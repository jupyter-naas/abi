...
### Definition
b is a message receiver role =Def b is a role that inheres in an agent & b is realized by processes in which that agent participates in accessing an existing concretization of a message GDC that was made available through transmission

### Examples
The role of being an email recipient; the role of being a chat participant who receives messages; the role of being a listener in a conversation

### Aliases
Not defined.

### URI
http://ontology.naas.ai/messaging#MessageReceiverRole

### Subclass Of
```mermaid
graph BT
    messaging#MessageReceiverRole(Message<br>receiver<br>role):::bfo-->BFO_0000023
...
- [Message receiver role](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Role/Message%20receiver%20role/Message%20receiver%20role.md)
