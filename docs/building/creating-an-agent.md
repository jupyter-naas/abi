...
Related pages: [[concepts/agent-system|Agent System]], [[building/creating-a-module|Creating a Module]], [[adr/20260305_agent-class-new-pattern|ADR: Agent.New() Pattern]].
