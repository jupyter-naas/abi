...
### Definition
Industry referenced on LinkedIn.

### Examples
Events Services, Hospitality, Travel Arrangements, etc.

### Aliases
Not defined.

### URI
http://ontology.naas.ai/abi/linkedin#LinkedInIndustry

### Subclass Of
```mermaid
graph BT
    linkedin#LinkedInIndustry(Linkedin<br>industry):::abi-->ont00001069
...
- [Linkedin industry](/docs/ontology/reference/model/Entity/Continuant/Generically%20dependent%20continuant/Information%20content%20entity/Representational%20information%20content%20entity/Linkedin%20industry/Linkedin%20industry.md)
