...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SpecificationReference

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SpecificationReference(Specification<br>reference):::d3fend-->d3fend.owl#TechniqueReference
...
- [Specification reference](/docs/ontology/reference/model/D3FENDKBThing/Technique%20reference/Specification%20reference/Specification%20reference.md)
