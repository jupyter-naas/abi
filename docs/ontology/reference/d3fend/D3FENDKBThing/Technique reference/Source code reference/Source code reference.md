...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SourceCodeReference

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SourceCodeReference(Source<br>code<br>reference):::d3fend-->d3fend.owl#TechniqueReference
...
- [Source code reference](/docs/ontology/reference/model/D3FENDKBThing/Technique%20reference/Source%20code%20reference/Source%20code%20reference.md)
