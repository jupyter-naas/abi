...
```mermaid
graph BT
    d3fend.owl#T1519(Emond):::d3fend-->d3fend.owl#PrivilegeEscalationTechnique
...
- [Emond](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Emond/Emond.md)
