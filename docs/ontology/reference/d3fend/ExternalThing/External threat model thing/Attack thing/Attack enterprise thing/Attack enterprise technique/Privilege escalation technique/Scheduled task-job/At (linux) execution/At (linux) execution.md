...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1053.001

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1053.001(At<br>(linux)<br>execution):::d3fend-->d3fend.owl#T1053
...
- [At (linux) execution](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Scheduled%20task-job/At%20%28linux%29%20execution/At%20%28linux%29%20execution.md)
