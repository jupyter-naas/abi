...
```mermaid
graph BT
    d3fend.owl#T1038(Dll<br>search<br>order<br>hijacking):::d3fend-->d3fend.owl#PersistenceTechnique
...
- [Dll search order hijacking](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Persistence%20technique/Dll%20search%20order%20hijacking/Dll%20search%20order%20hijacking.md)
