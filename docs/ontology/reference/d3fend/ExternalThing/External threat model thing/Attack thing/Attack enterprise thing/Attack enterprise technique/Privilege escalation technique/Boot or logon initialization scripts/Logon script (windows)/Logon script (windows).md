...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1037.001

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1037.001(Logon<br>script<br>(windows)):::d3fend-->d3fend.owl#T1037
...
- [Logon script (windows)](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Boot%20or%20logon%20initialization%20scripts/Logon%20script%20%28windows%29/Logon%20script%20%28windows%29.md)
