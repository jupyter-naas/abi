...
```mermaid
graph BT
    d3fend.owl#T1179(Hooking):::d3fend-->d3fend.owl#PersistenceTechnique
...
- [Hooking](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Persistence%20technique/Hooking/Hooking.md)
