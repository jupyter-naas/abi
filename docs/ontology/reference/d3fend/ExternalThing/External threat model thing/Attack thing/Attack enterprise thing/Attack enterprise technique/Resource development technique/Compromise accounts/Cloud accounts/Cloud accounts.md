...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1586.003

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1586.003(Cloud<br>accounts):::d3fend-->d3fend.owl#T1586
    d3fend.owl#T1586(Compromise<br>accounts):::d3fend-->d3fend.owl#ResourceDevelopmentTechnique
...
- [Cloud accounts](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Resource%20development%20technique/Compromise%20accounts/Cloud%20accounts/Cloud%20accounts.md)
