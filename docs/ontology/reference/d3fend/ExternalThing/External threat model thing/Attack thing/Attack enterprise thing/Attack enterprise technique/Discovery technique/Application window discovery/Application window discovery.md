...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1010

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1010(Application<br>window<br>discovery):::d3fend-->d3fend.owl#DiscoveryTechnique
...
- [Application window discovery](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Discovery%20technique/Application%20window%20discovery/Application%20window%20discovery.md)
