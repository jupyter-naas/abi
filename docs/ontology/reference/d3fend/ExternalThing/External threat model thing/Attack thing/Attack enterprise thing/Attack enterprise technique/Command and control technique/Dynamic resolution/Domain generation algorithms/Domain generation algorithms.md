...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1568.002

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1568.002(Domain<br>generation<br>algorithms):::d3fend-->d3fend.owl#T1568
...
- [Domain generation algorithms](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Dynamic%20resolution/Domain%20generation%20algorithms/Domain%20generation%20algorithms.md)
