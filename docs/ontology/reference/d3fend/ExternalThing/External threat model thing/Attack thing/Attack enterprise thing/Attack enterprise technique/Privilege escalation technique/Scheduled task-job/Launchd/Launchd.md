...
```mermaid
graph BT
    d3fend.owl#T1053.004(Launchd):::d3fend-->d3fend.owl#T1053
...
- [Launchd](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Scheduled%20task-job/Launchd/Launchd.md)
