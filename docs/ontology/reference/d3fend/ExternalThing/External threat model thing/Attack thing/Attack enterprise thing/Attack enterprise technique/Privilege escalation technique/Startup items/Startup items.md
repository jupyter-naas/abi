...
```mermaid
graph BT
    d3fend.owl#T1165(Startup<br>items):::d3fend-->d3fend.owl#PrivilegeEscalationTechnique
...
- [Startup items](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Startup%20items/Startup%20items.md)
