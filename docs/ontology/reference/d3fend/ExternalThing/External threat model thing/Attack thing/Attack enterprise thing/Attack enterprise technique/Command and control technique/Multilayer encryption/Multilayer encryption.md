...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1079

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1079(Multilayer<br>encryption):::d3fend-->d3fend.owl#CommandAndControlTechnique
...
- [Multilayer encryption](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Multilayer%20encryption/Multilayer%20encryption.md)
