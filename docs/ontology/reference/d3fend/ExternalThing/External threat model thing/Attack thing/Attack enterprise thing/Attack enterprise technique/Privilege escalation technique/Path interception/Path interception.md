...
```mermaid
graph BT
    d3fend.owl#T1034(Path<br>interception):::d3fend-->d3fend.owl#PrivilegeEscalationTechnique
...
- [Path interception](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Path%20interception/Path%20interception.md)
