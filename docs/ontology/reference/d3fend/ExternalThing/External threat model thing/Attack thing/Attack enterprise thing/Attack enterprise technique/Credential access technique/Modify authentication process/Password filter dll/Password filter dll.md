...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1556.002

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1556.002(Password<br>filter<br>dll):::d3fend-->d3fend.owl#T1556
...
- [Password filter dll](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Credential%20access%20technique/Modify%20authentication%20process/Password%20filter%20dll/Password%20filter%20dll.md)
