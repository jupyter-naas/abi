...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1185

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1185(Browser<br>session<br>hijacking):::d3fend-->d3fend.owl#CollectionTechnique
...
- [Browser session hijacking](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Collection%20technique/Browser%20session%20hijacking/Browser%20session%20hijacking.md)
