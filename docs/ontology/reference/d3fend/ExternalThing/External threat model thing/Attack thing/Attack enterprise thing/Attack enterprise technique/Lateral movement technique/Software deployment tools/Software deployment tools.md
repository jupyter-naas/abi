...
```mermaid
graph BT
    d3fend.owl#T1072(Software<br>deployment<br>tools):::d3fend-->d3fend.owl#LateralMovementTechnique
...
- [Software deployment tools](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Lateral%20movement%20technique/Software%20deployment%20tools/Software%20deployment%20tools.md)
