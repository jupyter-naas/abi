...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1595.001

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1595.001(Scanning<br>ip<br>blocks):::d3fend-->d3fend.owl#T1595
...
- [Scanning ip blocks](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Reconnaissance%20technique/Active%20scanning/Scanning%20ip%20blocks/Scanning%20ip%20blocks.md)
