...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1016.001

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1016.001(Internet<br>connection<br>discovery):::d3fend-->d3fend.owl#T1016
...
- [Internet connection discovery](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Discovery%20technique/System%20network%20configuration%20discovery/Internet%20connection%20discovery/Internet%20connection%20discovery.md)
