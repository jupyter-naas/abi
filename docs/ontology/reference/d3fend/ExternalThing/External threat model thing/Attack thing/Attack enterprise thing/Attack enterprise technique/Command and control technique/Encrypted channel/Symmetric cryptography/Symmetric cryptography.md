...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1573.001

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1573.001(Symmetric<br>cryptography):::d3fend-->d3fend.owl#T1573
...
- [Symmetric cryptography](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Encrypted%20channel/Symmetric%20cryptography/Symmetric%20cryptography.md)
