...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1037.003

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1037.003(Network<br>logon<br>script):::d3fend-->d3fend.owl#T1037
...
- [Network logon script](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Boot%20or%20logon%20initialization%20scripts/Network%20logon%20script/Network%20logon%20script.md)
