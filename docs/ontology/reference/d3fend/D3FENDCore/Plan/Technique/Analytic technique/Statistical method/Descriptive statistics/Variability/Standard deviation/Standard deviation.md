...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#StandardDeviation

### Subclass Of
```mermaid
graph BT
    d3fend.owl#StandardDeviation(Standard<br>deviation):::d3fend-->d3fend.owl#Variability
...
- [Standard deviation](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Statistical%20method/Descriptive%20statistics/Variability/Standard%20deviation/Standard%20deviation.md)
