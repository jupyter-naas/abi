...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#FuzzyLogic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#FuzzyLogic(Fuzzy<br>logic):::d3fend-->d3fend.owl#SymbolicAI
...
- [Fuzzy logic](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Symbolic%20logic/Symbolic%20ai/Fuzzy%20logic/Fuzzy%20logic.md)
