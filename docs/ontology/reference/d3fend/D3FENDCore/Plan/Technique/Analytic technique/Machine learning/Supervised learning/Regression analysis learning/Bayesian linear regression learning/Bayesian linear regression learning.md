...
### Definition
A supervised learning method that builds a Bayesian linear regression model using training data.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#BayesianLinearRegressionLearning

### Subclass Of
```mermaid
graph BT
    d3fend.owl#BayesianLinearRegressionLearning(Bayesian<br>linear<br>regression<br>learning):::d3fend-->d3fend.owl#RegressionAnalysisLearning
...
- [Bayesian linear regression learning](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Machine%20learning/Supervised%20learning/Regression%20analysis%20learning/Bayesian%20linear%20regression%20learning/Bayesian%20linear%20regression%20learning.md)
