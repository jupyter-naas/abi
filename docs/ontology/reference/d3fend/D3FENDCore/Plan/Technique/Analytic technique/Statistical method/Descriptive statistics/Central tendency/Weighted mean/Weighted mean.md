...
### Definition
A mean that incorporates weighting to certain data elements.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WeightedMean

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WeightedMean(Weighted<br>mean):::d3fend-->d3fend.owl#CentralTendency
...
- [Weighted mean](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Statistical%20method/Descriptive%20statistics/Central%20tendency/Weighted%20mean/Weighted%20mean.md)
