...
### Definition
The phi coefficient (or mean square contingency coefficient is a measure of association for two binary variables.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#PhiCoefficient

### Subclass Of
```mermaid
graph BT
    d3fend.owl#PhiCoefficient(Phi<br>coefficient):::d3fend-->d3fend.owl#Correlation
...
- [Phi coefficient](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Statistical%20method/Descriptive%20statistics/Correlation/Phi%20coefficient/Phi%20coefficient.md)
