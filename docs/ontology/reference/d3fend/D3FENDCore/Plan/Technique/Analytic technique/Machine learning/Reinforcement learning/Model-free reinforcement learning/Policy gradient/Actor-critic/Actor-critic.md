...
```mermaid
graph BT
    d3fend.owl#Actor-Critic(Actor-critic):::d3fend-->d3fend.owl#PolicyGradient
...
- [Actor-critic](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Machine%20learning/Reinforcement%20learning/Model-free%20reinforcement%20learning/Policy%20gradient/Actor-critic/Actor-critic.md)
