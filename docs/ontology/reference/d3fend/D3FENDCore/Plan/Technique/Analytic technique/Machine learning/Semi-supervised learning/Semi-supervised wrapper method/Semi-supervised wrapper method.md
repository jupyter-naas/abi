...
### Definition
The principle behind wrapper methods is that we train a model with labeled data and then generate pseudo-labels for the unlabeled data using the trained model iteratively.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Semi-supervisedWrapperMethod
