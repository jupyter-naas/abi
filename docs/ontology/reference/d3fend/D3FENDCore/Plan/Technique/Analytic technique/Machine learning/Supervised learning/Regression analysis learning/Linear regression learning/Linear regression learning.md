...
### Definition
A supervised learning method that builds a linear regression model using training data.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinearRegressionLearning

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinearRegressionLearning(Linear<br>regression<br>learning):::d3fend-->d3fend.owl#RegressionAnalysisLearning
...
- [Linear regression learning](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Machine%20learning/Supervised%20learning/Regression%20analysis%20learning/Linear%20regression%20learning/Linear%20regression%20learning.md)
