...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#RegexMatching

### Subclass Of
```mermaid
graph BT
    d3fend.owl#RegexMatching(Regex<br>matching):::d3fend-->d3fend.owl#PartialMatching
...
- [Regex matching](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Symbolic%20logic/Logical%20rules/Pattern%20matching/String%20pattern%20matching/Partial%20matching/Regex%20matching/Regex%20matching.md)
