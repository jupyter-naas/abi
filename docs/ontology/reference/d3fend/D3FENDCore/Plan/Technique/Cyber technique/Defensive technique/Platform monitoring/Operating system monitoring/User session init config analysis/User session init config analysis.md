...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#UserSessionInitConfigAnalysis

### Subclass Of
```mermaid
graph BT
    d3fend.owl#UserSessionInitConfigAnalysis(User<br>session<br>init<br>config<br>analysis):::d3fend-->d3fend.owl#OperatingSystemMonitoring
...
- [User session init config analysis](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Platform%20monitoring/Operating%20system%20monitoring/User%20session%20init%20config%20analysis/User%20session%20init%20config%20analysis.md)
