...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#FirmwareBehaviorAnalysis

### Subclass Of
```mermaid
graph BT
    d3fend.owl#FirmwareBehaviorAnalysis(Firmware<br>behavior<br>analysis):::d3fend-->d3fend.owl#PlatformMonitoring
...
- [Firmware behavior analysis](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Platform%20monitoring/Firmware%20behavior%20analysis/Firmware%20behavior%20analysis.md)
