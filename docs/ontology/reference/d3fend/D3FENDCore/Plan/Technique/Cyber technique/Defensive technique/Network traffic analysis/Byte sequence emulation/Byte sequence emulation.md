...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ByteSequenceEmulation

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ByteSequenceEmulation(Byte<br>sequence<br>emulation):::d3fend-->d3fend.owl#NetworkTrafficAnalysis
...
- [Byte sequence emulation](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Network%20traffic%20analysis/Byte%20sequence%20emulation/Byte%20sequence%20emulation.md)
