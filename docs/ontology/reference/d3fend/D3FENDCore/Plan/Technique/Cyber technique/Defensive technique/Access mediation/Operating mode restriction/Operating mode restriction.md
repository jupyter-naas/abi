...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OperatingModeRestriction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OperatingModeRestriction(Operating<br>mode<br>restriction):::d3fend-->d3fend.owl#AccessMediation
...
- [Operating mode restriction](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Access%20mediation/Operating%20mode%20restriction/Operating%20mode%20restriction.md)
