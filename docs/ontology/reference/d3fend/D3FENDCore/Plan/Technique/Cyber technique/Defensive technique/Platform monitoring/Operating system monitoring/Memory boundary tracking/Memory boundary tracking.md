...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MemoryBoundaryTracking

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MemoryBoundaryTracking(Memory<br>boundary<br>tracking):::d3fend-->d3fend.owl#OperatingSystemMonitoring
...
- [Memory boundary tracking](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Platform%20monitoring/Operating%20system%20monitoring/Memory%20boundary%20tracking/Memory%20boundary%20tracking.md)
