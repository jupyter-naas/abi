...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#RelayPatternAnalysis

### Subclass Of
```mermaid
graph BT
    d3fend.owl#RelayPatternAnalysis(Relay<br>pattern<br>analysis):::d3fend-->d3fend.owl#NetworkTrafficAnalysis
...
- [Relay pattern analysis](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Network%20traffic%20analysis/Relay%20pattern%20analysis/Relay%20pattern%20analysis.md)
