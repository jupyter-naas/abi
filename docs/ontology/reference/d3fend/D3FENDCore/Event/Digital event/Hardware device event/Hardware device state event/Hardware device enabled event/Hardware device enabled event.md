...
### Definition
An event where a device becomes operational and available for use, typically following initialization, activation, or repair.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#HardwareDeviceEnabledEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#HardwareDeviceEnabledEvent(Hardware<br>device<br>enabled<br>event):::d3fend-->d3fend.owl#HardwareDeviceStateEvent
...
- [Hardware device enabled event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Hardware%20device%20event/Hardware%20device%20state%20event/Hardware%20device%20enabled%20event/Hardware%20device%20enabled%20event.md)
