...
### Definition
An event where the name of a registry key is changed, altering its identifier within the registry hierarchy.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsRegistryKeyRenamingEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsRegistryKeyRenamingEvent(Windows<br>registry<br>key<br>renaming<br>event):::d3fend-->d3fend.owl#WindowsRegistryKeyEvent
...
- [Windows registry key renaming event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Windows%20registry%20event/Windows%20registry%20key%20event/Windows%20registry%20key%20renaming%20event/Windows%20registry%20key%20renaming%20event.md)
