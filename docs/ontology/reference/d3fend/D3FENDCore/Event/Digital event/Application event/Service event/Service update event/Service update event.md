...
```mermaid
graph BT
    d3fend.owl#ServiceUpdateEvent(Service<br>update<br>event):::d3fend-->d3fend.owl#ServiceEvent
...
- [Service update event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Application%20event/Service%20event/Service%20update%20event/Service%20update%20event.md)
