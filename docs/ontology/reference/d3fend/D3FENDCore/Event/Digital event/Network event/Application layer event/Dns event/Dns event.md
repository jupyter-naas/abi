...
### Definition
An event involving the Domain Name System (DNS), which translates domain names to IP addresses and operates over UDP and TCP.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DNSEvent
