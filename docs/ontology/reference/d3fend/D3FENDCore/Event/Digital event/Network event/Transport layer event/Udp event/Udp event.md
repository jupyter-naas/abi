...
### Definition
An event involving the User Datagram Protocol (UDP), providing a connectionless datagram service with minimal protocol mechanisms.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#UDPEvent
