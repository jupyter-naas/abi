...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTServiceStatusEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTServiceStatusEvent(Ot<br>service<br>status<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot service status event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20service%20status%20event/Ot%20service%20status%20event.md)
