...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTRestartDeviceEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTRestartDeviceEvent(Ot<br>restart<br>device<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot restart device event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20restart%20device%20event/Ot%20restart%20device%20event.md)
