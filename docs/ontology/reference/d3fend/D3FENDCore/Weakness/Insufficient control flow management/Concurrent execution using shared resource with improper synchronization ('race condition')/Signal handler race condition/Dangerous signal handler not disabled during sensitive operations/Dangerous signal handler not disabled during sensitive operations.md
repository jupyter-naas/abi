...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-432

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-432(Dangerous<br>signal<br>handler<br>not<br>disabled<br>during<br>sensitive<br>operations):::d3fend-->d3fend.owl#CWE-364
...
- [Dangerous signal handler not disabled during sensitive operations](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Concurrent%20execution%20using%20shared%20resource%20with%20improper%20synchronization%20%28%27race%20condition%27%29/Signal%20handler%20race%20condition/Dangerous%20signal%20handler%20not%20disabled%20during%20sensitive%20operations/Dangerous%20signal%20handler%20not%20disabled%20during%20sensitive%20operations.md)
