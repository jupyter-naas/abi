...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-408

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-408(Incorrect<br>behavior<br>order:<br>early<br>amplification):::d3fend-->d3fend.owl#CWE-696
...
- [Incorrect behavior order: early amplification](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Incorrect%20behavior%20order/Incorrect%20behavior%20order%3A%20early%20amplification/Incorrect%20behavior%20order%3A%20early%20amplification.md)
