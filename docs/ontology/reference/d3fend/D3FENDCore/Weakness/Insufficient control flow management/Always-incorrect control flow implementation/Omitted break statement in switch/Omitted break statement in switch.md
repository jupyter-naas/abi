...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-484

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-484(Omitted<br>break<br>statement<br>in<br>switch):::d3fend-->d3fend.owl#CWE-670
...
- [Omitted break statement in switch](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Always-incorrect%20control%20flow%20implementation/Omitted%20break%20statement%20in%20switch/Omitted%20break%20statement%20in%20switch.md)
