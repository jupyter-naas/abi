...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-783

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-783(Operator<br>precedence<br>logic<br>error):::d3fend-->d3fend.owl#CWE-670
...
- [Operator precedence logic error](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Always-incorrect%20control%20flow%20implementation/Operator%20precedence%20logic%20error/Operator%20precedence%20logic%20error.md)
