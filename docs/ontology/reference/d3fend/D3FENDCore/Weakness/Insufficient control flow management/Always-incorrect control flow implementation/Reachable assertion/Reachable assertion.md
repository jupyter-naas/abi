...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-617

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-617(Reachable<br>assertion):::d3fend-->d3fend.owl#CWE-670
...
- [Reachable assertion](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Always-incorrect%20control%20flow%20implementation/Reachable%20assertion/Reachable%20assertion.md)
