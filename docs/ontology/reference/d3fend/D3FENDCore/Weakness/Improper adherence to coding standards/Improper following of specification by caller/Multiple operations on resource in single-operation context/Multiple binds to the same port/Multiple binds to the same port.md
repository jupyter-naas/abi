...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-605

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-605(Multiple<br>binds<br>to<br>the<br>same<br>port):::d3fend-->d3fend.owl#CWE-675
...
- [Multiple binds to the same port](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Improper%20following%20of%20specification%20by%20caller/Multiple%20operations%20on%20resource%20in%20single-operation%20context/Multiple%20binds%20to%20the%20same%20port/Multiple%20binds%20to%20the%20same%20port.md)
