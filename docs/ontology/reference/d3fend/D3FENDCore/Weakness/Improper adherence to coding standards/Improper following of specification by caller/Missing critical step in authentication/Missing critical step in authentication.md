...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-304

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-304(Missing<br>critical<br>step<br>in<br>authentication):::d3fend-->d3fend.owl#CWE-573
...
- [Missing critical step in authentication](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Improper%20following%20of%20specification%20by%20caller/Missing%20critical%20step%20in%20authentication/Missing%20critical%20step%20in%20authentication.md)
