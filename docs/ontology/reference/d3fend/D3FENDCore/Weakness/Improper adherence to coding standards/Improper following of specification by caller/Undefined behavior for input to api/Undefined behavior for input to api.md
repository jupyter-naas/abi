...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-475

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-475(Undefined<br>behavior<br>for<br>input<br>to<br>api):::d3fend-->d3fend.owl#CWE-573
...
- [Undefined behavior for input to api](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Improper%20following%20of%20specification%20by%20caller/Undefined%20behavior%20for%20input%20to%20api/Undefined%20behavior%20for%20input%20to%20api.md)
