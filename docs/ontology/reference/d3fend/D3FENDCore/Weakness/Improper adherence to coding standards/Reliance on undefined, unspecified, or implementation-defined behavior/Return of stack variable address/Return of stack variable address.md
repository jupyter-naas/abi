...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-562

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-562(Return<br>of<br>stack<br>variable<br>address):::d3fend-->d3fend.owl#CWE-758
...
- [Return of stack variable address](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Reliance%20on%20undefined%2C%20unspecified%2C%20or%20implementation-defined%20behavior/Return%20of%20stack%20variable%20address/Return%20of%20stack%20variable%20address.md)
