...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-511

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-511(Logic-time<br>bomb):::d3fend-->d3fend.owl#CWE-506
...
- [Logic-time bomb](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Incorrect%20provision%20of%20specified%20functionality/Hidden%20functionality/Embedded%20malicious%20code/Logic-time%20bomb/Logic-time%20bomb.md)
