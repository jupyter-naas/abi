...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-440

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-440(Expected<br>behavior<br>violation):::d3fend-->d3fend.owl#CWE-684
...
- [Expected behavior violation](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Incorrect%20provision%20of%20specified%20functionality/Expected%20behavior%20violation/Expected%20behavior%20violation.md)
