...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1045

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1045(Parent<br>class<br>with<br>a<br>virtual<br>destructor<br>and<br>a<br>child<br>class<br>without<br>a<br>virtual<br>destructor):::d3fend-->d3fend.owl#CWE-1076
...
- [Parent class with a virtual destructor and a child class without a virtual destructor](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Insufficient%20adherence%20to%20expected%20conventions/Parent%20class%20with%20a%20virtual%20destructor%20and%20a%20child%20class%20without%20a%20virtual%20destructor/Parent%20class%20with%20a%20virtual%20destructor%20and%20a%20child%20class%20without%20a%20virtual%20destructor.md)
