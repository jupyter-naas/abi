...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1106

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1106(Insufficient<br>use<br>of<br>symbolic<br>constants):::d3fend-->d3fend.owl#CWE-1078
...
- [Insufficient use of symbolic constants](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Insufficient%20adherence%20to%20expected%20conventions/Inappropriate%20source%20code%20style%20or%20formatting/Insufficient%20use%20of%20symbolic%20constants/Insufficient%20use%20of%20symbolic%20constants.md)
