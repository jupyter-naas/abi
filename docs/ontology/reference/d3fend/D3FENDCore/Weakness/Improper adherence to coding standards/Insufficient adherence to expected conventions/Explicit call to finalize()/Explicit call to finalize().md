...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-586

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-586(Explicit<br>call<br>to<br>finalize()):::d3fend-->d3fend.owl#CWE-1076
...
- [Explicit call to finalize()](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Insufficient%20adherence%20to%20expected%20conventions/Explicit%20call%20to%20finalize%28%29/Explicit%20call%20to%20finalize%28%29.md)
