...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-394

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-394(Unexpected<br>status<br>code<br>or<br>return<br>value):::d3fend-->d3fend.owl#CWE-754
...
- [Unexpected status code or return value](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20check%20or%20handling%20of%20exceptional%20conditions/Improper%20check%20for%20unusual%20or%20exceptional%20conditions/Unexpected%20status%20code%20or%20return%20value/Unexpected%20status%20code%20or%20return%20value.md)
