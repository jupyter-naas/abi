...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-390

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-390(Detection<br>of<br>error<br>condition<br>without<br>action):::d3fend-->d3fend.owl#CWE-755
...
- [Detection of error condition without action](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20check%20or%20handling%20of%20exceptional%20conditions/Improper%20handling%20of%20exceptional%20conditions/Detection%20of%20error%20condition%20without%20action/Detection%20of%20error%20condition%20without%20action.md)
