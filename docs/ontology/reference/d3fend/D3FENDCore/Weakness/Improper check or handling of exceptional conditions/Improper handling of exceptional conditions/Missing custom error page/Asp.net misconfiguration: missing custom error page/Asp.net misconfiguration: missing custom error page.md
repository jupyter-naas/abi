...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-12

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-12(Asp.net<br>misconfiguration:<br>missing<br>custom<br>error<br>page):::d3fend-->d3fend.owl#CWE-756
...
- [Asp.net misconfiguration: missing custom error page](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20check%20or%20handling%20of%20exceptional%20conditions/Improper%20handling%20of%20exceptional%20conditions/Missing%20custom%20error%20page/Asp.net%20misconfiguration%3A%20missing%20custom%20error%20page/Asp.net%20misconfiguration%3A%20missing%20custom%20error%20page.md)
