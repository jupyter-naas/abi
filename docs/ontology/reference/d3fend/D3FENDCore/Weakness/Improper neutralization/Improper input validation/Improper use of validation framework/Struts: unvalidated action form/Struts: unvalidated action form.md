...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-108

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-108(Struts:<br>unvalidated<br>action<br>form):::d3fend-->d3fend.owl#CWE-1173
...
- [Struts: unvalidated action form](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20neutralization/Improper%20input%20validation/Improper%20use%20of%20validation%20framework/Struts%3A%20unvalidated%20action%20form/Struts%3A%20unvalidated%20action%20form.md)
