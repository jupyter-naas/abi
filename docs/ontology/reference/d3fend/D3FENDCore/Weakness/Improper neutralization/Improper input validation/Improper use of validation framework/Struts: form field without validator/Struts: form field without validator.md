...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-105

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-105(Struts:<br>form<br>field<br>without<br>validator):::d3fend-->d3fend.owl#CWE-1173
...
- [Struts: form field without validator](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20neutralization/Improper%20input%20validation/Improper%20use%20of%20validation%20framework/Struts%3A%20form%20field%20without%20validator/Struts%3A%20form%20field%20without%20validator.md)
