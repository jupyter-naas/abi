...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-554

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-554(Asp.net<br>misconfiguration:<br>not<br>using<br>input<br>validation<br>framework):::d3fend-->d3fend.owl#CWE-1173
...
- [Asp.net misconfiguration: not using input validation framework](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20neutralization/Improper%20input%20validation/Improper%20use%20of%20validation%20framework/Asp.net%20misconfiguration%3A%20not%20using%20input%20validation%20framework/Asp.net%20misconfiguration%3A%20not%20using%20input%20validation%20framework.md)
