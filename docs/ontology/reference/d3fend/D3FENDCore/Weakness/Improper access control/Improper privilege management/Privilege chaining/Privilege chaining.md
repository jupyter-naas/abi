...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-268

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-268(Privilege<br>chaining):::d3fend-->d3fend.owl#CWE-269
...
- [Privilege chaining](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20privilege%20management/Privilege%20chaining/Privilege%20chaining.md)
