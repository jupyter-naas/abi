...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-804

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-804(Guessable<br>captcha):::d3fend-->d3fend.owl#CWE-863
...
- [Guessable captcha](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authorization/Incorrect%20authorization/Guessable%20captcha/Guessable%20captcha.md)
