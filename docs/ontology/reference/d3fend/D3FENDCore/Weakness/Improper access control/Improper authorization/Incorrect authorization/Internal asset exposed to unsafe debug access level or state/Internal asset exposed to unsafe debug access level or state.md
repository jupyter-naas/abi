...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1244

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1244(Internal<br>asset<br>exposed<br>to<br>unsafe<br>debug<br>access<br>level<br>or<br>state):::d3fend-->d3fend.owl#CWE-863
...
- [Internal asset exposed to unsafe debug access level or state](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authorization/Incorrect%20authorization/Internal%20asset%20exposed%20to%20unsafe%20debug%20access%20level%20or%20state/Internal%20asset%20exposed%20to%20unsafe%20debug%20access%20level%20or%20state.md)
