...
```mermaid
graph BT
    d3fend.owl#CWE-551(Incorrect<br>behavior<br>order:<br>authorization<br>before<br>parsing<br>and<br>canonicalization):::d3fend-->d3fend.owl#CWE-863
...
- [Incorrect behavior order: authorization before parsing and canonicalization](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authorization/Incorrect%20authorization/Incorrect%20behavior%20order%3A%20authorization%20before%20parsing%20and%20canonicalization/Incorrect%20behavior%20order%3A%20authorization%20before%20parsing%20and%20canonicalization.md)
