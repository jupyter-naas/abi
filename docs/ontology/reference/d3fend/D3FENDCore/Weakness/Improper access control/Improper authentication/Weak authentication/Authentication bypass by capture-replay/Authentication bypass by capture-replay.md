...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-294

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-294(Authentication<br>bypass<br>by<br>capture-replay):::d3fend-->d3fend.owl#CWE-1390
...
- [Authentication bypass by capture-replay](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authentication/Weak%20authentication/Authentication%20bypass%20by%20capture-replay/Authentication%20bypass%20by%20capture-replay.md)
