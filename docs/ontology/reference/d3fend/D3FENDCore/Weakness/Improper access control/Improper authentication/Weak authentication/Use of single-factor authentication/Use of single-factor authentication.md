...
```mermaid
graph BT
    d3fend.owl#CWE-308(Use<br>of<br>single-factor<br>authentication):::d3fend-->d3fend.owl#CWE-1390
...
- [Use of single-factor authentication](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authentication/Weak%20authentication/Use%20of%20single-factor%20authentication/Use%20of%20single-factor%20authentication.md)
