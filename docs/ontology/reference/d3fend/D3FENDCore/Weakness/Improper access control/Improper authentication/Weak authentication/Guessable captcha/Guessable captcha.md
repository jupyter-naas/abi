...
```mermaid
graph BT
    d3fend.owl#CWE-804(Guessable<br>captcha):::d3fend-->d3fend.owl#CWE-1390
...
- [Guessable captcha](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authentication/Weak%20authentication/Guessable%20captcha/Guessable%20captcha.md)
