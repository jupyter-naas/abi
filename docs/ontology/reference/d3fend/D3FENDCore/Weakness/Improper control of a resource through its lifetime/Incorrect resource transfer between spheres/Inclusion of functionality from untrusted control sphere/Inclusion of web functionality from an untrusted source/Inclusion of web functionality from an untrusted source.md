...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-830

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-830(Inclusion<br>of<br>web<br>functionality<br>from<br>an<br>untrusted<br>source):::d3fend-->d3fend.owl#CWE-829
...
- [Inclusion of web functionality from an untrusted source](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Incorrect%20resource%20transfer%20between%20spheres/Inclusion%20of%20functionality%20from%20untrusted%20control%20sphere/Inclusion%20of%20web%20functionality%20from%20an%20untrusted%20source/Inclusion%20of%20web%20functionality%20from%20an%20untrusted%20source.md)
