...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-261

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-261(Weak<br>encoding<br>for<br>password):::d3fend-->d3fend.owl#CWE-522
...
- [Weak encoding for password](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Exposure%20of%20resource%20to%20wrong%20sphere/Insufficiently%20protected%20credentials/Weak%20encoding%20for%20password/Weak%20encoding%20for%20password.md)
