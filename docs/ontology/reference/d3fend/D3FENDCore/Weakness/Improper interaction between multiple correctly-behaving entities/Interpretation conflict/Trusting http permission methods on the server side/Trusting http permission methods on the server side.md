...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-650

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-650(Trusting<br>http<br>permission<br>methods<br>on<br>the<br>server<br>side):::d3fend-->d3fend.owl#CWE-436
...
- [Trusting http permission methods on the server side](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20interaction%20between%20multiple%20correctly-behaving%20entities/Interpretation%20conflict/Trusting%20http%20permission%20methods%20on%20the%20server%20side/Trusting%20http%20permission%20methods%20on%20the%20server%20side.md)
