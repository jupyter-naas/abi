...
```mermaid
graph BT
    d3fend.owl#CWE-778(Insufficient<br>logging):::d3fend-->d3fend.owl#CWE-693
...
- [Insufficient logging](/docs/ontology/reference/model/D3FENDCore/Weakness/Protection%20mechanism%20failure/Insufficient%20logging/Insufficient%20logging.md)
