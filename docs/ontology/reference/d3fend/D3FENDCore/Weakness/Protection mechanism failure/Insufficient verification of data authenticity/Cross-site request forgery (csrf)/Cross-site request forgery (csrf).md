...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-352

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-352(Cross-site<br>request<br>forgery<br>(csrf)):::d3fend-->d3fend.owl#CWE-345
...
- [Cross-site request forgery (csrf)](/docs/ontology/reference/model/D3FENDCore/Weakness/Protection%20mechanism%20failure/Insufficient%20verification%20of%20data%20authenticity/Cross-site%20request%20forgery%20%28csrf%29/Cross-site%20request%20forgery%20%28csrf%29.md)
