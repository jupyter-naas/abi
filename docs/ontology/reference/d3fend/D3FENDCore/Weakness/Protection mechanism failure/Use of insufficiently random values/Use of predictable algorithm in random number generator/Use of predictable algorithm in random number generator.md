...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1241

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1241(Use<br>of<br>predictable<br>algorithm<br>in<br>random<br>number<br>generator):::d3fend-->d3fend.owl#CWE-330
...
- [Use of predictable algorithm in random number generator](/docs/ontology/reference/model/D3FENDCore/Weakness/Protection%20mechanism%20failure/Use%20of%20insufficiently%20random%20values/Use%20of%20predictable%20algorithm%20in%20random%20number%20generator/Use%20of%20predictable%20algorithm%20in%20random%20number%20generator.md)
