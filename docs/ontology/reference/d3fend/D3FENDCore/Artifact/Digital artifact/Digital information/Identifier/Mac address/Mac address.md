...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MACAddress

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MACAddress(Mac<br>address):::d3fend-->d3fend.owl#Identifier
...
- [Mac address](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Identifier/Mac%20address/Mac%20address.md)
