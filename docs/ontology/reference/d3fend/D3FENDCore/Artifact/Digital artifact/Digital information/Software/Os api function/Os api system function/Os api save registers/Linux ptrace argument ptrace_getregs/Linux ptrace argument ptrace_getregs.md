...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPtraceArgumentPTRACEGETREGS

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPtraceArgumentPTRACEGETREGS(Linux<br>ptrace<br>argument<br>ptrace_getregs):::d3fend-->d3fend.owl#OSAPISaveRegisters
    d3fend.owl#OSAPISaveRegisters(Os<br>api<br>save<br>registers):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api save registers](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20save%20registers/Os%20api%20save%20registers.md)
- [Linux ptrace argument ptrace_getregs](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20save%20registers/Linux%20ptrace%20argument%20ptrace_getregs/Linux%20ptrace%20argument%20ptrace_getregs.md)
