...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ConsoleOutputFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ConsoleOutputFunction(Console<br>output<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Console output function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Console%20output%20function/Console%20output%20function.md)
