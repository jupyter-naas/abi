...
### Definition
OT command that removes existing data on a remote device.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTDeleteData

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTDeleteData(Ot<br>delete<br>data):::d3fend-->d3fend.owl#OTModifyDeviceData
...
- [Ot delete data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20data/Ot%20delete%20data/Ot%20delete%20data.md)
