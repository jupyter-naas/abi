...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtFreeVirtualMemory

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtFreeVirtualMemory(Windows<br>ntfreevirtualmemory):::d3fend-->d3fend.owl#OSAPIFreeMemory
    d3fend.owl#OSAPIFreeMemory(Os<br>api<br>free<br>memory):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api free memory](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20free%20memory/Os%20api%20free%20memory.md)
- [Windows ntfreevirtualmemory](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20free%20memory/Windows%20ntfreevirtualmemory/Windows%20ntfreevirtualmemory.md)
