...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsReadFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsReadFile(Windows<br>readfile):::d3fend-->d3fend.owl#OSAPIReadFile
...
- [Windows readfile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20read%20file/Windows%20readfile/Windows%20readfile.md)
