...
### Definition
A function which access a shared resource.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SharedResourceAccessFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SharedResourceAccessFunction(Shared<br>resource<br>access<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Shared resource access function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Shared%20resource%20access%20function/Shared%20resource%20access%20function.md)
