...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ContainerRuntime

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ContainerRuntime(Container<br>runtime):::d3fend-->d3fend.owl#ServiceApplication
...
- [Container runtime](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/Service%20application/Container%20runtime/Container%20runtime.md)
