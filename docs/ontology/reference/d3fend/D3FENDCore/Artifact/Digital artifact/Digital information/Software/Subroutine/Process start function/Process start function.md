...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ProcessStartFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ProcessStartFunction(Process<br>start<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Process start function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Process%20start%20function/Process%20start%20function.md)
