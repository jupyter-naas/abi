...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtWriteFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtWriteFile(Windows<br>ntwritefile):::d3fend-->d3fend.owl#OSAPIWriteFile
...
- [Windows ntwritefile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20file/Windows%20ntwritefile/Windows%20ntwritefile.md)
