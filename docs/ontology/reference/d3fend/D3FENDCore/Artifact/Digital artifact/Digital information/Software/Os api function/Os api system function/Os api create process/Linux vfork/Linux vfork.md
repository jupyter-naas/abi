...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxVfork

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxVfork(Linux<br>vfork):::d3fend-->d3fend.owl#OSAPICreateProcess
...
- [Linux vfork](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20process/Linux%20vfork/Linux%20vfork.md)
