...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MemoryFreeFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MemoryFreeFunction(Memory<br>free<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Memory free function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Memory%20free%20function/Memory%20free%20function.md)
