...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxMmap

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxMmap(Linux<br>mmap):::d3fend-->d3fend.owl#OSAPIAllocateMemory
...
- [Linux mmap](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20allocate%20memory/Linux%20mmap/Linux%20mmap.md)
