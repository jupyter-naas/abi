...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ApplicationShim

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ApplicationShim(Application<br>shim):::d3fend-->d3fend.owl#Shim
    d3fend.owl#Shim(Shim):::d3fend-->d3fend.owl#Software
...
- [Shim](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Shim/Shim.md)
- [Application shim](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Shim/Application%20shim/Application%20shim.md)
