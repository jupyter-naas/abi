...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPtraceArgumentPTRACEATTACH

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPtraceArgumentPTRACEATTACH(Linux<br>ptrace<br>argument<br>ptrace_attach):::d3fend-->d3fend.owl#OSAPIAccessProcess
    d3fend.owl#OSAPIAccessProcess(Os<br>api<br>access<br>process):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api access process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20access%20process/Os%20api%20access%20process.md)
- [Linux ptrace argument ptrace_attach](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20access%20process/Linux%20ptrace%20argument%20ptrace_attach/Linux%20ptrace%20argument%20ptrace_attach.md)
