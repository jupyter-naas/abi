...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#VirtualizationSoftware

### Subclass Of
```mermaid
graph BT
    d3fend.owl#VirtualizationSoftware(Virtualization<br>software):::d3fend-->d3fend.owl#ServiceApplication
...
- [Virtualization software](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/Service%20application/Virtualization%20software/Virtualization%20software.md)
