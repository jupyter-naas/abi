...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DynamicAnalysisTool

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DynamicAnalysisTool(Dynamic<br>analysis<br>tool):::d3fend-->d3fend.owl#CodeAnalyzer
...
- [Dynamic analysis tool](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Developer%20application/Code%20analyzer/Dynamic%20analysis%20tool/Dynamic%20analysis%20tool.md)
