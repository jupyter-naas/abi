# Ot establish remote connection
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTEstablishRemoteConnection

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTEstablishRemoteConnection(Ot<br>establish<br>remote<br>connection):::d3fend-->d3fend.owl#OTManageRemoteConnection
...
- [Ot establish remote connection](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20manage%20remote%20connection/Ot%20establish%20remote%20connection/Ot%20establish%20remote%20connection.md)
