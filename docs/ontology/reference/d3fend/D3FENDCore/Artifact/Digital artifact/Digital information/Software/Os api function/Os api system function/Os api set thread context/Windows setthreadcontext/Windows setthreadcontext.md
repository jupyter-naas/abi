...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsSetThreadContext

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsSetThreadContext(Windows<br>setthreadcontext):::d3fend-->d3fend.owl#OSAPISetThreadContext
...
- [Windows setthreadcontext](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20set%20thread%20context/Windows%20setthreadcontext/Windows%20setthreadcontext.md)
