...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsCreateThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsCreateThread(Windows<br>createthread):::d3fend-->d3fend.owl#OSAPICreateThread
...
- [Windows createthread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20thread/Windows%20createthread/Windows%20createthread.md)
