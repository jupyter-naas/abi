...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Microcode

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Microcode(Microcode):::d3fend-->d3fend.owl#Firmware
...
- [Microcode](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Firmware/Microcode/Microcode.md)
