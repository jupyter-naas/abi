...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTControlProgram

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTControlProgram(Ot<br>control<br>program):::d3fend-->d3fend.owl#Application
...
- [Ot control program](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/Ot%20control%20program/Ot%20control%20program.md)
