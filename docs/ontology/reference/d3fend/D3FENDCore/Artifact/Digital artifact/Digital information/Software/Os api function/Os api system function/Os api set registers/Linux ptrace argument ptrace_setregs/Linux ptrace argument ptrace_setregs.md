...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPtraceArgumentPTRACESETREGS

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPtraceArgumentPTRACESETREGS(Linux<br>ptrace<br>argument<br>ptrace_setregs):::d3fend-->d3fend.owl#OSAPISetRegisters
    d3fend.owl#OSAPISetRegisters(Os<br>api<br>set<br>registers):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api set registers](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20set%20registers/Os%20api%20set%20registers.md)
- [Linux ptrace argument ptrace_setregs](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20set%20registers/Linux%20ptrace%20argument%20ptrace_setregs/Linux%20ptrace%20argument%20ptrace_setregs.md)
