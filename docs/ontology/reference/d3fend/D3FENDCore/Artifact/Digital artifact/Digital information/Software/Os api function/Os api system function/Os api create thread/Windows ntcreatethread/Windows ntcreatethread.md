...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtCreateThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtCreateThread(Windows<br>ntcreatethread):::d3fend-->d3fend.owl#OSAPICreateThread
...
- [Windows ntcreatethread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20thread/Windows%20ntcreatethread/Windows%20ntcreatethread.md)
