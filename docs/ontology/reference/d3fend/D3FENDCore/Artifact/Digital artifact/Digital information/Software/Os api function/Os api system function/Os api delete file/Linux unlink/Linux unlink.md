...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxUnlink

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxUnlink(Linux<br>unlink):::d3fend-->d3fend.owl#OSAPIDeleteFile
...
- [Linux unlink](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20delete%20file/Linux%20unlink/Linux%20unlink.md)
