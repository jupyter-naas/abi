...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DigitalAudio

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DigitalAudio(Digital<br>audio):::d3fend-->d3fend.owl#DigitalMedia
...
- [Digital audio](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Digital%20media/Digital%20audio/Digital%20audio.md)
