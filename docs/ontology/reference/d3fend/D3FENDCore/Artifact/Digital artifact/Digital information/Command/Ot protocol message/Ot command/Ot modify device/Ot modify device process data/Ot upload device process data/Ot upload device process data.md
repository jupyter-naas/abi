# Ot upload device process data

## Overview

### Definition
OT command that uploads process data to a remote device.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTUploadDeviceProcessData

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTUploadDeviceProcessData(Ot<br>upload<br>device<br>process<br>data):::d3fend-->d3fend.owl#OTModifyDeviceProcessData
...
- [Ot upload device process data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20process%20data/Ot%20upload%20device%20process%20data/Ot%20upload%20device%20process%20data.md)
