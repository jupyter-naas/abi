...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#RawMemoryAccessFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#RawMemoryAccessFunction(Raw<br>memory<br>access<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Raw memory access function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Raw%20memory%20access%20function/Raw%20memory%20access%20function.md)
