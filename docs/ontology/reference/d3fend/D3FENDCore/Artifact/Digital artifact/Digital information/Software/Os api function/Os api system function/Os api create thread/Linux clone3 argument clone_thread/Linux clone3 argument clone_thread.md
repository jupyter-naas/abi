...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxClone3ArgumentCLONE_THREAD

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxClone3ArgumentCLONE_THREAD(Linux<br>clone3<br>argument<br>clone_thread):::d3fend-->d3fend.owl#OSAPICreateThread
    d3fend.owl#OSAPICreateThread(Os<br>api<br>create<br>thread):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api create thread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20thread/Os%20api%20create%20thread.md)
- [Linux clone3 argument clone_thread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20thread/Linux%20clone3%20argument%20clone_thread/Linux%20clone3%20argument%20clone_thread.md)
