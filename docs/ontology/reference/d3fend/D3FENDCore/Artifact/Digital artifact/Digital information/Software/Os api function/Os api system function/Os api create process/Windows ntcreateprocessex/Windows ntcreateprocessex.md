...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtCreateProcessEx

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtCreateProcessEx(Windows<br>ntcreateprocessex):::d3fend-->d3fend.owl#OSAPICreateProcess
    d3fend.owl#OSAPICreateProcess(Os<br>api<br>create<br>process):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api create process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20process/Os%20api%20create%20process.md)
- [Windows ntcreateprocessex](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20process/Windows%20ntcreateprocessex/Windows%20ntcreateprocessex.md)
