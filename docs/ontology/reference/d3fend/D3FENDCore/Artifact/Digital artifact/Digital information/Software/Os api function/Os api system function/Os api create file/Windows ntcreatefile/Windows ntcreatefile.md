...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtCreateFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtCreateFile(Windows<br>ntcreatefile):::d3fend-->d3fend.owl#OSAPICreateFile
...
- [Windows ntcreatefile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Windows%20ntcreatefile/Windows%20ntcreatefile.md)
