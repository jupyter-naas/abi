...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#GraphicsCardFirmware

### Subclass Of
```mermaid
graph BT
    d3fend.owl#GraphicsCardFirmware(Graphics<br>card<br>firmware):::d3fend-->d3fend.owl#PeripheralFirmware
...
- [Graphics card firmware](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Firmware/Peripheral%20firmware/Graphics%20card%20firmware/Graphics%20card%20firmware.md)
