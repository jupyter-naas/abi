...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxKillArgumentSIGKILL

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxKillArgumentSIGKILL(Linux<br>kill<br>argument<br>sigkill):::d3fend-->d3fend.owl#OSAPITerminateProcess
    d3fend.owl#OSAPITerminateProcess(Os<br>api<br>terminate<br>process):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api terminate process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20terminate%20process/Os%20api%20terminate%20process.md)
- [Linux kill argument sigkill](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20terminate%20process/Linux%20kill%20argument%20sigkill/Linux%20kill%20argument%20sigkill.md)
