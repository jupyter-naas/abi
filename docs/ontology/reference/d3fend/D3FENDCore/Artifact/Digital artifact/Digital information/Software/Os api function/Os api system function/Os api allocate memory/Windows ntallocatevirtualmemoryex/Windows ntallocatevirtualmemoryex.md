...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtAllocateVirtualMemoryEx

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtAllocateVirtualMemoryEx(Windows<br>ntallocatevirtualmemoryex):::d3fend-->d3fend.owl#OSAPIAllocateMemory
    d3fend.owl#OSAPIAllocateMemory(Os<br>api<br>allocate<br>memory):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api allocate memory](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20allocate%20memory/Os%20api%20allocate%20memory.md)
- [Windows ntallocatevirtualmemoryex](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20allocate%20memory/Windows%20ntallocatevirtualmemoryex/Windows%20ntallocatevirtualmemoryex.md)
