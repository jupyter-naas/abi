...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MathematicalFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MathematicalFunction(Mathematical<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Mathematical function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Mathematical%20function/Mathematical%20function.md)
