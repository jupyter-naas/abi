...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxSocketcallArgumentSYS_CONNECT

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxSocketcallArgumentSYS_CONNECT(Linux<br>socketcall<br>argument<br>sys_connect):::d3fend-->d3fend.owl#OSAPIConnectSocket
    d3fend.owl#OSAPIConnectSocket(Os<br>api<br>connect<br>socket):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api connect socket](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20connect%20socket/Os%20api%20connect%20socket.md)
- [Linux socketcall argument sys_connect](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20connect%20socket/Linux%20socketcall%20argument%20sys_connect/Linux%20socketcall%20argument%20sys_connect.md)
