...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#JobSchedule

### Subclass Of
```mermaid
graph BT
    d3fend.owl#JobSchedule(Job<br>schedule):::d3fend-->d3fend.owl#DigitalInformation
...
- [Job schedule](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Job%20schedule/Job%20schedule.md)
