...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPauseProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPauseProcess(Linux<br>pause<br>process):::d3fend-->d3fend.owl#OSAPISuspendProcess
...
- [Linux pause process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20suspend%20process/Linux%20pause%20process/Linux%20pause%20process.md)
