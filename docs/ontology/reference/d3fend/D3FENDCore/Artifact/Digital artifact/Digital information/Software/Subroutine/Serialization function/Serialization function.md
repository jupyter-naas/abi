...
### Definition
A function which has an operation that serializes data.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SerializationFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SerializationFunction(Serialization<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Serialization function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Serialization%20function/Serialization%20function.md)
