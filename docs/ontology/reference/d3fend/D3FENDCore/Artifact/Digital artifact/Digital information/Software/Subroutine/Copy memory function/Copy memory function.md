...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CopyMemoryFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CopyMemoryFunction(Copy<br>memory<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Copy memory function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Copy%20memory%20function/Copy%20memory%20function.md)
