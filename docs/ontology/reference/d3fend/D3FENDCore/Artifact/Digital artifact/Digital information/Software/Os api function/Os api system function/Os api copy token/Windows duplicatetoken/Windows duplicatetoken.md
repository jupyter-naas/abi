...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsDuplicateToken

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsDuplicateToken(Windows<br>duplicatetoken):::d3fend-->d3fend.owl#OSAPICopyToken
...
- [Windows duplicatetoken](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20copy%20token/Windows%20duplicatetoken/Windows%20duplicatetoken.md)
