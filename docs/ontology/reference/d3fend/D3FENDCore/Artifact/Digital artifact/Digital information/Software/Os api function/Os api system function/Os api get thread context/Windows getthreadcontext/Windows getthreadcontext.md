...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsGetThreadContext

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsGetThreadContext(Windows<br>getthreadcontext):::d3fend-->d3fend.owl#OSAPIGetThreadContext
...
- [Windows getthreadcontext](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20get%20thread%20context/Windows%20getthreadcontext/Windows%20getthreadcontext.md)
