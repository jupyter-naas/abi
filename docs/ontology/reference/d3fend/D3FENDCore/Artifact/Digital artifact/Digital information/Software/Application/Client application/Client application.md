...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ClientApplication

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ClientApplication(Client<br>application):::d3fend-->d3fend.owl#Application
...
- [Client application](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/Client%20application/Client%20application.md)
