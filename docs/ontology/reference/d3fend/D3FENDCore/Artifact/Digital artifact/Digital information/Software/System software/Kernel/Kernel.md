...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Kernel

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Kernel(Kernel):::d3fend-->d3fend.owl#SystemSoftware
...
- [Kernel](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/System%20software/Kernel/Kernel.md)
