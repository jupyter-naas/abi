...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#VirtualAddress

### Subclass Of
```mermaid
graph BT
    d3fend.owl#VirtualAddress(Virtual<br>address):::d3fend-->d3fend.owl#MemoryAddress
...
- [Virtual address](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Memory%20address/Virtual%20address/Virtual%20address.md)
