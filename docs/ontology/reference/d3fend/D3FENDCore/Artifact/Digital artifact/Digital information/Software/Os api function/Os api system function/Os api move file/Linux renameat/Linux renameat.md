...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxRenameat

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxRenameat(Linux<br>renameat):::d3fend-->d3fend.owl#OSAPIMoveFile
...
- [Linux renameat](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20move%20file/Linux%20renameat/Linux%20renameat.md)
