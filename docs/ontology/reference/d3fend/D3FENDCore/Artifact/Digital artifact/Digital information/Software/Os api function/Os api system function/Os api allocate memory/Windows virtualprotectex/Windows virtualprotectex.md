...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsVirtualProtectEx

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsVirtualProtectEx(Windows<br>virtualprotectex):::d3fend-->d3fend.owl#OSAPIAllocateMemory
...
- [Windows virtualprotectex](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20allocate%20memory/Windows%20virtualprotectex/Windows%20virtualprotectex.md)
