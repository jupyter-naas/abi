...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#BrowserExtension

### Subclass Of
```mermaid
graph BT
    d3fend.owl#BrowserExtension(Browser<br>extension):::d3fend-->d3fend.owl#UserApplication
...
- [Browser extension](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Browser%20extension/Browser%20extension.md)
