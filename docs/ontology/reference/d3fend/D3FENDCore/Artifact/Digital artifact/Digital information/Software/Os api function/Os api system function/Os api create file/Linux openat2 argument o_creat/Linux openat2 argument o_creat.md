...
### Definition
Create a regular file. Extension of Linux Openat.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxOpenAt2ArgumentO_CREAT

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxOpenAt2ArgumentO_CREAT(Linux<br>openat2<br>argument<br>o_creat):::d3fend-->d3fend.owl#OSAPICreateFile
    d3fend.owl#OSAPICreateFile(Os<br>api<br>create<br>file):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api create file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Os%20api%20create%20file.md)
- [Linux openat2 argument o_creat](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Linux%20openat2%20argument%20o_creat/Linux%20openat2%20argument%20o_creat.md)
