...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LogMessageFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LogMessageFunction(Log<br>message<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Log message function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Log%20message%20function/Log%20message%20function.md)
