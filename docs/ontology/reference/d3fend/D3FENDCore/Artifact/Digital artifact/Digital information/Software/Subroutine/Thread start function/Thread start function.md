...
### Definition
A function which invokes a create thread system call.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ThreadStartFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ThreadStartFunction(Thread<br>start<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Thread start function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Thread%20start%20function/Thread%20start%20function.md)
