...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ApplicationInstaller

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ApplicationInstaller(Application<br>installer):::d3fend-->d3fend.owl#UserApplication
...
- [Application installer](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Application%20installer/Application%20installer.md)
