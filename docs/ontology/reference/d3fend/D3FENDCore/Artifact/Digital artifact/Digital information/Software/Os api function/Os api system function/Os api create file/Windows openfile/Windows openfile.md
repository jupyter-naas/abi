...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowOpenFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowOpenFile(Windows<br>openfile):::d3fend-->d3fend.owl#OSAPICreateFile
...
- [Windows openfile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Windows%20openfile/Windows%20openfile.md)
