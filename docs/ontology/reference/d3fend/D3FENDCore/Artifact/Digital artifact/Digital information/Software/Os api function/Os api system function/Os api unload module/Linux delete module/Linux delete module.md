...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxDeleteModule

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxDeleteModule(Linux<br>delete<br>module):::d3fend-->d3fend.owl#OSAPIUnloadModule
    d3fend.owl#OSAPIUnloadModule(Os<br>api<br>unload<br>module):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api unload module](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20unload%20module/Os%20api%20unload%20module.md)
- [Linux delete module](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20unload%20module/Linux%20delete%20module/Linux%20delete%20module.md)
