# Ot read device configuration data
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTReadDeviceConfigurationData

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTReadDeviceConfigurationData(Ot<br>read<br>device<br>configuration<br>data):::d3fend-->d3fend.owl#OTGetData
...
- [Ot read device configuration data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20get%20data/Ot%20read%20device%20configuration%20data/Ot%20read%20device%20configuration%20data.md)
