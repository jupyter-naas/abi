...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxMmap2

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxMmap2(Linux<br>mmap2):::d3fend-->d3fend.owl#OSAPIAllocateMemory
...
- [Linux mmap2](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20allocate%20memory/Linux%20mmap2/Linux%20mmap2.md)
