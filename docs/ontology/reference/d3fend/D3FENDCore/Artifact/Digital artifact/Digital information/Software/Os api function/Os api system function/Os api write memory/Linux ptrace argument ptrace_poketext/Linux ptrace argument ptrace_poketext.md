...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPtraceArgumentPTRACEPOKETEXT

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPtraceArgumentPTRACEPOKETEXT(Linux<br>ptrace<br>argument<br>ptrace_poketext):::d3fend-->d3fend.owl#OSAPIWriteMemory
    d3fend.owl#OSAPIWriteMemory(Os<br>api<br>write<br>memory):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api write memory](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20memory/Os%20api%20write%20memory.md)
- [Linux ptrace argument ptrace_poketext](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20memory/Linux%20ptrace%20argument%20ptrace_poketext/Linux%20ptrace%20argument%20ptrace_poketext.md)
