...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MemoryWord

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MemoryWord(Memory<br>word):::d3fend-->d3fend.owl#MemoryExtent
...
- [Memory word](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Memory%20extent/Memory%20word/Memory%20word.md)
