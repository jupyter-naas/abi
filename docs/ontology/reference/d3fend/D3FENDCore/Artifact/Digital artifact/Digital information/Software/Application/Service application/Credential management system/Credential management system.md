...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CredentialManagementSystem

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CredentialManagementSystem(Credential<br>management<br>system):::d3fend-->d3fend.owl#ServiceApplication
...
- [Credential management system](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/Service%20application/Credential%20management%20system/Credential%20management%20system.md)
