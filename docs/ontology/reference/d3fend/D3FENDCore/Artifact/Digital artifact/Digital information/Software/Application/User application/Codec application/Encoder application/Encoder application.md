...
### Definition
An application that encodes digital data.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#EncoderApplication

### Subclass Of
```mermaid
graph BT
    d3fend.owl#EncoderApplication(Encoder<br>application):::d3fend-->d3fend.owl#CodecApplication
...
- [Encoder application](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Codec%20application/Encoder%20application/Encoder%20application.md)
