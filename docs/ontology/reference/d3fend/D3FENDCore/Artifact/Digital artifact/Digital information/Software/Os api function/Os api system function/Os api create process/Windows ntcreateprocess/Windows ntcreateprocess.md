...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtCreateProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtCreateProcess(Windows<br>ntcreateprocess):::d3fend-->d3fend.owl#OSAPICreateProcess
...
- [Windows ntcreateprocess](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20process/Windows%20ntcreateprocess/Windows%20ntcreateprocess.md)
