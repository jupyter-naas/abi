...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#EvalFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#EvalFunction(Eval<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Eval function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Eval%20function/Eval%20function.md)
