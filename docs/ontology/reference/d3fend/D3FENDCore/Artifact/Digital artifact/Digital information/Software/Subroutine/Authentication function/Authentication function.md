...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#AuthenticationFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#AuthenticationFunction(Authentication<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Authentication function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Authentication%20function/Authentication%20function.md)
