...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#HardDiskFirmware

### Subclass Of
```mermaid
graph BT
    d3fend.owl#HardDiskFirmware(Hard<br>disk<br>firmware):::d3fend-->d3fend.owl#PeripheralFirmware
...
- [Hard disk firmware](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Firmware/Peripheral%20firmware/Hard%20disk%20firmware/Hard%20disk%20firmware.md)
