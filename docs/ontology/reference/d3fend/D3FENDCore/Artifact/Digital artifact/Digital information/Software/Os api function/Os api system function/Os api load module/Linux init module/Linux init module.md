...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxInitModule

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxInitModule(Linux<br>init<br>module):::d3fend-->d3fend.owl#OSAPILoadModule
    d3fend.owl#OSAPILoadModule(Os<br>api<br>load<br>module):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api load module](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20load%20module/Os%20api%20load%20module.md)
- [Linux init module](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20load%20module/Linux%20init%20module/Linux%20init%20module.md)
