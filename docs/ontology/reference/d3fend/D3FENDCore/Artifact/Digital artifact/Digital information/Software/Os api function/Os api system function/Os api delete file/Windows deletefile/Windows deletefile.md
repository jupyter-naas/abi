...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsDeleteFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsDeleteFile(Windows<br>deletefile):::d3fend-->d3fend.owl#OSAPIDeleteFile
...
- [Windows deletefile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20delete%20file/Windows%20deletefile/Windows%20deletefile.md)
