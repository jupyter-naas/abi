...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtWriteFileGather

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtWriteFileGather(Windows<br>ntwritefilegather):::d3fend-->d3fend.owl#OSAPIWriteFile
    d3fend.owl#OSAPIWriteFile(Os<br>api<br>write<br>file):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api write file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20file/Os%20api%20write%20file.md)
- [Windows ntwritefilegather](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20file/Windows%20ntwritefilegather/Windows%20ntwritefilegather.md)
