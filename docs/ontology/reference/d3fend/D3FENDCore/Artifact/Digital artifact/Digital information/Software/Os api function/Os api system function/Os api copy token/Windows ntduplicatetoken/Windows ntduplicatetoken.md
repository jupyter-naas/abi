...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtDuplicateToken

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtDuplicateToken(Windows<br>ntduplicatetoken):::d3fend-->d3fend.owl#OSAPICopyToken
    d3fend.owl#OSAPICopyToken(Os<br>api<br>copy<br>token):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api copy token](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20copy%20token/Os%20api%20copy%20token.md)
- [Windows ntduplicatetoken](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20copy%20token/Windows%20ntduplicatetoken/Windows%20ntduplicatetoken.md)
