...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#StoredProcedure

### Subclass Of
```mermaid
graph BT
    d3fend.owl#StoredProcedure(Stored<br>procedure):::d3fend-->d3fend.owl#Subroutine
...
- [Stored procedure](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Stored%20procedure/Stored%20procedure.md)
