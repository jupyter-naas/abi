...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ShimDatabase

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ShimDatabase(Shim<br>database):::d3fend-->d3fend.owl#ApplicationConfigurationDatabase
...
- [Shim database](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/Configuration%20resource/Configuration%20database/Application%20configuration%20database/Shim%20database/Shim%20database.md)
