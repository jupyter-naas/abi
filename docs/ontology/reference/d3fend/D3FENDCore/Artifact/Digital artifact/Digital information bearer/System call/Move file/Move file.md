...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MoveFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MoveFile(Move<br>file):::d3fend-->d3fend.owl#SystemCall
...
- [Move file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Move%20file/Move%20file.md)
