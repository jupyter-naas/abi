...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#GetSystemTime

### Subclass Of
```mermaid
graph BT
    d3fend.owl#GetSystemTime(Get<br>system<br>time):::d3fend-->d3fend.owl#SystemCall
...
- [Get system time](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Get%20system%20time/Get%20system%20time.md)
