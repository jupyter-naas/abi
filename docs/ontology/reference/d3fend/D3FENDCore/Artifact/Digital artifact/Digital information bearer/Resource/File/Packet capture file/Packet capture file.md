...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#PacketCaptureFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#PacketCaptureFile(Packet<br>capture<br>file):::d3fend-->d3fend.owl#File
...
- [Packet capture file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Packet%20capture%20file/Packet%20capture%20file.md)
