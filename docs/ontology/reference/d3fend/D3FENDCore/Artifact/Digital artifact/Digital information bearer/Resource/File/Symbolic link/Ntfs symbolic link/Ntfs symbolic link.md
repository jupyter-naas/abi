...
```mermaid
graph BT
    d3fend.owl#NTFSSymbolicLink(Ntfs<br>symbolic<br>link):::d3fend-->d3fend.owl#SymbolicLink
...
- [Ntfs symbolic link](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Symbolic%20link/Ntfs%20symbolic%20link/Ntfs%20symbolic%20link.md)
