...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OfficeApplicationFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OfficeApplicationFile(Office<br>application<br>file):::d3fend-->d3fend.owl#DocumentFile
...
- [Office application file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Document%20file/Office%20application%20file/Office%20application%20file.md)
