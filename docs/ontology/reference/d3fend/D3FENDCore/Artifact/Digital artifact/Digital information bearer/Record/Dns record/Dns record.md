...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DNSRecord

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DNSRecord(Dns<br>record):::d3fend-->d3fend.owl#Record
...
- [Dns record](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Record/Dns%20record/Dns%20record.md)
