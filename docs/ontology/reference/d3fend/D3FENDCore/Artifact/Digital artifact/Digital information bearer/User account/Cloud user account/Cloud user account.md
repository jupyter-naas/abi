...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CloudUserAccount

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CloudUserAccount(Cloud<br>user<br>account):::d3fend-->d3fend.owl#UserAccount
...
- [Cloud user account](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/User%20account/Cloud%20user%20account/Cloud%20user%20account.md)
