...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Storage

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Storage(Storage):::d3fend-->d3fend.owl#DigitalInformationBearer
...
- [Storage](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Storage/Storage.md)
