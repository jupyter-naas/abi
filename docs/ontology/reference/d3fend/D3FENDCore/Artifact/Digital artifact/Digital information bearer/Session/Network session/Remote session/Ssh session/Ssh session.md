...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SSHSession

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SSHSession(Ssh<br>session):::d3fend-->d3fend.owl#RemoteSession
...
- [Ssh session](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Session/Network%20session/Remote%20session/Ssh%20session/Ssh%20session.md)
