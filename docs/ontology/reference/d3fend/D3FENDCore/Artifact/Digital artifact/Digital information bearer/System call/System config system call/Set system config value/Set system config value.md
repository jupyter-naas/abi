...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SetSystemConfigValue

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SetSystemConfigValue(Set<br>system<br>config<br>value):::d3fend-->d3fend.owl#SystemConfigSystemCall
...
- [Set system config value](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/System%20config%20system%20call/Set%20system%20config%20value/Set%20system%20config%20value.md)
