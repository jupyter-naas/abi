...
```mermaid
graph BT
    d3fend.owl#AccessControlList(Access<br>control<br>list):::d3fend-->d3fend.owl#AccessControlConfiguration
...
- [Access control list](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/Configuration%20resource/Access%20control%20configuration/Access%20control%20list/Access%20control%20list.md)
