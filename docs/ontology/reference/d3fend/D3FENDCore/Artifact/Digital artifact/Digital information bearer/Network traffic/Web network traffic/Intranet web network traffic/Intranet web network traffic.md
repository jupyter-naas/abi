...
```mermaid
graph BT
    d3fend.owl#IntranetWebNetworkTraffic(Intranet<br>web<br>network<br>traffic):::d3fend-->d3fend.owl#WebNetworkTraffic
...
- [Intranet web network traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/Web%20network%20traffic/Intranet%20web%20network%20traffic/Intranet%20web%20network%20traffic.md)
