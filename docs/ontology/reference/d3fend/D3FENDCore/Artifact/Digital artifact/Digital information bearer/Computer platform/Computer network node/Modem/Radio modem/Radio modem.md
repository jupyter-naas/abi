...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#RadioModem

### Subclass Of
```mermaid
graph BT
    d3fend.owl#RadioModem(Radio<br>modem):::d3fend-->d3fend.owl#Modem
...
- [Radio modem](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Modem/Radio%20modem/Radio%20modem.md)
