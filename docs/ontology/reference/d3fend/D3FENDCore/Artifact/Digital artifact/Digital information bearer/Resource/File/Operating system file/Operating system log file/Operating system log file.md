...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OperatingSystemLogFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OperatingSystemLogFile(Operating<br>system<br>log<br>file):::d3fend-->d3fend.owl#OperatingSystemFile
...
- [Operating system log file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Operating%20system%20file/Operating%20system%20log%20file/Operating%20system%20log%20file.md)
