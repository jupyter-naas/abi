...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DirectoryService

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DirectoryService(Directory<br>service):::d3fend-->d3fend.owl#NetworkService
...
- [Directory service](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Process/User%20process/Application%20process/Service%20application%20process/Network%20service/Directory%20service/Directory%20service.md)
