...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WriteFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WriteFile(Write<br>file):::d3fend-->d3fend.owl#SystemCall
...
- [Write file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Write%20file/Write%20file.md)
