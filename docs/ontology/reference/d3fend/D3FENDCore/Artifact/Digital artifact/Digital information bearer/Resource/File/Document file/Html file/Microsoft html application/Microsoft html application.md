...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MicrosoftHTMLApplication

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MicrosoftHTMLApplication(Microsoft<br>html<br>application):::d3fend-->d3fend.owl#HTMLFile
...
- [Microsoft html application](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Document%20file/Html%20file/Microsoft%20html%20application/Microsoft%20html%20application.md)
