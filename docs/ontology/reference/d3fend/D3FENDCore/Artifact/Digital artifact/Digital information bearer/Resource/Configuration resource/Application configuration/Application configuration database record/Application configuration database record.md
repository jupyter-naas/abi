...
```mermaid
graph BT
    d3fend.owl#ApplicationConfigurationDatabaseRecord(Application<br>configuration<br>database<br>record):::d3fend-->d3fend.owl#ApplicationConfiguration
...
- [Application configuration database record](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/Configuration%20resource/Application%20configuration/Application%20configuration%20database%20record/Application%20configuration%20database%20record.md)
