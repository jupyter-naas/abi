...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OrchestrationWorker

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OrchestrationWorker(Orchestration<br>worker):::d3fend-->d3fend.owl#OrchestrationServer
...
- [Orchestration worker](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Orchestration%20server/Orchestration%20worker/Orchestration%20worker.md)
