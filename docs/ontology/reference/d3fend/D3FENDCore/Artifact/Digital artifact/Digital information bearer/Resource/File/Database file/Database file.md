...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DatabaseFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DatabaseFile(Database<br>file):::d3fend-->d3fend.owl#File
...
- [Database file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Database%20file/Database%20file.md)
