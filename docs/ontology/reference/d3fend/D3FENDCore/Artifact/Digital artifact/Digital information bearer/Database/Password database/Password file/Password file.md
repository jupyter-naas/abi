...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#PasswordFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#PasswordFile(Password<br>file):::d3fend-->d3fend.owl#PasswordDatabase
...
- [Password file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Database/Password%20database/Password%20file/Password%20file.md)
