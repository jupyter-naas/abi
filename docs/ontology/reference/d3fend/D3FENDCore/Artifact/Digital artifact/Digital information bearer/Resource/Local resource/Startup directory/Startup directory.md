...
```mermaid
graph BT
    d3fend.owl#StartupDirectory(Startup<br>directory):::d3fend-->d3fend.owl#LocalResource
...
- [Startup directory](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/Local%20resource/Startup%20directory/Startup%20directory.md)
