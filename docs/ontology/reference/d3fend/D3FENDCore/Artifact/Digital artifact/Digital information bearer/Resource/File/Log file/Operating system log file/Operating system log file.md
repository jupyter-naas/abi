...
```mermaid
graph BT
    d3fend.owl#OperatingSystemLogFile(Operating<br>system<br>log<br>file):::d3fend-->d3fend.owl#LogFile
...
- [Operating system log file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Log%20file/Operating%20system%20log%20file/Operating%20system%20log%20file.md)
