...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ProcessImage

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ProcessImage(Process<br>image):::d3fend-->d3fend.owl#ComputingImage
...
- [Process image](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computing%20image/Process%20image/Process%20image.md)
