...
```mermaid
graph BT
    d3fend.owl#NetworkInitScriptFileResource(Network<br>init<br>script<br>file<br>resource):::d3fend-->d3fend.owl#InitScript
...
- [Network init script file resource](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Executable%20file/Executable%20script/Init%20script/Network%20init%20script%20file%20resource/Network%20init%20script%20file%20resource.md)
