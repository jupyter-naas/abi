...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ConfigurationManagementDatabase

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ConfigurationManagementDatabase(Configuration<br>management<br>database):::d3fend-->d3fend.owl#ConfigurationDatabase
...
- [Configuration management database](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/Configuration%20resource/Configuration%20database/Configuration%20management%20database/Configuration%20management%20database.md)
