...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OutboundInternetWebTraffic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OutboundInternetWebTraffic(Outbound<br>internet<br>web<br>traffic):::d3fend-->d3fend.owl#OutboundInternetNetworkTraffic
...
- [Outbound internet web traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/Outbound%20network%20traffic/Outbound%20internet%20network%20traffic/Outbound%20internet%20web%20traffic/Outbound%20internet%20web%20traffic.md)
