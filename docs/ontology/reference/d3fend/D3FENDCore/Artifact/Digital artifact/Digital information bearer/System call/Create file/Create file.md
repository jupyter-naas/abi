...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CreateFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CreateFile(Create<br>file):::d3fend-->d3fend.owl#SystemCall
...
- [Create file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Create%20file/Create%20file.md)
