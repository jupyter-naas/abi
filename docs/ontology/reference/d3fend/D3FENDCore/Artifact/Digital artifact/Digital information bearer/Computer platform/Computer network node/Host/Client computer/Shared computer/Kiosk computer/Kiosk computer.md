...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#KioskComputer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#KioskComputer(Kiosk<br>computer):::d3fend-->d3fend.owl#SharedComputer
...
- [Kiosk computer](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Client%20computer/Shared%20computer/Kiosk%20computer/Kiosk%20computer.md)
