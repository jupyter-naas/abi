...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ChildProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ChildProcess(Child<br>process):::d3fend-->d3fend.owl#Process
...
- [Child process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Process/Child%20process/Child%20process.md)
