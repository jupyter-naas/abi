...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#FileServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#FileServer(File<br>server):::d3fend-->d3fend.owl#Server
...
- [File server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/File%20server/File%20server.md)
