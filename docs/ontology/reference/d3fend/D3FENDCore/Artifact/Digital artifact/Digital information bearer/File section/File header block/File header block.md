...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#FileHeaderBlock

### Subclass Of
```mermaid
graph BT
    d3fend.owl#FileHeaderBlock(File<br>header<br>block):::d3fend-->d3fend.owl#FileSection
...
- [File header block](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/File%20section/File%20header%20block/File%20header%20block.md)
