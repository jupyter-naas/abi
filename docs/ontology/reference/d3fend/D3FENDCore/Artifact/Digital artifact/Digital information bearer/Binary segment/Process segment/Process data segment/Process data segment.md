...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ProcessDataSegment

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ProcessDataSegment(Process<br>data<br>segment):::d3fend-->d3fend.owl#ProcessSegment
...
- [Process data segment](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Binary%20segment/Process%20segment/Process%20data%20segment/Process%20data%20segment.md)
