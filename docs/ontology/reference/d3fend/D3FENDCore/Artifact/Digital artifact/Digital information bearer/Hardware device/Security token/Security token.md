...
```mermaid
graph BT
    d3fend.owl#SecurityToken(Security<br>token):::d3fend-->d3fend.owl#HardwareDevice
...
- [Security token](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Hardware%20device/Security%20token/Security%20token.md)
