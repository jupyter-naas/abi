...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SoftwareLibraryFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SoftwareLibraryFile(Software<br>library<br>file):::d3fend-->d3fend.owl#File
...
- [Software library file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Software%20library%20file/Software%20library%20file.md)
