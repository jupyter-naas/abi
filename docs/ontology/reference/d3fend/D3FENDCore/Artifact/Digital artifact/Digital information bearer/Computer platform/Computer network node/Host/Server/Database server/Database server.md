...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DatabaseServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DatabaseServer(Database<br>server):::d3fend-->d3fend.owl#Server
...
- [Database server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Database%20server/Database%20server.md)
