...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTEngineeringWorkstation

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTEngineeringWorkstation(Ot<br>engineering<br>workstation):::d3fend-->d3fend.owl#ClientComputer
...
- [Ot engineering workstation](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Client%20computer/Ot%20engineering%20workstation/Ot%20engineering%20workstation.md)
