...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTControlLogicProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTControlLogicProcess(Ot<br>control<br>logic<br>process):::d3fend-->d3fend.owl#Process
...
- [Ot control logic process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Process/Ot%20control%20logic%20process/Ot%20control%20logic%20process.md)
