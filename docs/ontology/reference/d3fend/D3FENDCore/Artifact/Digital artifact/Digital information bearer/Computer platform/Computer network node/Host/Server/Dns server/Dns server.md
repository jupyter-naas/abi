...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DNSServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DNSServer(Dns<br>server):::d3fend-->d3fend.owl#Server
...
- [Dns server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Dns%20server/Dns%20server.md)
