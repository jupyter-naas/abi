...
```mermaid
graph BT
    d3fend.owl#Switch(Switch):::d3fend-->d3fend.owl#ComputerNetworkNode
...
- [Switch](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Switch/Switch.md)
