...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#TerminateProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#TerminateProcess(Terminate<br>process):::d3fend-->d3fend.owl#SystemCall
...
- [Terminate process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Terminate%20process/Terminate%20process.md)
