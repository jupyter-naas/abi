...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#VPNServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#VPNServer(Vpn<br>server):::d3fend-->d3fend.owl#Server
...
- [Vpn server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Vpn%20server/Vpn%20server.md)
