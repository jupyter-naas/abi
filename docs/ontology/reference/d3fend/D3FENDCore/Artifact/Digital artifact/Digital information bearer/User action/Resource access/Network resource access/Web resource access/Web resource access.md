...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WebResourceAccess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WebResourceAccess(Web<br>resource<br>access):::d3fend-->d3fend.owl#NetworkResourceAccess
...
- [Web resource access](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/User%20action/Resource%20access/Network%20resource%20access/Web%20resource%20access/Web%20resource%20access.md)
