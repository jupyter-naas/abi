...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DefaultUserAccount

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DefaultUserAccount(Default<br>user<br>account):::d3fend-->d3fend.owl#UserAccount
...
- [Default user account](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/User%20account/Default%20user%20account/Default%20user%20account.md)
