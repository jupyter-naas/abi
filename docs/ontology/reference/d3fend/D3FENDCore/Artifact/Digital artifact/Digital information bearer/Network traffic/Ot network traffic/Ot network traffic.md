...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTNetworkTraffic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTNetworkTraffic(Ot<br>network<br>traffic):::d3fend-->d3fend.owl#NetworkTraffic
...
- [Ot network traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/Ot%20network%20traffic/Ot%20network%20traffic.md)
