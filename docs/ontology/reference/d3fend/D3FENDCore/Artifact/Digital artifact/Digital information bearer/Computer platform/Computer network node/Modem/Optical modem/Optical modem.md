...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OpticalModem

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OpticalModem(Optical<br>modem):::d3fend-->d3fend.owl#Modem
...
- [Optical modem](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Modem/Optical%20modem/Optical%20modem.md)
