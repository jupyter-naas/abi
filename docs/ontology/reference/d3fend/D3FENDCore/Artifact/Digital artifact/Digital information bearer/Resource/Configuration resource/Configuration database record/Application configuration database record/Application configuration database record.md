...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ApplicationConfigurationDatabaseRecord

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ApplicationConfigurationDatabaseRecord(Application<br>configuration<br>database<br>record):::d3fend-->d3fend.owl#ConfigurationDatabaseRecord
...
- [Application configuration database record](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/Configuration%20resource/Configuration%20database%20record/Application%20configuration%20database%20record/Application%20configuration%20database%20record.md)
