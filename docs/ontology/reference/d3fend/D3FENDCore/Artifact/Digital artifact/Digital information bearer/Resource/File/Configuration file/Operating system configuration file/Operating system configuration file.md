...
```mermaid
graph BT
    d3fend.owl#OperatingSystemConfigurationFile(Operating<br>system<br>configuration<br>file):::d3fend-->d3fend.owl#ConfigurationFile
...
- [Operating system configuration file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Configuration%20file/Operating%20system%20configuration%20file/Operating%20system%20configuration%20file.md)
