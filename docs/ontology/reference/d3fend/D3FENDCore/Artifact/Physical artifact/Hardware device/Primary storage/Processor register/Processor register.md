...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ProcessorRegister

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ProcessorRegister(Processor<br>register):::d3fend-->d3fend.owl#PrimaryStorage
...
- [Processor register](/docs/ontology/reference/model/D3FENDCore/Artifact/Physical%20artifact/Hardware%20device/Primary%20storage/Processor%20register/Processor%20register.md)
