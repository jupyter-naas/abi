...
```mermaid
graph BT
    ont00000083(Process<br>ending):::cco-->BFO_0000035
...
- [Process ending](/docs/ontology/reference/model/Entity/Occurrent/Process%20boundary/Process%20ending/Process%20ending.md)
