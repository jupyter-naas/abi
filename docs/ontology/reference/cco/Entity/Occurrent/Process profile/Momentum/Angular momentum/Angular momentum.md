...
```mermaid
graph BT
    ont00000955(Angular<br>momentum):::cco-->ont00000278
    ont00000278(Momentum):::cco-->BFO_0000144
...
- [Momentum](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Momentum/Momentum.md)
- [Angular momentum](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Momentum/Angular%20momentum/Angular%20momentum.md)
