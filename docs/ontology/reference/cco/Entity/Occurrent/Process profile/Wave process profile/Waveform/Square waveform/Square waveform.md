...
```mermaid
graph BT
    ont00000414(Square<br>waveform):::cco-->ont00001286
...
- [Square waveform](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Wave%20process%20profile/Waveform/Square%20waveform/Square%20waveform.md)
