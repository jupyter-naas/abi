...
```mermaid
graph BT
    ont00001112(Proper<br>acceleration):::cco-->ont00000712
    ont00000712(Acceleration):::cco-->BFO_0000144
...
- [Acceleration](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Acceleration/Acceleration.md)
- [Proper acceleration](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Acceleration/Proper%20acceleration/Proper%20acceleration.md)
