...
```mermaid
graph BT
    ont00000197(Process<br>beginning):::cco-->BFO_0000035
...
- [Process boundary](/docs/ontology/reference/model/Entity/Occurrent/Process%20boundary/Process%20boundary.md)
- [Process beginning](/docs/ontology/reference/model/Entity/Occurrent/Process%20boundary/Process%20beginning/Process%20beginning.md)
