...
```mermaid
graph BT
    ont00000296(Angular<br>velocity):::cco-->ont00000763
    ont00000763(Velocity):::cco-->BFO_0000144
...
- [Velocity](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Velocity/Velocity.md)
- [Angular velocity](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Velocity/Angular%20velocity/Angular%20velocity.md)
