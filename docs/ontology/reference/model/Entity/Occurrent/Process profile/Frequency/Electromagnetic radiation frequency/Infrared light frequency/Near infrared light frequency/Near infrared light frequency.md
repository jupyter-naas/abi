...
### Subclass Of
- Infrared Light Frequency: https://www.commoncoreontologies.org/ont00001337
...
```mermaid
graph BT
    ont00000155(Near<br>infrared<br>light<br>frequency):::ABI-->ont00001337
    ont00001337(Infrared<br>light<br>frequency):::ABI-->ont00000754
