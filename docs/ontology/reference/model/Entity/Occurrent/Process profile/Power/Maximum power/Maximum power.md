...
```mermaid
graph BT
    ont00000138(Maximum<br>power):::cco-->ont00000503
    ont00000503(Power):::cco-->BFO_0000144
...
- [Power](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Power/Power.md)
- [Maximum power](/docs/ontology/reference/model/Entity/Occurrent/Process%20profile/Power/Maximum%20power/Maximum%20power.md)
