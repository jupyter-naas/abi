...
### Subclass Of
- Notification Message: https://www.commoncoreontologies.org/ont00001046
...
```mermaid
graph BT
    ont00000471(Warning<br>message):::ABI-->ont00001046
    ont00001046(Notification<br>message):::ABI-->ont00001002
    ont00001002(Message):::ABI-->ont00000798
