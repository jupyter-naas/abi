...
### Subclass Of
- Telecommunication Network Node: https://www.commoncoreontologies.org/ont00000918
...
```mermaid
graph BT
    ont00000315(Telecommunication<br>switching<br>node):::ABI-->ont00000918
    ont00000918(Telecommunication<br>network<br>node):::ABI-->ont00000346
