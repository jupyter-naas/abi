...
### Subclass Of
- Internal Combustion Engine: https://www.commoncoreontologies.org/ont00000394
...
```mermaid
graph BT
    ont00000807(Compression<br>ignition<br>engine):::ABI-->ont00000394
    ont00000394(Internal<br>combustion<br>engine):::ABI-->ont00000746
