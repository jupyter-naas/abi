...
### Subclass Of
- Observation Artifact Function: https://www.commoncoreontologies.org/ont00001306
...
```mermaid
graph BT
    ont00001087(Orientation<br>observation<br>artifact<br>function):::ABI-->ont00001306
    ont00001306(Observation<br>artifact<br>function):::ABI-->ont00000323
