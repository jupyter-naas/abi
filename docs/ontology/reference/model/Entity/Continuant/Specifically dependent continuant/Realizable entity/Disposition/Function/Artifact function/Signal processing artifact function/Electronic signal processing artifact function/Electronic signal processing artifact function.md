...
```mermaid
graph BT
    ont00000317(Electronic<br>signal<br>processing<br>artifact<br>function<br>ont00000317):::ABI-->ont00001218
    ont00001218(Signal<br>processing<br>artifact<br>function<br>ont00001218):::ABI-->ont00000323
