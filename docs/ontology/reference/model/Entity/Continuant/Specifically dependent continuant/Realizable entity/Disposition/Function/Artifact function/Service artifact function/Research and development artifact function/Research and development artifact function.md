...
### Subclass Of
- Service Artifact Function: https://www.commoncoreontologies.org/ont00001301
...
```mermaid
graph BT
    ont00000481(Research<br>and<br>development<br>artifact<br>function):::ABI-->ont00001301
    ont00001301(Service<br>artifact<br>function):::ABI-->ont00000323
