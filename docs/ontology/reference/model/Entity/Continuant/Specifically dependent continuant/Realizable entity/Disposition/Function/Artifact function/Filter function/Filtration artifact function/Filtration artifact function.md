...
### Subclass Of
- Filter Function: https://www.commoncoreontologies.org/ont00001999
...
```mermaid
graph BT
    ont00000311(Filtration<br>artifact<br>function):::ABI-->ont00001999
    ont00001999(Filter<br>function):::ABI-->ont00000323
