...
### Subclass Of
- Measurement Artifact Function: https://www.commoncoreontologies.org/ont00001100
...
```mermaid
graph BT
    ont00000947(Temperature<br>measurement<br>artifact<br>function):::ABI-->ont00001100
    ont00001100(Measurement<br>artifact<br>function):::ABI-->ont00000323
