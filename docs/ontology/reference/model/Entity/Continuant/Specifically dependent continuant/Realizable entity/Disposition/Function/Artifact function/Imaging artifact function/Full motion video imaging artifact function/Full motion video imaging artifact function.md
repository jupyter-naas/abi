...
### Subclass Of
- Imaging Artifact Function: https://www.commoncoreontologies.org/ont00000601
...
```mermaid
graph BT
    ont00001155(Full<br>motion<br>video<br>imaging<br>artifact<br>function):::ABI-->ont00000601
