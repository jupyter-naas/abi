...
```mermaid
graph BT
    ont00001129(Pressurization<br>control<br>artifact<br>function<br>ont00001129):::ABI-->ont00000113
    ont00000113(Ventilation<br>control<br>artifact<br>function<br>ont00000113):::ABI-->ont00000323
