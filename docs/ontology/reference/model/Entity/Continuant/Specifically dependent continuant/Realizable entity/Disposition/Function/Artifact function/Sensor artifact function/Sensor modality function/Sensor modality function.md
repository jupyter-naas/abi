...
### Subclass Of
- Sensor Artifact Function: https://www.commoncoreontologies.org/ont00001241
...
```mermaid
graph BT
    ont00001273(Sensor<br>modality<br>function):::ABI-->ont00001241
    ont00001241(Sensor<br>artifact<br>function):::ABI-->ont00000323
