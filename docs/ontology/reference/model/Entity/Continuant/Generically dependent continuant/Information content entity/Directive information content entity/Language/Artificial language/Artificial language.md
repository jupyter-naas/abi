...
### Subclass Of
- Language: https://www.commoncoreontologies.org/ont00001175
...
```mermaid
graph BT
    ont00000146(Artificial<br>language):::ABI-->ont00001175
    ont00001175(Language):::ABI-->ont00000965
...
| [language used in](https://www.commoncoreontologies.org/ont00001942) | x language_used_by y iff y is an instance of Information Bearing Entity and x is an instance of Language, such that the literal value of y is a string that is encoded according to the syntax of x. |  | [Language](https://www.commoncoreontologies.org/ont00001175) | [Information Bearing Entity](https://www.commoncoreontologies.org/ont00000253) | [uses language](https://www.commoncoreontologies.org/ont00001976) |
