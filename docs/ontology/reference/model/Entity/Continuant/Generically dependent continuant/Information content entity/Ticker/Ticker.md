...
```mermaid
graph BT
    Ticker(Ticker<br>Ticker):::ABI-->ont00000958
...
|-----------|---------|--------|---------|------------|----------|------------|
| http://ontology.naas.ai/abi/isTickerSymbolOf | ['http://ontology.naas.ai/abi/Ticker'] | ['https://www.commoncoreontologies.org/ont00001180'] | is ticker symbol of | Relates a ticker symbol to the organization it belongs to. |  | None |
