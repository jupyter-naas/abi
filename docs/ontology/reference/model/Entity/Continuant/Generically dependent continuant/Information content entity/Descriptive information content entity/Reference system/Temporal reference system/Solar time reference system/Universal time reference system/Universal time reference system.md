...
### Subclass Of
- Solar Time Reference System: https://www.commoncoreontologies.org/ont00000124
...
```mermaid
graph BT
    ont00000630(Universal<br>time<br>reference<br>system):::ABI-->ont00000124
    ont00000124(Solar<br>time<br>reference<br>system):::ABI-->ont00001328
    ont00001328(Temporal<br>reference<br>system):::ABI-->ont00000398
