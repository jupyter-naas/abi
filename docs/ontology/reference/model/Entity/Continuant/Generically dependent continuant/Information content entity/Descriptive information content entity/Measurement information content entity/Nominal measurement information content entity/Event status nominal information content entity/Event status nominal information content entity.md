...
### Subclass Of
- Nominal Measurement Information Content Entity: https://www.commoncoreontologies.org/ont00000293
...
```mermaid
graph BT
    ont00000203(Event<br>status<br>nominal<br>information<br>content<br>entity):::ABI-->ont00000293
    ont00000293(Nominal<br>measurement<br>information<br>content<br>entity):::ABI-->ont00001163
...
| [is a nominal measurement of](https://www.commoncoreontologies.org/ont00001982) | x is_a_nominal_measurement_of y iff x is an instance of Information Content Entity and y is an instance of Entity, such that x classifies y relative to some set of shared, possibly arbitrary, characteristics. |  | [Nominal Measurement Information Content Entity](https://www.commoncoreontologies.org/ont00000293) |  | [is measured by nominal](https://www.commoncoreontologies.org/ont00001914) |
