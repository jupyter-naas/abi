...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#UserManualReference

### Subclass Of
```mermaid
graph BT
    d3fend.owl#UserManualReference(User<br>manual<br>reference):::d3fend-->d3fend.owl#TechniqueReference
...
- [User manual reference](/docs/ontology/reference/model/D3FENDKBThing/Technique%20reference/User%20manual%20reference/User%20manual%20reference.md)
