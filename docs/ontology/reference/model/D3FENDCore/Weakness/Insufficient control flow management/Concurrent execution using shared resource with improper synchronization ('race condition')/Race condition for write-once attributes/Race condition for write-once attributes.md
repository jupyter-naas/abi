...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1223

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1223(Race<br>condition<br>for<br>write-once<br>attributes):::d3fend-->d3fend.owl#CWE-362
...
- [Race condition for write-once attributes](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Concurrent%20execution%20using%20shared%20resource%20with%20improper%20synchronization%20%28%27race%20condition%27%29/Race%20condition%20for%20write-once%20attributes/Race%20condition%20for%20write-once%20attributes.md)
