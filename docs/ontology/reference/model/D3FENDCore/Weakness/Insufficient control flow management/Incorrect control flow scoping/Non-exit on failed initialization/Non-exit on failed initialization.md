...
```mermaid
graph BT
    d3fend.owl#CWE-455(Non-exit<br>on<br>failed<br>initialization):::d3fend-->d3fend.owl#CWE-705
...
- [Non-exit on failed initialization](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Incorrect%20control%20flow%20scoping/Non-exit%20on%20failed%20initialization/Non-exit%20on%20failed%20initialization.md)
