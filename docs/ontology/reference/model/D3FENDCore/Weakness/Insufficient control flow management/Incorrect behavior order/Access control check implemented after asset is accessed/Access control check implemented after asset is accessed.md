...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1280

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1280(Access<br>control<br>check<br>implemented<br>after<br>asset<br>is<br>accessed):::d3fend-->d3fend.owl#CWE-696
...
- [Access control check implemented after asset is accessed](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Incorrect%20behavior%20order/Access%20control%20check%20implemented%20after%20asset%20is%20accessed/Access%20control%20check%20implemented%20after%20asset%20is%20accessed.md)
