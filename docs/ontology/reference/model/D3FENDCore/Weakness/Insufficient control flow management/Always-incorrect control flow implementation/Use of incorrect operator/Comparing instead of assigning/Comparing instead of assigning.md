...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-482

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-482(Comparing<br>instead<br>of<br>assigning):::d3fend-->d3fend.owl#CWE-480
...
- [Comparing instead of assigning](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Always-incorrect%20control%20flow%20implementation/Use%20of%20incorrect%20operator/Comparing%20instead%20of%20assigning/Comparing%20instead%20of%20assigning.md)
