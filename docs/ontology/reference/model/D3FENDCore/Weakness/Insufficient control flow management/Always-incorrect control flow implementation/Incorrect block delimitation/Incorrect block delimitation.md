...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-483

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-483(Incorrect<br>block<br>delimitation):::d3fend-->d3fend.owl#CWE-670
...
- [Incorrect block delimitation](/docs/ontology/reference/model/D3FENDCore/Weakness/Insufficient%20control%20flow%20management/Always-incorrect%20control%20flow%20implementation/Incorrect%20block%20delimitation/Incorrect%20block%20delimitation.md)
