...
```mermaid
graph BT
    d3fend.owl#CWE-250(Execution<br>with<br>unnecessary<br>privileges):::d3fend-->d3fend.owl#CWE-657
...
- [Execution with unnecessary privileges](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Violation%20of%20secure%20design%20principles/Execution%20with%20unnecessary%20privileges/Execution%20with%20unnecessary%20privileges.md)
