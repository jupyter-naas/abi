...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-585

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-585(Empty<br>synchronized<br>block):::d3fend-->d3fend.owl#CWE-1071
...
- [Empty synchronized block](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Irrelevant%20code/Empty%20code%20block/Empty%20synchronized%20block/Empty%20synchronized%20block.md)
