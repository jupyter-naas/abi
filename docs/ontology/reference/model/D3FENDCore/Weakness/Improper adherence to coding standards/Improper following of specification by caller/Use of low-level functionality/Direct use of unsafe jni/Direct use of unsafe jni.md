...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-111

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-111(Direct<br>use<br>of<br>unsafe<br>jni):::d3fend-->d3fend.owl#CWE-695
...
- [Direct use of unsafe jni](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Improper%20following%20of%20specification%20by%20caller/Use%20of%20low-level%20functionality/Direct%20use%20of%20unsafe%20jni/Direct%20use%20of%20unsafe%20jni.md)
