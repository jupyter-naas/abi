...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-325

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-325(Missing<br>cryptographic<br>step):::d3fend-->d3fend.owl#CWE-573
...
- [Missing cryptographic step](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Improper%20following%20of%20specification%20by%20caller/Missing%20cryptographic%20step/Missing%20cryptographic%20step.md)
