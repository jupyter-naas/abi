...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-393

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-393(Return<br>of<br>wrong<br>status<br>code):::d3fend-->d3fend.owl#CWE-684
...
- [Return of wrong status code](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20adherence%20to%20coding%20standards/Incorrect%20provision%20of%20specified%20functionality/Return%20of%20wrong%20status%20code/Return%20of%20wrong%20status%20code.md)
