...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-353

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-353(Missing<br>support<br>for<br>integrity<br>check):::d3fend-->d3fend.owl#CWE-345
...
- [Missing support for integrity check](/docs/ontology/reference/model/D3FENDCore/Weakness/Protection%20mechanism%20failure/Insufficient%20verification%20of%20data%20authenticity/Missing%20support%20for%20integrity%20check/Missing%20support%20for%20integrity%20check.md)
