...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-348

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-348(Use<br>of<br>less<br>trusted<br>source):::d3fend-->d3fend.owl#CWE-345
...
- [Use of less trusted source](/docs/ontology/reference/model/D3FENDCore/Weakness/Protection%20mechanism%20failure/Insufficient%20verification%20of%20data%20authenticity/Use%20of%20less%20trusted%20source/Use%20of%20less%20trusted%20source.md)
