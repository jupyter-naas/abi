...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-603

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-603(Use<br>of<br>client-side<br>authentication):::d3fend-->d3fend.owl#CWE-602
...
- [Use of client-side authentication](/docs/ontology/reference/model/D3FENDCore/Weakness/Protection%20mechanism%20failure/Client-side%20enforcement%20of%20server-side%20security/Use%20of%20client-side%20authentication/Use%20of%20client-side%20authentication.md)
