...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-187

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-187(Partial<br>string<br>comparison):::d3fend-->d3fend.owl#CWE-1023
...
- [Partial string comparison](/docs/ontology/reference/model/D3FENDCore/Weakness/Incorrect%20comparison/Incomplete%20comparison%20with%20missing%20factors/Partial%20string%20comparison/Partial%20string%20comparison.md)
