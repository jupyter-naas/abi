...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-839

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-839(Numeric<br>range<br>comparison<br>without<br>minimum<br>check):::d3fend-->d3fend.owl#CWE-1023
...
- [Numeric range comparison without minimum check](/docs/ontology/reference/model/D3FENDCore/Weakness/Incorrect%20comparison/Incomplete%20comparison%20with%20missing%20factors/Numeric%20range%20comparison%20without%20minimum%20check/Numeric%20range%20comparison%20without%20minimum%20check.md)
