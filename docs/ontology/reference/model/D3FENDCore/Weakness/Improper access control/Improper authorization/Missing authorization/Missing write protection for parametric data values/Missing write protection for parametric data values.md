...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1314

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1314(Missing<br>write<br>protection<br>for<br>parametric<br>data<br>values):::d3fend-->d3fend.owl#CWE-862
...
- [Missing write protection for parametric data values](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authorization/Missing%20authorization/Missing%20write%20protection%20for%20parametric%20data%20values/Missing%20write%20protection%20for%20parametric%20data%20values.md)
