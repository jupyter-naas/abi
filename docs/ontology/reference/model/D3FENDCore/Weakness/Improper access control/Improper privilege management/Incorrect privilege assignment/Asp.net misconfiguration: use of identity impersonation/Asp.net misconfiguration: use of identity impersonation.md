...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-556

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-556(Asp.net<br>misconfiguration:<br>use<br>of<br>identity<br>impersonation):::d3fend-->d3fend.owl#CWE-266
...
- [Asp.net misconfiguration: use of identity impersonation](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20privilege%20management/Incorrect%20privilege%20assignment/Asp.net%20misconfiguration%3A%20use%20of%20identity%20impersonation/Asp.net%20misconfiguration%3A%20use%20of%20identity%20impersonation.md)
