...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-301

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-301(Reflection<br>attack<br>in<br>an<br>authentication<br>protocol):::d3fend-->d3fend.owl#CWE-1390
...
- [Reflection attack in an authentication protocol](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authentication/Weak%20authentication/Reflection%20attack%20in%20an%20authentication%20protocol/Reflection%20attack%20in%20an%20authentication%20protocol.md)
