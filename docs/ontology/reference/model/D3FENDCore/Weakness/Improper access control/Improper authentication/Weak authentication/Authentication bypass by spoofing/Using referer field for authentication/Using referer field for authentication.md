...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-293

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-293(Using<br>referer<br>field<br>for<br>authentication):::d3fend-->d3fend.owl#CWE-290
...
- [Using referer field for authentication](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authentication/Weak%20authentication/Authentication%20bypass%20by%20spoofing/Using%20referer%20field%20for%20authentication/Using%20referer%20field%20for%20authentication.md)
