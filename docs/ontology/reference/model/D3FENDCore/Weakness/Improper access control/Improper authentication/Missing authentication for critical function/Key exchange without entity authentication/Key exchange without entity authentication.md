...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-322

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-322(Key<br>exchange<br>without<br>entity<br>authentication):::d3fend-->d3fend.owl#CWE-306
...
- [Key exchange without entity authentication](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authentication/Missing%20authentication%20for%20critical%20function/Key%20exchange%20without%20entity%20authentication/Key%20exchange%20without%20entity%20authentication.md)
