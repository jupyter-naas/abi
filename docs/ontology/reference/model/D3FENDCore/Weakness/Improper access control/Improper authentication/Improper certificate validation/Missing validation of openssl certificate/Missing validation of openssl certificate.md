...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-599

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-599(Missing<br>validation<br>of<br>openssl<br>certificate):::d3fend-->d3fend.owl#CWE-295
...
- [Missing validation of openssl certificate](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20access%20control/Improper%20authentication/Improper%20certificate%20validation/Missing%20validation%20of%20openssl%20certificate/Missing%20validation%20of%20openssl%20certificate.md)
