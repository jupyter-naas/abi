...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-354

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-354(Improper<br>validation<br>of<br>integrity<br>check<br>value):::d3fend-->d3fend.owl#CWE-754
...
- [Improper validation of integrity check value](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20check%20or%20handling%20of%20exceptional%20conditions/Improper%20check%20for%20unusual%20or%20exceptional%20conditions/Improper%20validation%20of%20integrity%20check%20value/Improper%20validation%20of%20integrity%20check%20value.md)
