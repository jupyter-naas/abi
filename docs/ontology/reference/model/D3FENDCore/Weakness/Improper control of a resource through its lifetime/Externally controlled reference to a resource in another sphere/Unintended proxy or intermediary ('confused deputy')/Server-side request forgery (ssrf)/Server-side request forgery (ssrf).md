...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-918

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-918(Server-side<br>request<br>forgery<br>(ssrf)):::d3fend-->d3fend.owl#CWE-441
...
- [Server-side request forgery (ssrf)](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Externally%20controlled%20reference%20to%20a%20resource%20in%20another%20sphere/Unintended%20proxy%20or%20intermediary%20%28%27confused%20deputy%27%29/Server-side%20request%20forgery%20%28ssrf%29/Server-side%20request%20forgery%20%28ssrf%29.md)
