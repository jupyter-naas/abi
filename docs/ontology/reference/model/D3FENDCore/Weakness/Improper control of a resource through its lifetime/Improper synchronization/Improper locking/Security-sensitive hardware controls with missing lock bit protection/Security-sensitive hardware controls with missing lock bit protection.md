...
```mermaid
graph BT
    d3fend.owl#CWE-1233(Security-sensitive<br>hardware<br>controls<br>with<br>missing<br>lock<br>bit<br>protection):::d3fend-->d3fend.owl#CWE-667
...
- [Security-sensitive hardware controls with missing lock bit protection](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Improper%20synchronization/Improper%20locking/Security-sensitive%20hardware%20controls%20with%20missing%20lock%20bit%20protection/Security-sensitive%20hardware%20controls%20with%20missing%20lock%20bit%20protection.md)
