...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1232

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1232(Improper<br>lock<br>behavior<br>after<br>power<br>state<br>transition):::d3fend-->d3fend.owl#CWE-667
...
- [Improper lock behavior after power state transition](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Improper%20synchronization/Improper%20locking/Improper%20lock%20behavior%20after%20power%20state%20transition/Improper%20lock%20behavior%20after%20power%20state%20transition.md)
