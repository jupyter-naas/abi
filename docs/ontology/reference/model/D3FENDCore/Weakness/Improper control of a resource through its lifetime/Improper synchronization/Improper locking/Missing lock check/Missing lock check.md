...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-414

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-414(Missing<br>lock<br>check):::d3fend-->d3fend.owl#CWE-667
...
- [Missing lock check](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Improper%20synchronization/Improper%20locking/Missing%20lock%20check/Missing%20lock%20check.md)
