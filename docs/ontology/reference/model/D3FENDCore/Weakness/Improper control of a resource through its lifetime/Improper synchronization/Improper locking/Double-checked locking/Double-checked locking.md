...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-609

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-609(Double-checked<br>locking):::d3fend-->d3fend.owl#CWE-667
...
- [Double-checked locking](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Improper%20synchronization/Improper%20locking/Double-checked%20locking/Double-checked%20locking.md)
