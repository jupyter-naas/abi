...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-412

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-412(Unrestricted<br>externally<br>accessible<br>lock):::d3fend-->d3fend.owl#CWE-667
...
- [Unrestricted externally accessible lock](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Improper%20synchronization/Improper%20locking/Unrestricted%20externally%20accessible%20lock/Unrestricted%20externally%20accessible%20lock.md)
