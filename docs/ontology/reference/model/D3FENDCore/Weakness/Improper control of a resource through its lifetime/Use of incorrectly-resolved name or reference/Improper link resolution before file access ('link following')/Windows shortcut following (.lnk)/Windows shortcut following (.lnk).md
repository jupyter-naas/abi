...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-64

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-64(Windows<br>shortcut<br>following<br>(.lnk)):::d3fend-->d3fend.owl#CWE-59
...
- [Windows shortcut following (.lnk)](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Use%20of%20incorrectly-resolved%20name%20or%20reference/Improper%20link%20resolution%20before%20file%20access%20%28%27link%20following%27%29/Windows%20shortcut%20following%20%28.lnk%29/Windows%20shortcut%20following%20%28.lnk%29.md)
