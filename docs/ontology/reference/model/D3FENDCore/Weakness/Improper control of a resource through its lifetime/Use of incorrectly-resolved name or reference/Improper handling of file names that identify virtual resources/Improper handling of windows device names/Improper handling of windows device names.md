...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-67

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-67(Improper<br>handling<br>of<br>windows<br>device<br>names):::d3fend-->d3fend.owl#CWE-66
...
- [Improper handling of windows device names](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Use%20of%20incorrectly-resolved%20name%20or%20reference/Improper%20handling%20of%20file%20names%20that%20identify%20virtual%20resources/Improper%20handling%20of%20windows%20device%20names/Improper%20handling%20of%20windows%20device%20names.md)
