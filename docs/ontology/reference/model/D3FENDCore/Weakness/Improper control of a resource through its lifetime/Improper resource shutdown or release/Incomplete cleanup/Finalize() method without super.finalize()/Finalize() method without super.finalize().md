...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-568

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-568(Finalize()<br>method<br>without<br>super.finalize()):::d3fend-->d3fend.owl#CWE-459
...
- [Finalize() method without super.finalize()](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20control%20of%20a%20resource%20through%20its%20lifetime/Improper%20resource%20shutdown%20or%20release/Incomplete%20cleanup/Finalize%28%29%20method%20without%20super.finalize%28%29/Finalize%28%29%20method%20without%20super.finalize%28%29.md)
