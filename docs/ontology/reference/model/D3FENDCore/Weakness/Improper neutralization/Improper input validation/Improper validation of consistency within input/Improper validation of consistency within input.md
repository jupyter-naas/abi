...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CWE-1288

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CWE-1288(Improper<br>validation<br>of<br>consistency<br>within<br>input):::d3fend-->d3fend.owl#CWE-20
...
- [Improper validation of consistency within input](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20neutralization/Improper%20input%20validation/Improper%20validation%20of%20consistency%20within%20input/Improper%20validation%20of%20consistency%20within%20input.md)
