...
```mermaid
graph BT
    d3fend.owl#CWE-789(Memory<br>allocation<br>with<br>excessive<br>size<br>value):::d3fend-->d3fend.owl#CWE-1284
...
- [Memory allocation with excessive size value](/docs/ontology/reference/model/D3FENDCore/Weakness/Improper%20neutralization/Improper%20input%20validation/Improper%20validation%20of%20specified%20quantity%20in%20input/Memory%20allocation%20with%20excessive%20size%20value/Memory%20allocation%20with%20excessive%20size%20value.md)
