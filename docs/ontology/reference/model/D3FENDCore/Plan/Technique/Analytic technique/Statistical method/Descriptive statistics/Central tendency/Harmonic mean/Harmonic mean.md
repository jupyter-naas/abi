...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#HarmonicMean

### Subclass Of
```mermaid
graph BT
    d3fend.owl#HarmonicMean(Harmonic<br>mean):::d3fend-->d3fend.owl#CentralTendency
...
- [Harmonic mean](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Statistical%20method/Descriptive%20statistics/Central%20tendency/Harmonic%20mean/Harmonic%20mean.md)
