...
### Definition
Sequence Generation Framework (SeqGAN) models the data generator as a stochastic policy in reinforcement learning (RL), SeqGAN bypasses the generator differentiation problem by directly performing gradient policy update.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SeqGAN

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SeqGAN(Seqgan):::d3fend-->d3fend.owl#GenerativeAdversarialNetwork
...
- [Seqgan](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Machine%20learning/Unsupervised%20learning/Generative%20adversarial%20network/Seqgan/Seqgan.md)
