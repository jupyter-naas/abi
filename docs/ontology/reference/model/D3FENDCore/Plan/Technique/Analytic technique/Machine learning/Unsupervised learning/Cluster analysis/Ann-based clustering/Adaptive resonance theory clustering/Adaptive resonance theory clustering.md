...
### Definition
Adaptive Resonance Theory (ART) Clustering is a  neural network algorithm used for clustering data and is open to new learning(i.e. adaptive) without discarding the previous or the old information(i.e. resonance).
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#AdaptiveResonanceTheoryClustering

### Subclass Of
```mermaid
graph BT
    d3fend.owl#AdaptiveResonanceTheoryClustering(Adaptive<br>resonance<br>theory<br>clustering):::d3fend-->d3fend.owl#ANN-basedClustering
...
- [Adaptive resonance theory clustering](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Machine%20learning/Unsupervised%20learning/Cluster%20analysis/Ann-based%20clustering/Adaptive%20resonance%20theory%20clustering/Adaptive%20resonance%20theory%20clustering.md)
