...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinearClassifier

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinearClassifier(Linear<br>classifier):::d3fend-->d3fend.owl#Classification
...
- [Linear classifier](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Machine%20learning/Supervised%20learning/Classification/Linear%20classifier/Linear%20classifier.md)
