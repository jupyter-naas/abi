...
### Definition
Probabilistic logic extends traditional logic truth tables with probabilistic expressions.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ProbabilisticLogic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ProbabilisticLogic(Probabilistic<br>logic):::d3fend-->d3fend.owl#SymbolicAI
...
- [Probabilistic logic](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Analytic%20technique/Symbolic%20logic/Symbolic%20ai/Probabilistic%20logic/Probabilistic%20logic.md)
