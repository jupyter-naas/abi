...
```mermaid
graph BT
    d3fend.owl#FileHashing(File<br>hashing):::d3fend-->d3fend.owl#FileAnalysis
...
- [File hashing](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/File%20analysis/File%20hashing/File%20hashing.md)
