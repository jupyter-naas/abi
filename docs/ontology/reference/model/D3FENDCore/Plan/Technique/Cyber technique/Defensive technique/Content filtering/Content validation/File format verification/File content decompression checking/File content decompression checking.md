...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#FileContentDecompressionChecking

### Subclass Of
```mermaid
graph BT
    d3fend.owl#FileContentDecompressionChecking(File<br>content<br>decompression<br>checking):::d3fend-->d3fend.owl#FileFormatVerification
...
- [File content decompression checking](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Content%20filtering/Content%20validation/File%20format%20verification/File%20content%20decompression%20checking/File%20content%20decompression%20checking.md)
