...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#PhysicalAccessMediation

### Subclass Of
```mermaid
graph BT
    d3fend.owl#PhysicalAccessMediation(Physical<br>access<br>mediation):::d3fend-->d3fend.owl#AccessMediation
...
- [Physical access mediation](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Access%20mediation/Physical%20access%20mediation/Physical%20access%20mediation.md)
