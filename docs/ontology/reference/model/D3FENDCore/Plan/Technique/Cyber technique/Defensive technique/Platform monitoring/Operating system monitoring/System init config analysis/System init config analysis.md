...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SystemInitConfigAnalysis

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SystemInitConfigAnalysis(System<br>init<br>config<br>analysis):::d3fend-->d3fend.owl#OperatingSystemMonitoring
...
- [System init config analysis](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Platform%20monitoring/Operating%20system%20monitoring/System%20init%20config%20analysis/System%20init%20config%20analysis.md)
