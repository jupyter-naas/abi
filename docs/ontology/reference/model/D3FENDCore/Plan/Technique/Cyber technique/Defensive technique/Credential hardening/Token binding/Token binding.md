...
```mermaid
graph BT
    d3fend.owl#TokenBinding(Token<br>binding):::d3fend-->d3fend.owl#CredentialHardening
...
- [Token binding](/docs/ontology/reference/model/D3FENDCore/Plan/Technique/Cyber%20technique/Defensive%20technique/Credential%20hardening/Token%20binding/Token%20binding.md)
