...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxConnect

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxConnect(Linux<br>connect):::d3fend-->d3fend.owl#OSAPIConnectSocket
...
- [Linux connect](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20connect%20socket/Linux%20connect/Linux%20connect.md)
