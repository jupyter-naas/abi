...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTParameterStatus

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTParameterStatus(Ot<br>parameter<br>status):::d3fend-->d3fend.owl#OTReadDeviceStatus
    d3fend.owl#OTReadDeviceStatus(Ot<br>read<br>device<br>status):::d3fend-->d3fend.owl#OTGetData
...
- [Ot read device status](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20get%20data/Ot%20read%20device%20status/Ot%20read%20device%20status.md)
- [Ot parameter status](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20get%20data/Ot%20read%20device%20status/Ot%20parameter%20status/Ot%20parameter%20status.md)
