...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxCloneArgumentCLONE_THREAD

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxCloneArgumentCLONE_THREAD(Linux<br>clone<br>argument<br>clone_thread):::d3fend-->d3fend.owl#OSAPICreateThread
...
- [Linux clone argument clone_thread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20thread/Linux%20clone%20argument%20clone_thread/Linux%20clone%20argument%20clone_thread.md)
