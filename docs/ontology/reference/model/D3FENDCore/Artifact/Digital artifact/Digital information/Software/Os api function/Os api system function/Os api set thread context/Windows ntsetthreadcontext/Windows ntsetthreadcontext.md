...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtSetThreadContext

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtSetThreadContext(Windows<br>ntsetthreadcontext):::d3fend-->d3fend.owl#OSAPISetThreadContext
    d3fend.owl#OSAPISetThreadContext(Os<br>api<br>set<br>thread<br>context):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api set thread context](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20set%20thread%20context/Os%20api%20set%20thread%20context.md)
- [Windows ntsetthreadcontext](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20set%20thread%20context/Windows%20ntsetthreadcontext/Windows%20ntsetthreadcontext.md)
