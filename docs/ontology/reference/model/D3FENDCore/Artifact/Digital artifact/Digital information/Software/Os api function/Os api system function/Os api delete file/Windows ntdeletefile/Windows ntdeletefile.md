...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtDeleteFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtDeleteFile(Windows<br>ntdeletefile):::d3fend-->d3fend.owl#OSAPIDeleteFile
...
- [Windows ntdeletefile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20delete%20file/Windows%20ntdeletefile/Windows%20ntdeletefile.md)
