...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsWriteFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsWriteFile(Windows<br>writefile):::d3fend-->d3fend.owl#OSAPIWriteFile
...
- [Windows writefile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20file/Windows%20writefile/Windows%20writefile.md)
