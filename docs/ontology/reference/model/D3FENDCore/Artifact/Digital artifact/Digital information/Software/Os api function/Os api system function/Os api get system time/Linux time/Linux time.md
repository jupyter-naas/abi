...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxTime

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxTime(Linux<br>time):::d3fend-->d3fend.owl#OSAPIGetSystemTime
...
- [Linux time](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20get%20system%20time/Linux%20time/Linux%20time.md)
