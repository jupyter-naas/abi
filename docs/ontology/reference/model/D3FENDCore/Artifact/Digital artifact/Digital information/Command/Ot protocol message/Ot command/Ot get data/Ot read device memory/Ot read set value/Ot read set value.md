...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTReadSetValue

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTReadSetValue(Ot<br>read<br>set<br>value):::d3fend-->d3fend.owl#OTReadDeviceMemory
...
- [Ot read set value](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20get%20data/Ot%20read%20device%20memory/Ot%20read%20set%20value/Ot%20read%20set%20value.md)
