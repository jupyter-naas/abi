...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtFlushInstructionCache

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtFlushInstructionCache(Windows<br>ntflushinstructioncache):::d3fend-->d3fend.owl#OSAPIWriteMemory
...
- [Windows ntflushinstructioncache](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20memory/Windows%20ntflushinstructioncache/Windows%20ntflushinstructioncache.md)
