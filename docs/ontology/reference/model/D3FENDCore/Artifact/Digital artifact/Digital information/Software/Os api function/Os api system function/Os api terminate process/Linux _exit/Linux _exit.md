...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Linux_Exit

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Linux_Exit(Linux<br>_exit):::d3fend-->d3fend.owl#OSAPITerminateProcess
...
- [Linux _exit](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20terminate%20process/Linux%20_exit/Linux%20_exit.md)
