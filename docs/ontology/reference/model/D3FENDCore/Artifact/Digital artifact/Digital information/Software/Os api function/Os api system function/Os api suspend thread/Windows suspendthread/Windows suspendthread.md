...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsSuspendThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsSuspendThread(Windows<br>suspendthread):::d3fend-->d3fend.owl#OSAPISuspendThread
...
- [Windows suspendthread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20suspend%20thread/Windows%20suspendthread/Windows%20suspendthread.md)
