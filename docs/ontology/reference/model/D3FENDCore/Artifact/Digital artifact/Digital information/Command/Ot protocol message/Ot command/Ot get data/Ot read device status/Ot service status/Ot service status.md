...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTServiceStatus

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTServiceStatus(Ot<br>service<br>status):::d3fend-->d3fend.owl#OTReadDeviceStatus
...
- [Ot service status](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20get%20data/Ot%20read%20device%20status/Ot%20service%20status/Ot%20service%20status.md)
