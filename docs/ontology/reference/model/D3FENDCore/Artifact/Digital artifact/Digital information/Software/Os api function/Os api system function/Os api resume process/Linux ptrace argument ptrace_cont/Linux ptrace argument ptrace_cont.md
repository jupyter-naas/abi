...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPtraceArgumentPTRACECONT

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPtraceArgumentPTRACECONT(Linux<br>ptrace<br>argument<br>ptrace_cont):::d3fend-->d3fend.owl#OSAPIResumeProcess
...
- [Linux ptrace argument ptrace_cont](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20resume%20process/Linux%20ptrace%20argument%20ptrace_cont/Linux%20ptrace%20argument%20ptrace_cont.md)
