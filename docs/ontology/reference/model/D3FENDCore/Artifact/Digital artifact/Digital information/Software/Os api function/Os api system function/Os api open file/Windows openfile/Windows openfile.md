...
```mermaid
graph BT
    d3fend.owl#WindowOpenFile(Windows<br>openfile):::d3fend-->d3fend.owl#OSAPIOpenFile
...
- [Windows openfile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20open%20file/Windows%20openfile/Windows%20openfile.md)
