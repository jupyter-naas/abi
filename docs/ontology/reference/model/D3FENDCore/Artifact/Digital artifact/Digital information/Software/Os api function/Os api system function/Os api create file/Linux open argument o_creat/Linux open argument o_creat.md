...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxOpenArgumentO_CREAT

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxOpenArgumentO_CREAT(Linux<br>open<br>argument<br>o_creat):::d3fend-->d3fend.owl#OSAPICreateFile
...
- [Linux open argument o_creat](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Linux%20open%20argument%20o_creat/Linux%20open%20argument%20o_creat.md)
