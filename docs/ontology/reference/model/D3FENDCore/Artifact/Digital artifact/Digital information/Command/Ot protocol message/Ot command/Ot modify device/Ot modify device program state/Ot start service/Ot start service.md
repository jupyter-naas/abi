...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTStartService

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTStartService(Ot<br>start<br>service):::d3fend-->d3fend.owl#OTModifyDeviceProgramState
...
- [Ot start service](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20program%20state/Ot%20start%20service/Ot%20start%20service.md)
