...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#IntegrationTestExecutionTool

### Subclass Of
```mermaid
graph BT
    d3fend.owl#IntegrationTestExecutionTool(Integration<br>test<br>execution<br>tool):::d3fend-->d3fend.owl#TestExecutionTool
...
- [Integration test execution tool](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Developer%20application/Test%20execution%20tool/Integration%20test%20execution%20tool/Integration%20test%20execution%20tool.md)
