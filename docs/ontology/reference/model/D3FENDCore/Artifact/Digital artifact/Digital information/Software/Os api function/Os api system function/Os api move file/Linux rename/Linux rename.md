...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxRename

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxRename(Linux<br>rename):::d3fend-->d3fend.owl#OSAPIMoveFile
...
- [Linux rename](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20move%20file/Linux%20rename/Linux%20rename.md)
