...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DomainRegistration

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DomainRegistration(Domain<br>registration):::d3fend-->d3fend.owl#DigitalInformation
...
- [Domain registration](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Domain%20registration/Domain%20registration.md)
