...
### Definition
Reserves memory for a running process to use.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MemoryAllocationFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MemoryAllocationFunction(Memory<br>allocation<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Memory allocation function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Memory%20allocation%20function/Memory%20allocation%20function.md)
