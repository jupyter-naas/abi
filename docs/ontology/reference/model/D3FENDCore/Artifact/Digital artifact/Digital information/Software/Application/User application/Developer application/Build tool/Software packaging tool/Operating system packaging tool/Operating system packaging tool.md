...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OperatingSystemPackagingTool

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OperatingSystemPackagingTool(Operating<br>system<br>packaging<br>tool):::d3fend-->d3fend.owl#SoftwarePackagingTool
...
- [Operating system packaging tool](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Developer%20application/Build%20tool/Software%20packaging%20tool/Operating%20system%20packaging%20tool/Operating%20system%20packaging%20tool.md)
