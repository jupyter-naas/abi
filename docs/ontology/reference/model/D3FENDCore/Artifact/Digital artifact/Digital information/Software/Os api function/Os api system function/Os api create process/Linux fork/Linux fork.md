...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxFork

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxFork(Linux<br>fork):::d3fend-->d3fend.owl#OSAPICreateProcess
...
- [Linux fork](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20process/Linux%20fork/Linux%20fork.md)
