...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxMunmap

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxMunmap(Linux<br>munmap):::d3fend-->d3fend.owl#OSAPIFreeMemory
...
- [Linux munmap](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20free%20memory/Linux%20munmap/Linux%20munmap.md)
