...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxClone3

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxClone3(Linux<br>clone3):::d3fend-->d3fend.owl#OSAPICreateProcess
...
- [Linux clone3](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20process/Linux%20clone3/Linux%20clone3.md)
