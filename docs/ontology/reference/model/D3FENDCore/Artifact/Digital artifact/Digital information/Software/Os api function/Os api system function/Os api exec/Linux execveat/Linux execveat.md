...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxExecveat

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxExecveat(Linux<br>execveat):::d3fend-->d3fend.owl#OSAPIExec
    d3fend.owl#OSAPIExec(Os<br>api<br>exec):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api exec](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20exec/Os%20api%20exec.md)
- [Linux execveat](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20exec/Linux%20execveat/Linux%20execveat.md)
