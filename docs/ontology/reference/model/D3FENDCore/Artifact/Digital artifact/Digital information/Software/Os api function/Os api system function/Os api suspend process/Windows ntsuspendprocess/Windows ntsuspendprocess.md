...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtSuspendProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtSuspendProcess(Windows<br>ntsuspendprocess):::d3fend-->d3fend.owl#OSAPISuspendProcess
...
- [Windows ntsuspendprocess](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20suspend%20process/Windows%20ntsuspendprocess/Windows%20ntsuspendprocess.md)
