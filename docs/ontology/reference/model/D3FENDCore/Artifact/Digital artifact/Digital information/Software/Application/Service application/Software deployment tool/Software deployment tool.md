...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SoftwareDeploymentTool

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SoftwareDeploymentTool(Software<br>deployment<br>tool):::d3fend-->d3fend.owl#ServiceApplication
...
- [Software deployment tool](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/Service%20application/Software%20deployment%20tool/Software%20deployment%20tool.md)
