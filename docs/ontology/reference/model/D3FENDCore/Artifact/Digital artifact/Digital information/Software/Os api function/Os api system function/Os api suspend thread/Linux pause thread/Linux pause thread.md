...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPauseThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPauseThread(Linux<br>pause<br>thread):::d3fend-->d3fend.owl#OSAPISuspendThread
...
- [Linux pause thread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20suspend%20thread/Linux%20pause%20thread/Linux%20pause%20thread.md)
