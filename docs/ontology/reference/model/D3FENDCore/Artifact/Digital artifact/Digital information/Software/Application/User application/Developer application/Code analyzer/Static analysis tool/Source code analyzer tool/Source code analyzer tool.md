...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#SourceCodeAnalyzerTool

### Subclass Of
```mermaid
graph BT
    d3fend.owl#SourceCodeAnalyzerTool(Source<br>code<br>analyzer<br>tool):::d3fend-->d3fend.owl#StaticAnalysisTool
...
- [Source code analyzer tool](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Developer%20application/Code%20analyzer/Static%20analysis%20tool/Source%20code%20analyzer%20tool/Source%20code%20analyzer%20tool.md)
