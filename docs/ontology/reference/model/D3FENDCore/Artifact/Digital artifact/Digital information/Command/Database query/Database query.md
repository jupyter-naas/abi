...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DatabaseQuery

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DatabaseQuery(Database<br>query):::d3fend-->d3fend.owl#Command
...
- [Database query](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Database%20query/Database%20query.md)
