...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsOpenProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsOpenProcess(Windows<br>openprocess):::d3fend-->d3fend.owl#OSAPITraceProcess
...
- [Windows openprocess](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20trace%20process/Windows%20openprocess/Windows%20openprocess.md)
