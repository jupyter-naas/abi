...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxCreat

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxCreat(Linux<br>creat):::d3fend-->d3fend.owl#OSAPICreateFile
...
- [Linux creat](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Linux%20creat/Linux%20creat.md)
