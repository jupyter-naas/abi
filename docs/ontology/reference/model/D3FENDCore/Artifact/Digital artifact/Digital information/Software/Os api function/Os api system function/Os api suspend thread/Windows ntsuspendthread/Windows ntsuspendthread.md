...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtSuspendThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtSuspendThread(Windows<br>ntsuspendthread):::d3fend-->d3fend.owl#OSAPISuspendThread
    d3fend.owl#OSAPISuspendThread(Os<br>api<br>suspend<br>thread):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api suspend thread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20suspend%20thread/Os%20api%20suspend%20thread.md)
- [Windows ntsuspendthread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20suspend%20thread/Windows%20ntsuspendthread/Windows%20ntsuspendthread.md)
