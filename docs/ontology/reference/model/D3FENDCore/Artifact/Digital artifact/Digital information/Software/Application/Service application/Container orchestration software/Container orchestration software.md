...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ContainerOrchestrationSoftware

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ContainerOrchestrationSoftware(Container<br>orchestration<br>software):::d3fend-->d3fend.owl#ServiceApplication
...
- [Container orchestration software](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/Service%20application/Container%20orchestration%20software/Container%20orchestration%20software.md)
