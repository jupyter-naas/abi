...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxExecve

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxExecve(Linux<br>execve):::d3fend-->d3fend.owl#OSAPIExec
...
- [Linux execve](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20exec/Linux%20execve/Linux%20execve.md)
