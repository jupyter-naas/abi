...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Browser

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Browser(Browser):::d3fend-->d3fend.owl#UserApplication
...
- [Browser](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Browser/Browser.md)
