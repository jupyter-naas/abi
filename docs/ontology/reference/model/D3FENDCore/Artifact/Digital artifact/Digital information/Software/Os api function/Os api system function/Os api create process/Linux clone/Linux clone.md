...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxClone

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxClone(Linux<br>clone):::d3fend-->d3fend.owl#OSAPICreateProcess
...
- [Linux clone](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20process/Linux%20clone/Linux%20clone.md)
