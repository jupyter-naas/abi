...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#HumanInputDeviceFirmware

### Subclass Of
```mermaid
graph BT
    d3fend.owl#HumanInputDeviceFirmware(Human<br>input<br>device<br>firmware):::d3fend-->d3fend.owl#PeripheralFirmware
...
- [Human input device firmware](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Firmware/Peripheral%20firmware/Human%20input%20device%20firmware/Human%20input%20device%20firmware.md)
