...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtReadFileScatter

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtReadFileScatter(Windows<br>ntreadfilescatter):::d3fend-->d3fend.owl#OSAPIReadFile
    d3fend.owl#OSAPIReadFile(Os<br>api<br>read<br>file):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api read file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20read%20file/Os%20api%20read%20file.md)
- [Windows ntreadfilescatter](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20read%20file/Windows%20ntreadfilescatter/Windows%20ntreadfilescatter.md)
