...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DigitalDocument

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DigitalDocument(Digital<br>document):::d3fend-->d3fend.owl#DigitalMedia
...
- [Digital document](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Digital%20media/Digital%20document/Digital%20document.md)
