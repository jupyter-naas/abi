...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsCreateFileA

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsCreateFileA(Windows<br>createfilea):::d3fend-->d3fend.owl#OSAPICreateFile
...
- [Windows createfilea](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Windows%20createfilea/Windows%20createfilea.md)
