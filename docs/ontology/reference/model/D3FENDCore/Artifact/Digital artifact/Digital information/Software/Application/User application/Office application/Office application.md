...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OfficeApplication

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OfficeApplication(Office<br>application):::d3fend-->d3fend.owl#UserApplication
...
- [Office application](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Office%20application/Office%20application.md)
