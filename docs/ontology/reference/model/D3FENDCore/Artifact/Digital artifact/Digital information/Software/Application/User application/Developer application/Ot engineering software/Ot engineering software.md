...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTEngineeringSoftware

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTEngineeringSoftware(Ot<br>engineering<br>software):::d3fend-->d3fend.owl#DeveloperApplication
...
- [Ot engineering software](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Developer%20application/Ot%20engineering%20software/Ot%20engineering%20software.md)
