...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxReadv

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxReadv(Linux<br>readv):::d3fend-->d3fend.owl#OSAPIReadFile
...
- [Linux readv](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20read%20file/Linux%20readv/Linux%20readv.md)
