...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtCreatePagingFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtCreatePagingFile(Windows<br>ntcreatepagingfile):::d3fend-->d3fend.owl#OSAPICreateFile
...
- [Windows ntcreatepagingfile](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20file/Windows%20ntcreatepagingfile/Windows%20ntcreatepagingfile.md)
