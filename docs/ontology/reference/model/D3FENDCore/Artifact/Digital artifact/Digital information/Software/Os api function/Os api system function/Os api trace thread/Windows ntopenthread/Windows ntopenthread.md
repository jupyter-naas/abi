...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtOpenThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtOpenThread(Windows<br>ntopenthread):::d3fend-->d3fend.owl#OSAPITraceThread
    d3fend.owl#OSAPITraceThread(Os<br>api<br>trace<br>thread):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api trace thread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20trace%20thread/Os%20api%20trace%20thread.md)
- [Windows ntopenthread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20trace%20thread/Windows%20ntopenthread/Windows%20ntopenthread.md)
