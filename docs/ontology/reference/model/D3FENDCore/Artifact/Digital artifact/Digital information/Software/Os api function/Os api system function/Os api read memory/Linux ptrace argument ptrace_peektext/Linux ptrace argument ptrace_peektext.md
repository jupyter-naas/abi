...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxPtraceArgumentPTRACEPEEKTEXT

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxPtraceArgumentPTRACEPEEKTEXT(Linux<br>ptrace<br>argument<br>ptrace_peektext):::d3fend-->d3fend.owl#OSAPIReadMemory
    d3fend.owl#OSAPIReadMemory(Os<br>api<br>read<br>memory):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api read memory](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20read%20memory/Os%20api%20read%20memory.md)
- [Linux ptrace argument ptrace_peektext](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20read%20memory/Linux%20ptrace%20argument%20ptrace_peektext/Linux%20ptrace%20argument%20ptrace_peektext.md)
