# Ot create new device process data

## Overview

### Definition
OT command that creates process data on a remote device.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTCreateNewDeviceProcessData

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTCreateNewDeviceProcessData(Ot<br>create<br>new<br>device<br>process<br>data):::d3fend-->d3fend.owl#OTModifyDeviceProcessData
    d3fend.owl#OTModifyDeviceProcessData(Ot<br>modify<br>device<br>process<br>data):::d3fend-->d3fend.owl#OTModifyDevice
...
- [Ot modify device process data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20process%20data/Ot%20modify%20device%20process%20data.md)
- [Ot create new device process data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20process%20data/Ot%20create%20new%20device%20process%20data/Ot%20create%20new%20device%20process%20data.md)
