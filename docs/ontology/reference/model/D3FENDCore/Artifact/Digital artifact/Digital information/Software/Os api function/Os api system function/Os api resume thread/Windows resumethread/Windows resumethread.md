...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsResumeThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsResumeThread(Windows<br>resumethread):::d3fend-->d3fend.owl#OSAPIResumeThread
...
- [Windows resumethread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20resume%20thread/Windows%20resumethread/Windows%20resumethread.md)
