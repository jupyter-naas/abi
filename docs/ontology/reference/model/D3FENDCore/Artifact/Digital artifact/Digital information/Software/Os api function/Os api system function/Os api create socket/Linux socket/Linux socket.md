...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxSocket

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxSocket(Linux<br>socket):::d3fend-->d3fend.owl#OSAPICreateSocket
...
- [Linux socket](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20socket/Linux%20socket/Linux%20socket.md)
