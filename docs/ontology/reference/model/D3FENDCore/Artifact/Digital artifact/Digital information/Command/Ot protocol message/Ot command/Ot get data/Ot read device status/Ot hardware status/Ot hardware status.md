...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTHardwareStatus

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTHardwareStatus(Ot<br>hardware<br>status):::d3fend-->d3fend.owl#OTReadDeviceStatus
...
- [Ot hardware status](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20get%20data/Ot%20read%20device%20status/Ot%20hardware%20status/Ot%20hardware%20status.md)
