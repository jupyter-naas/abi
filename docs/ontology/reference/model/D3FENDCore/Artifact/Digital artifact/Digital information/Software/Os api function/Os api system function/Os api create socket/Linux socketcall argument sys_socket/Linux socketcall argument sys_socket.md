...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxSocketcallArgumentSYS_SOCKET

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxSocketcallArgumentSYS_SOCKET(Linux<br>socketcall<br>argument<br>sys_socket):::d3fend-->d3fend.owl#OSAPICreateSocket
    d3fend.owl#OSAPICreateSocket(Os<br>api<br>create<br>socket):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api create socket](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20socket/Os%20api%20create%20socket.md)
- [Linux socketcall argument sys_socket](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20create%20socket/Linux%20socketcall%20argument%20sys_socket/Linux%20socketcall%20argument%20sys_socket.md)
