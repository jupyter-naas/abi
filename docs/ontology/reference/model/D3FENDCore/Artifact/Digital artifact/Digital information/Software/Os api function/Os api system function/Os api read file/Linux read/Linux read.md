...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxRead

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxRead(Linux<br>read):::d3fend-->d3fend.owl#OSAPIReadFile
...
- [Linux read](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20read%20file/Linux%20read/Linux%20read.md)
