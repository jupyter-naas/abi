...
### Definition
Request the identification of a remote device.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTIdentifyDevice

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTIdentifyDevice(Ot<br>identify<br>device):::d3fend-->d3fend.owl#OTManageRemoteConnection
...
- [Ot identify device](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20manage%20remote%20connection/Ot%20identify%20device/Ot%20identify%20device.md)
