...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTDeleteDeviceProcessData

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTDeleteDeviceProcessData(Ot<br>delete<br>device<br>process<br>data):::d3fend-->d3fend.owl#OTModifyDeviceProcessData
...
- [Ot delete device process data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20process%20data/Ot%20delete%20device%20process%20data/Ot%20delete%20device%20process%20data.md)
