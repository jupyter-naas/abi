...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtQuerySystemTime

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtQuerySystemTime(Windows<br>ntquerysystemtime):::d3fend-->d3fend.owl#OSAPIGetSystemTime
...
- [Windows ntquerysystemtime](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20get%20system%20time/Windows%20ntquerysystemtime/Windows%20ntquerysystemtime.md)
