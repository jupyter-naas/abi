...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsWriteProcessMemory

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsWriteProcessMemory(Windows<br>writeprocessmemory):::d3fend-->d3fend.owl#OSAPIWriteMemory
...
- [Windows writeprocessmemory](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20memory/Windows%20writeprocessmemory/Windows%20writeprocessmemory.md)
