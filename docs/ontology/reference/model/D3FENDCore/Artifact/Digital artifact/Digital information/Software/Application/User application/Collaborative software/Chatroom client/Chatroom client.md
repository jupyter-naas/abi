...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ChatroomClient

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ChatroomClient(Chatroom<br>client):::d3fend-->d3fend.owl#CollaborativeSoftware
...
- [Chatroom client](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Application/User%20application/Collaborative%20software/Chatroom%20client/Chatroom%20client.md)
