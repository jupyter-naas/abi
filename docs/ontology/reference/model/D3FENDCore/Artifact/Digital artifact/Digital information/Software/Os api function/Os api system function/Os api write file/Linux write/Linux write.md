...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxWrite

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxWrite(Linux<br>write):::d3fend-->d3fend.owl#OSAPIWriteFile
...
- [Linux write](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20write%20file/Linux%20write/Linux%20write.md)
