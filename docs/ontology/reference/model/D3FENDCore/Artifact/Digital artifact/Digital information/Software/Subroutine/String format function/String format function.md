...
### Definition
A function which creates a new string based on a format specification and correspondingi specified values.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#StringFormatFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#StringFormatFunction(String<br>format<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [String format function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/String%20format%20function/String%20format%20function.md)
