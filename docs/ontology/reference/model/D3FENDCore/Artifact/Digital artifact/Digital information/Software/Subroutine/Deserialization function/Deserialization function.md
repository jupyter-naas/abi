...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DeserializationFunction

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DeserializationFunction(Deserialization<br>function):::d3fend-->d3fend.owl#Subroutine
...
- [Deserialization function](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Deserialization%20function/Deserialization%20function.md)
