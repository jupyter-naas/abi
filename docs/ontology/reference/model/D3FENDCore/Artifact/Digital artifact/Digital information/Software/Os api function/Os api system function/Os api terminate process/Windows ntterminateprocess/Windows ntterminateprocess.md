...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNtTerminateProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNtTerminateProcess(Windows<br>ntterminateprocess):::d3fend-->d3fend.owl#OSAPITerminateProcess
...
- [Windows ntterminateprocess](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20terminate%20process/Windows%20ntterminateprocess/Windows%20ntterminateprocess.md)
