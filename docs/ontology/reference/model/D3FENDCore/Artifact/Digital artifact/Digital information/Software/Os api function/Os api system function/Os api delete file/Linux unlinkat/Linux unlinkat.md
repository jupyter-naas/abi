...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LinuxUnlinkat

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LinuxUnlinkat(Linux<br>unlinkat):::d3fend-->d3fend.owl#OSAPIDeleteFile
...
- [Linux unlinkat](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20delete%20file/Linux%20unlinkat/Linux%20unlinkat.md)
