...
### Definition
OT command that uploads data to a remote device.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTUploadData

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTUploadData(Ot<br>upload<br>data):::d3fend-->d3fend.owl#OTModifyDeviceData
...
- [Ot upload data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20data/Ot%20upload%20data/Ot%20upload%20data.md)
