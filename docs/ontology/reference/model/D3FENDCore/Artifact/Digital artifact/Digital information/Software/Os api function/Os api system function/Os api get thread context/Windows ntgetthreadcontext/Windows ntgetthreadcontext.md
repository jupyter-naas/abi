...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsNTGetThreadContext

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsNTGetThreadContext(Windows<br>ntgetthreadcontext):::d3fend-->d3fend.owl#OSAPIGetThreadContext
    d3fend.owl#OSAPIGetThreadContext(Os<br>api<br>get<br>thread<br>context):::d3fend-->d3fend.owl#OSAPISystemFunction
...
- [Os api get thread context](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20get%20thread%20context/Os%20api%20get%20thread%20context.md)
- [Windows ntgetthreadcontext](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Os%20api%20function/Os%20api%20system%20function/Os%20api%20get%20thread%20context/Windows%20ntgetthreadcontext/Windows%20ntgetthreadcontext.md)
