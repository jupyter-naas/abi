...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ExceptionHandler

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ExceptionHandler(Exception<br>handler):::d3fend-->d3fend.owl#Subroutine
...
- [Exception handler](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Software/Subroutine/Exception%20handler/Exception%20handler.md)
