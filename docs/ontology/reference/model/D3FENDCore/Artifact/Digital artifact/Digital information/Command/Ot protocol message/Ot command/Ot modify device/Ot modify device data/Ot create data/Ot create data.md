...
### Definition
OT command that creates data on a remote device.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTCreateData

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTCreateData(Ot<br>create<br>data):::d3fend-->d3fend.owl#OTModifyDeviceData
...
- [Ot create data](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information/Command/Ot%20protocol%20message/Ot%20command/Ot%20modify%20device/Ot%20modify%20device%20data/Ot%20create%20data/Ot%20create%20data.md)
