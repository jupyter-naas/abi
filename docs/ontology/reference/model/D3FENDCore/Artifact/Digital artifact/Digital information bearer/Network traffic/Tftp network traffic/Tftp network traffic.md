...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#TFTPNetworkTraffic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#TFTPNetworkTraffic(Tftp<br>network<br>traffic):::d3fend-->d3fend.owl#NetworkTraffic
...
- [Tftp network traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/Tftp%20network%20traffic/Tftp%20network%20traffic.md)
