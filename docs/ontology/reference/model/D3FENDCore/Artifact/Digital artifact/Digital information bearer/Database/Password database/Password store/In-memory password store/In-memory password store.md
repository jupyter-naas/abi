...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#In-memoryPasswordStore

### Subclass Of
```mermaid
graph BT
    d3fend.owl#In-memoryPasswordStore(In-memory<br>password<br>store):::d3fend-->d3fend.owl#PasswordStore
...
- [In-memory password store](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Database/Password%20database/Password%20store/In-memory%20password%20store/In-memory%20password%20store.md)
