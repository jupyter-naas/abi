...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ComputingServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ComputingServer(Computing<br>server):::d3fend-->d3fend.owl#Server
...
- [Computing server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Computing%20server/Computing%20server.md)
