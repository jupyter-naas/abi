...
```mermaid
graph BT
    d3fend.owl#PasswordFile(Password<br>file):::d3fend-->d3fend.owl#File
...
- [Password file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Password%20file/Password%20file.md)
