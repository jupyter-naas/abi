...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#NetworkFrame

### Subclass Of
```mermaid
graph BT
    d3fend.owl#NetworkFrame(Network<br>frame):::d3fend-->d3fend.owl#DigitalInformationBearer
...
- [Network frame](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20frame/Network%20frame.md)
