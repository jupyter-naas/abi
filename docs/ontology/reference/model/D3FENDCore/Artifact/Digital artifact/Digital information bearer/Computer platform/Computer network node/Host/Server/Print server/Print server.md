...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#PrintServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#PrintServer(Print<br>server):::d3fend-->d3fend.owl#Server
...
- [Print server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Print%20server/Print%20server.md)
