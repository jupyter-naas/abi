...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CreateThread

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CreateThread(Create<br>thread):::d3fend-->d3fend.owl#SystemCall
...
- [Create thread](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Create%20thread/Create%20thread.md)
