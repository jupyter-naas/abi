...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#PythonScriptFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#PythonScriptFile(Python<br>script<br>file):::d3fend-->d3fend.owl#ExecutableScript
...
- [Python script file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Executable%20file/Executable%20script/Python%20script%20file/Python%20script%20file.md)
