...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ExecutableBinary

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ExecutableBinary(Executable<br>binary):::d3fend-->d3fend.owl#ExecutableFile
...
- [Executable binary](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Executable%20file/Executable%20binary/Executable%20binary.md)
