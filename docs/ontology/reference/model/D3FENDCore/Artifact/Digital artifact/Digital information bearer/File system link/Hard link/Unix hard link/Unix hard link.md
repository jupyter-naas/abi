...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#UnixHardLink

### Subclass Of
```mermaid
graph BT
    d3fend.owl#UnixHardLink(Unix<br>hard<br>link):::d3fend-->d3fend.owl#HardLink
...
- [Unix hard link](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/File%20system%20link/Hard%20link/Unix%20hard%20link/Unix%20hard%20link.md)
