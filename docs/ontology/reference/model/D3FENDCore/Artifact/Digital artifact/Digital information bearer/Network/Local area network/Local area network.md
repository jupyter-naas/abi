...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LocalAreaNetwork

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LocalAreaNetwork(Local<br>area<br>network):::d3fend-->d3fend.owl#Network
...
- [Local area network](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network/Local%20area%20network/Local%20area%20network.md)
