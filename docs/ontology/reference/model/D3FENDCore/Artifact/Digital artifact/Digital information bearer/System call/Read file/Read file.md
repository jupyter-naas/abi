...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ReadFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ReadFile(Read<br>file):::d3fend-->d3fend.owl#SystemCall
...
- [Read file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Read%20file/Read%20file.md)
