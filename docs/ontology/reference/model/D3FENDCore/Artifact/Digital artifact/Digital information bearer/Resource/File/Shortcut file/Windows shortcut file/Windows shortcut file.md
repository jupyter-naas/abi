...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsShortcutFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsShortcutFile(Windows<br>shortcut<br>file):::d3fend-->d3fend.owl#ShortcutFile
...
- [Windows shortcut file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Shortcut%20file/Windows%20shortcut%20file/Windows%20shortcut%20file.md)
