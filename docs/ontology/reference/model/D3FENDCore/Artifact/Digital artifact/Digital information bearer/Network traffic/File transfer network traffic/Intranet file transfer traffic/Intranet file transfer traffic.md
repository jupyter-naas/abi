...
```mermaid
graph BT
    d3fend.owl#IntranetFileTransferTraffic(Intranet<br>file<br>transfer<br>traffic):::d3fend-->d3fend.owl#FileTransferNetworkTraffic
...
- [Intranet file transfer traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/File%20transfer%20network%20traffic/Intranet%20file%20transfer%20traffic/Intranet%20file%20transfer%20traffic.md)
