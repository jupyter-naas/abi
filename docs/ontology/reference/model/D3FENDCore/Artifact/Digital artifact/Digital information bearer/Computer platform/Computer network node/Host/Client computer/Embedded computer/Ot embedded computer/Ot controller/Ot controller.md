...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTController

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTController(Ot<br>controller):::d3fend-->d3fend.owl#OTEmbeddedComputer
    d3fend.owl#OTEmbeddedComputer(Ot<br>embedded<br>computer):::d3fend-->d3fend.owl#EmbeddedComputer
    d3fend.owl#EmbeddedComputer(Embedded<br>computer):::d3fend-->d3fend.owl#ClientComputer
...
- [Embedded computer](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Client%20computer/Embedded%20computer/Embedded%20computer.md)
- [Ot embedded computer](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Client%20computer/Embedded%20computer/Ot%20embedded%20computer/Ot%20embedded%20computer.md)
- [Ot controller](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Client%20computer/Embedded%20computer/Ot%20embedded%20computer/Ot%20controller/Ot%20controller.md)
