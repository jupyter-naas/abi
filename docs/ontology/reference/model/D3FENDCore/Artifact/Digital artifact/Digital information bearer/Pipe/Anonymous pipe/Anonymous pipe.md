...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#AnonymousPipe

### Subclass Of
```mermaid
graph BT
    d3fend.owl#AnonymousPipe(Anonymous<br>pipe):::d3fend-->d3fend.owl#Pipe
    d3fend.owl#Pipe(Pipe):::d3fend-->d3fend.owl#DigitalInformationBearer
...
- [Anonymous pipe](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Pipe/Anonymous%20pipe/Anonymous%20pipe.md)
