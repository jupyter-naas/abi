# Network media streaming resource

## Overview

### Definition
A server that provides digital media content to users.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#NetworkMediaStreamingResource
