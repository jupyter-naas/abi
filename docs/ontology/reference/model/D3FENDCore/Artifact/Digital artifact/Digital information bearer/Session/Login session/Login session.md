...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LoginSession

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LoginSession(Login<br>session):::d3fend-->d3fend.owl#Session
...
- [Login session](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Session/Login%20session/Login%20session.md)
