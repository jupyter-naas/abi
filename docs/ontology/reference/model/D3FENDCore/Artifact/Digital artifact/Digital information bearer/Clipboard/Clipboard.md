...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Clipboard

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Clipboard(Clipboard):::d3fend-->d3fend.owl#DigitalInformationBearer
...
- [Clipboard](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Clipboard/Clipboard.md)
