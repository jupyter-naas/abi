...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#BusNetworkNode

### Subclass Of
```mermaid
graph BT
    d3fend.owl#BusNetworkNode(Bus<br>network<br>node):::d3fend-->d3fend.owl#Host
...
- [Bus network node](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Bus%20network%20node/Bus%20network%20node.md)
