...
```mermaid
graph BT
    d3fend.owl#InternetNetwork(Internet<br>network):::d3fend-->d3fend.owl#Network
...
- [Internet network](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network/Internet%20network/Internet%20network.md)
