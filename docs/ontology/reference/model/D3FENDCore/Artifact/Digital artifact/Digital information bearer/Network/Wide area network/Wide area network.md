...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WideAreaNetwork

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WideAreaNetwork(Wide<br>area<br>network):::d3fend-->d3fend.owl#Network
...
- [Wide area network](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network/Wide%20area%20network/Wide%20area%20network.md)
