...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#LoadModule

### Subclass Of
```mermaid
graph BT
    d3fend.owl#LoadModule(Load<br>module):::d3fend-->d3fend.owl#SystemCall
...
- [Load module](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Load%20module/Load%20module.md)
