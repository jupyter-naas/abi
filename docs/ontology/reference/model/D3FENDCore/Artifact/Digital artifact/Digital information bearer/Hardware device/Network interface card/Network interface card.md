...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#NetworkInterfaceCard

### Subclass Of
```mermaid
graph BT
    d3fend.owl#NetworkInterfaceCard(Network<br>interface<br>card):::d3fend-->d3fend.owl#HardwareDevice
...
- [Network interface card](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Hardware%20device/Network%20interface%20card/Network%20interface%20card.md)
