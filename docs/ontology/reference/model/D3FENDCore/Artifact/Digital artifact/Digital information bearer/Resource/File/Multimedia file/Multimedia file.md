...
### Definition
A file that contains digital multimedia.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MultimediaFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MultimediaFile(Multimedia<br>file):::d3fend-->d3fend.owl#File
...
- [Multimedia file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Multimedia%20file/Multimedia%20file.md)
