...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ReverseProxyServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ReverseProxyServer(Reverse<br>proxy<br>server):::d3fend-->d3fend.owl#ProxyServer
...
- [Proxy server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Proxy%20server/Proxy%20server.md)
- [Reverse proxy server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Proxy%20server/Reverse%20proxy%20server/Reverse%20proxy%20server.md)
