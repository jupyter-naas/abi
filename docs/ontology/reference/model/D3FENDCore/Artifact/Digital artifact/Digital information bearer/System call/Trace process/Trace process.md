...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#TraceProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#TraceProcess(Trace<br>process):::d3fend-->d3fend.owl#SystemCall
...
- [Trace process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Trace%20process/Trace%20process.md)
