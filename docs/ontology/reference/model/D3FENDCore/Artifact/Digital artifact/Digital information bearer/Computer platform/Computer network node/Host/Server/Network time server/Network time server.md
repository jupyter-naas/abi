...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#NetworkTimeServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#NetworkTimeServer(Network<br>time<br>server):::d3fend-->d3fend.owl#Server
...
- [Network time server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Network%20time%20server/Network%20time%20server.md)
