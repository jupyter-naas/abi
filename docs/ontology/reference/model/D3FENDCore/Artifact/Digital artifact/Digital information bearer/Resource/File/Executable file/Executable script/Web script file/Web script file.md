...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WebScriptFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WebScriptFile(Web<br>script<br>file):::d3fend-->d3fend.owl#ExecutableScript
...
- [Web script file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Executable%20file/Executable%20script/Web%20script%20file/Web%20script%20file.md)
