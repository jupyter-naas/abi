...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OrchestrationController

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OrchestrationController(Orchestration<br>controller):::d3fend-->d3fend.owl#OrchestrationServer
    d3fend.owl#OrchestrationServer(Orchestration<br>server):::d3fend-->d3fend.owl#Server
...
- [Orchestration server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Orchestration%20server/Orchestration%20server.md)
- [Orchestration controller](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Orchestration%20server/Orchestration%20controller/Orchestration%20controller.md)
