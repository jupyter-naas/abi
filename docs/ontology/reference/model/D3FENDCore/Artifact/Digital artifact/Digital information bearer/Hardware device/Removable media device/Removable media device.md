...
```mermaid
graph BT
    d3fend.owl#RemovableMediaDevice(Removable<br>media<br>device):::d3fend-->d3fend.owl#HardwareDevice
...
- [Removable media device](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Hardware%20device/Removable%20media%20device/Removable%20media%20device.md)
