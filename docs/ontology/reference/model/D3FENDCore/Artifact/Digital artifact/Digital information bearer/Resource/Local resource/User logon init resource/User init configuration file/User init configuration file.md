...
```mermaid
graph BT
    d3fend.owl#UserInitConfigurationFile(User<br>init<br>configuration<br>file):::d3fend-->d3fend.owl#UserLogonInitResource
...
- [User init configuration file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/Local%20resource/User%20logon%20init%20resource/User%20init%20configuration%20file/User%20init%20configuration%20file.md)
