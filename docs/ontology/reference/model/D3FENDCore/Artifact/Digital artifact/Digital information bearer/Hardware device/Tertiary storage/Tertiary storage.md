...
```mermaid
graph BT
    d3fend.owl#TertiaryStorage(Tertiary<br>storage):::d3fend-->d3fend.owl#HardwareDevice
...
- [Tertiary storage](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Hardware%20device/Tertiary%20storage/Tertiary%20storage.md)
