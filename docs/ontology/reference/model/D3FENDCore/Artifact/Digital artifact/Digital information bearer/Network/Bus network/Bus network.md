...
```mermaid
graph BT
    d3fend.owl#BusNetwork(Bus<br>network):::d3fend-->d3fend.owl#Network
...
- [Bus network](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network/Bus%20network/Bus%20network.md)
