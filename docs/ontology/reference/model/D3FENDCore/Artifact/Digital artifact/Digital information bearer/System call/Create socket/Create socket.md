...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CreateSocket

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CreateSocket(Create<br>socket):::d3fend-->d3fend.owl#SystemCall
...
- [Create socket](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/System%20call/Create%20socket/Create%20socket.md)
