...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OutboundInternetMailTraffic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OutboundInternetMailTraffic(Outbound<br>internet<br>mail<br>traffic):::d3fend-->d3fend.owl#OutboundInternetNetworkTraffic
...
- [Outbound internet mail traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/Internet%20network%20traffic/Outbound%20internet%20network%20traffic/Outbound%20internet%20mail%20traffic/Outbound%20internet%20mail%20traffic.md)
