...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MediaServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MediaServer(Media<br>server):::d3fend-->d3fend.owl#Server
...
- [Media server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Media%20server/Media%20server.md)
