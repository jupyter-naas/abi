...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#NTFSJunctionPoint

### Subclass Of
```mermaid
graph BT
    d3fend.owl#NTFSJunctionPoint(Ntfs<br>junction<br>point):::d3fend-->d3fend.owl#SymbolicLink
...
- [Ntfs junction point](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/File%20system%20link/Symbolic%20link/Ntfs%20junction%20point/Ntfs%20junction%20point.md)
