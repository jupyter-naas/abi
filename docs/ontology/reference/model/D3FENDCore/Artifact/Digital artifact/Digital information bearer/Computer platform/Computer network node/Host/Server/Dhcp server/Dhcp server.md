...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DHCPServer

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DHCPServer(Dhcp<br>server):::d3fend-->d3fend.owl#Server
...
- [Dhcp server](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Computer%20platform/Computer%20network%20node/Host/Server/Dhcp%20server/Dhcp%20server.md)
