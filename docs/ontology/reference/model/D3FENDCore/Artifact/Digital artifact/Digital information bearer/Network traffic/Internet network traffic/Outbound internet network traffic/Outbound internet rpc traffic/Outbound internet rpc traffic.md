...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OutboundInternetRPCTraffic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OutboundInternetRPCTraffic(Outbound<br>internet<br>rpc<br>traffic):::d3fend-->d3fend.owl#OutboundInternetNetworkTraffic
...
- [Outbound internet rpc traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/Internet%20network%20traffic/Outbound%20internet%20network%20traffic/Outbound%20internet%20rpc%20traffic/Outbound%20internet%20rpc%20traffic.md)
