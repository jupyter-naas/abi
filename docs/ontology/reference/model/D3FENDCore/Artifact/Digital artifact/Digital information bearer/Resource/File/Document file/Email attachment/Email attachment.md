...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#EmailAttachment

### Subclass Of
```mermaid
graph BT
    d3fend.owl#EmailAttachment(Email<br>attachment):::d3fend-->d3fend.owl#DocumentFile
...
- [Email attachment](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Document%20file/Email%20attachment/Email%20attachment.md)
