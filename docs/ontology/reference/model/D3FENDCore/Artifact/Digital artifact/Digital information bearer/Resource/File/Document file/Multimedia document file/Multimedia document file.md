...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#MultimediaDocumentFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#MultimediaDocumentFile(Multimedia<br>document<br>file):::d3fend-->d3fend.owl#DocumentFile
...
- [Multimedia document file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Document%20file/Multimedia%20document%20file/Multimedia%20document%20file.md)
