...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#RemoteAuthorizationService

### Subclass Of
```mermaid
graph BT
    d3fend.owl#RemoteAuthorizationService(Remote<br>authorization<br>service):::d3fend-->d3fend.owl#AuthorizationService
    d3fend.owl#AuthorizationService(Authorization<br>service):::d3fend-->d3fend.owl#ServiceApplicationProcess
...
- [Authorization service](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Process/User%20process/Application%20process/Service%20application%20process/Authorization%20service/Authorization%20service.md)
- [Remote authorization service](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Process/User%20process/Application%20process/Service%20application%20process/Authorization%20service/Remote%20authorization%20service/Remote%20authorization%20service.md)
