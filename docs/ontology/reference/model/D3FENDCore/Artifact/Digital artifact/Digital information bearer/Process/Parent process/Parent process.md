...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#ParentProcess

### Subclass Of
```mermaid
graph BT
    d3fend.owl#ParentProcess(Parent<br>process):::d3fend-->d3fend.owl#Process
...
- [Parent process](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Process/Parent%20process/Parent%20process.md)
