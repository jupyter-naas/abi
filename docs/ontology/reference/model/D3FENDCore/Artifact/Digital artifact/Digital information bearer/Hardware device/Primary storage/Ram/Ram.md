...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#RAM

### Subclass Of
```mermaid
graph BT
    d3fend.owl#RAM(Ram):::d3fend-->d3fend.owl#PrimaryStorage
...
- [Ram](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Hardware%20device/Primary%20storage/Ram/Ram.md)
