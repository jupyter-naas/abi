...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#VMImage

### Subclass Of
```mermaid
graph BT
    d3fend.owl#VMImage(Virtual<br>machine<br>image):::d3fend-->d3fend.owl#StorageImage
...
- [Virtual machine image](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Storage%20image/Virtual%20machine%20image/Virtual%20machine%20image.md)
