...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#CommandHistoryLogFile

### Subclass Of
```mermaid
graph BT
    d3fend.owl#CommandHistoryLogFile(Command<br>history<br>log<br>file):::d3fend-->d3fend.owl#LogFile
...
- [Command history log file](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Log%20file/Command%20history%20log%20file/Command%20history%20log%20file.md)
