...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#NTFSHardLink

### Subclass Of
```mermaid
graph BT
    d3fend.owl#NTFSHardLink(Ntfs<br>hard<br>link):::d3fend-->d3fend.owl#NTFSLink
...
- [Ntfs hard link](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/File%20system%20link/Ntfs%20link/Ntfs%20hard%20link/Ntfs%20hard%20link.md)
