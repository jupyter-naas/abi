...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#BootSector

### Subclass Of
```mermaid
graph BT
    d3fend.owl#BootSector(Boot<br>sector):::d3fend-->d3fend.owl#BootRecord
...
- [Boot sector](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Record/Boot%20record/Boot%20sector/Boot%20sector.md)
