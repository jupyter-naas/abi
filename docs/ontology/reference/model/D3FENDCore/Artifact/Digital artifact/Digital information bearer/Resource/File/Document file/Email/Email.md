...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Email

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Email(Email):::d3fend-->d3fend.owl#DocumentFile
...
- [Email](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Resource/File/Document%20file/Email/Email.md)
