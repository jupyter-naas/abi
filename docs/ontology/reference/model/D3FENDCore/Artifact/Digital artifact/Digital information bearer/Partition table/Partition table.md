...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#PartitionTable

### Subclass Of
```mermaid
graph BT
    d3fend.owl#PartitionTable(Partition<br>table):::d3fend-->d3fend.owl#DigitalInformationBearer
...
- [Partition table](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Partition%20table/Partition%20table.md)
