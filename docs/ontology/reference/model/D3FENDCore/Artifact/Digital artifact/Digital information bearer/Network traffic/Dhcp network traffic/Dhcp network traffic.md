...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#DHCPNetworkTraffic

### Subclass Of
```mermaid
graph BT
    d3fend.owl#DHCPNetworkTraffic(Dhcp<br>network<br>traffic):::d3fend-->d3fend.owl#NetworkTraffic
...
- [Dhcp network traffic](/docs/ontology/reference/model/D3FENDCore/Artifact/Digital%20artifact/Digital%20information%20bearer/Network%20traffic/Dhcp%20network%20traffic/Dhcp%20network%20traffic.md)
