...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#Matching

### Subclass Of
```mermaid
graph BT
    d3fend.owl#Matching(Matching):::d3fend-->d3fend.owl#AnalyticalPurpose
...
- [Matching](/docs/ontology/reference/model/D3FENDCore/Goal/Analytical%20purpose/Matching/Matching.md)
