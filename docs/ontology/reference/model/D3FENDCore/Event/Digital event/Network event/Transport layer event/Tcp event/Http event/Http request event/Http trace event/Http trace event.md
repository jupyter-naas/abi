...
### Definition
An event where the HTTP TRACE method is used to perform a message loop-back test along the path to the target resource.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#HTTPTraceEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#HTTPTraceEvent(Http<br>trace<br>event):::d3fend-->d3fend.owl#HTTPRequestEvent
...
- [Http trace event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Network%20event/Transport%20layer%20event/Tcp%20event/Http%20event/Http%20request%20event/Http%20trace%20event/Http%20trace%20event.md)
