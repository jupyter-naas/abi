...
### Definition
An event occurring at the transport layer, responsible for end-to-end communication and data transfer management.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#TransportLayerEvent
