...
### Definition
An event involving the Hypertext Transfer Protocol (HTTP), which operates over TCP to transmit hypermedia documents.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#HTTPEvent
