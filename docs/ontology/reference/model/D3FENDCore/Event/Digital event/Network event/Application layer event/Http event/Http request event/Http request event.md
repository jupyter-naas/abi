...
### Definition
An event where an HTTP request is sent from a client to a server over an established TCP connection.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#HTTPRequestEvent
