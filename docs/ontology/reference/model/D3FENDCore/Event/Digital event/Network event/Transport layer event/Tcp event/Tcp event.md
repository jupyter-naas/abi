...
### Definition
An event involving the Transmission Control Protocol (TCP), providing reliable, ordered, and error-checked delivery of data between applications.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#TCPEvent
