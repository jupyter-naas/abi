...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTDeleteDataEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTDeleteDataEvent(Ot<br>delete<br>data<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot delete data event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20delete%20data%20event/Ot%20delete%20data%20event.md)
