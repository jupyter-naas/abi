...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTStartServiceEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTStartServiceEvent(Ot<br>start<br>service<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot start service event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20start%20service%20event/Ot%20start%20service%20event.md)
