...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTModifyDevicePowerEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTModifyDevicePowerEvent(Ot<br>device<br>power<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot device power event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20device%20power%20event/Ot%20device%20power%20event.md)
