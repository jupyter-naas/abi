...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTStopServiceEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTStopServiceEvent(Ot<br>stop<br>service<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot stop service event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20stop%20service%20event/Ot%20stop%20service%20event.md)
