...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTUploadDataEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTUploadDataEvent(Ot<br>upload<br>data<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot upload data event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20upload%20data%20event/Ot%20upload%20data%20event.md)
