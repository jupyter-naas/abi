...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#OTPauseServiceEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#OTPauseServiceEvent(Ot<br>pause<br>service<br>event):::d3fend-->d3fend.owl#OTCommandEvent
...
- [Ot pause service event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Ot%20event/Ot%20command%20event/Ot%20pause%20service%20event/Ot%20pause%20service%20event.md)
