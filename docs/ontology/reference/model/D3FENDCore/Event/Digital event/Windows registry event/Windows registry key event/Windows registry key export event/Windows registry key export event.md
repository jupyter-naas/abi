...
### Definition
An event representing the export of registry key data from the Windows Registry to an external file or format.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsRegistryKeyExportEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsRegistryKeyExportEvent(Windows<br>registry<br>key<br>export<br>event):::d3fend-->d3fend.owl#WindowsRegistryKeyEvent
...
- [Windows registry key export event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Windows%20registry%20event/Windows%20registry%20key%20event/Windows%20registry%20key%20export%20event/Windows%20registry%20key%20export%20event.md)
