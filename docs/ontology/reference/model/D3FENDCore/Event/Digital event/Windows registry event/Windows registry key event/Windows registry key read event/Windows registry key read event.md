...
### Definition
An event where a registry key is accessed to query its structure, properties, or associated metadata without modifying its state.
...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#WindowsRegistryKeyReadEvent

### Subclass Of
```mermaid
graph BT
    d3fend.owl#WindowsRegistryKeyReadEvent(Windows<br>registry<br>key<br>read<br>event):::d3fend-->d3fend.owl#WindowsRegistryKeyEvent
...
- [Windows registry key read event](/docs/ontology/reference/model/D3FENDCore/Event/Digital%20event/Windows%20registry%20event/Windows%20registry%20key%20event/Windows%20registry%20key%20read%20event/Windows%20registry%20key%20read%20event.md)
