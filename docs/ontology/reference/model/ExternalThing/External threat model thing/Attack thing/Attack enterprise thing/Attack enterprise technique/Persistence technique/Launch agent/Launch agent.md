...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1159

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1159(Launch<br>agent):::d3fend-->d3fend.owl#PersistenceTechnique
...
- [Launch agent](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Persistence%20technique/Launch%20agent/Launch%20agent.md)
