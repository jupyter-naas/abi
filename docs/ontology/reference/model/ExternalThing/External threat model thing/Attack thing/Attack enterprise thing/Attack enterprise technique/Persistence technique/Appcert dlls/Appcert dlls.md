...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1182

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1182(Appcert<br>dlls):::d3fend-->d3fend.owl#PersistenceTechnique
...
- [Appcert dlls](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Persistence%20technique/Appcert%20dlls/Appcert%20dlls.md)
