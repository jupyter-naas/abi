...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1090.002

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1090.002(External<br>proxy):::d3fend-->d3fend.owl#T1090
...
- [External proxy](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Proxy/External%20proxy/External%20proxy.md)
