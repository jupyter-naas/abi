...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1120

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1120(Peripheral<br>device<br>discovery):::d3fend-->d3fend.owl#DiscoveryTechnique
...
- [Peripheral device discovery](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Discovery%20technique/Peripheral%20device%20discovery/Peripheral%20device%20discovery.md)
