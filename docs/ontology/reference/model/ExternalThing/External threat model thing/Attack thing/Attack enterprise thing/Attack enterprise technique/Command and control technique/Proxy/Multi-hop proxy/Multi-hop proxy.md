...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1090.003

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1090.003(Multi-hop<br>proxy):::d3fend-->d3fend.owl#T1090
...
- [Multi-hop proxy](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Proxy/Multi-hop%20proxy/Multi-hop%20proxy.md)
