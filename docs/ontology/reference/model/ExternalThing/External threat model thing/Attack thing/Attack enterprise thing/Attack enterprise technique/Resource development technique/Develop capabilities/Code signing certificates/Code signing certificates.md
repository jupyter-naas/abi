...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1587.002

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1587.002(Code<br>signing<br>certificates):::d3fend-->d3fend.owl#T1587
    d3fend.owl#T1587(Develop<br>capabilities):::d3fend-->d3fend.owl#ResourceDevelopmentTechnique
...
- [Code signing certificates](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Resource%20development%20technique/Develop%20capabilities/Code%20signing%20certificates/Code%20signing%20certificates.md)
