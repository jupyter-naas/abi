...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1028

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1028(Windows<br>remote<br>management):::d3fend-->d3fend.owl#LateralMovementTechnique
...
- [Windows remote management](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Lateral%20movement%20technique/Windows%20remote%20management/Windows%20remote%20management.md)
