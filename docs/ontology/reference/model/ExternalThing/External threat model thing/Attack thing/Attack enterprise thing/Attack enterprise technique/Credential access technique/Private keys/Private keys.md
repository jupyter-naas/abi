...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1145

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1145(Private<br>keys):::d3fend-->d3fend.owl#CredentialAccessTechnique
...
- [Private keys](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Credential%20access%20technique/Private%20keys/Private%20keys.md)
