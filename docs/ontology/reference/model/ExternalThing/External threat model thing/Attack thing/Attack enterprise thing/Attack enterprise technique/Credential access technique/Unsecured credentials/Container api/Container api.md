...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1552.007

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1552.007(Container<br>api):::d3fend-->d3fend.owl#T1552
...
- [Container api](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Credential%20access%20technique/Unsecured%20credentials/Container%20api/Container%20api.md)
