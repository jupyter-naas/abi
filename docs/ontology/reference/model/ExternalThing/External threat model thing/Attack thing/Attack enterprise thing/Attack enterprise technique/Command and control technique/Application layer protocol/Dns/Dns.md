...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1071.004

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1071.004(Dns):::d3fend-->d3fend.owl#T1071
...
- [Dns](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Application%20layer%20protocol/Dns/Dns.md)
