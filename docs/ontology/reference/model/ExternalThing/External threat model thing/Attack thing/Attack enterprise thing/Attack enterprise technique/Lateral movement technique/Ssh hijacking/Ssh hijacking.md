...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1184

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1184(Ssh<br>hijacking):::d3fend-->d3fend.owl#LateralMovementTechnique
...
- [Ssh hijacking](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Lateral%20movement%20technique/Ssh%20hijacking/Ssh%20hijacking.md)
