...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1552.005

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1552.005(Cloud<br>instance<br>metadata<br>api):::d3fend-->d3fend.owl#T1552
...
- [Cloud instance metadata api](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Credential%20access%20technique/Unsecured%20credentials/Cloud%20instance%20metadata%20api/Cloud%20instance%20metadata%20api.md)
