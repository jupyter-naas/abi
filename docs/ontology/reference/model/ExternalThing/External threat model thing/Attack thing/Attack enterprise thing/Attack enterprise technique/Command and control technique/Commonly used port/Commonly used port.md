...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1043

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1043(Commonly<br>used<br>port):::d3fend-->d3fend.owl#CommandAndControlTechnique
...
- [Commonly used port](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Commonly%20used%20port/Commonly%20used%20port.md)
