...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1021.004

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1021.004(Ssh):::d3fend-->d3fend.owl#T1021
...
- [Ssh](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Lateral%20movement%20technique/Remote%20services/Ssh/Ssh.md)
