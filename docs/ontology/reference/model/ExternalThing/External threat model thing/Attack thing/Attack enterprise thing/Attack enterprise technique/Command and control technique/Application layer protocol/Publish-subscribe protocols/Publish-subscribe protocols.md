...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1071.005

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1071.005(Publish-subscribe<br>protocols):::d3fend-->d3fend.owl#T1071
    d3fend.owl#T1071(Application<br>layer<br>protocol):::d3fend-->d3fend.owl#CommandAndControlTechnique
...
- [Publish-subscribe protocols](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Command%20and%20control%20technique/Application%20layer%20protocol/Publish-subscribe%20protocols/Publish-subscribe%20protocols.md)
