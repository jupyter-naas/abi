...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1555.004

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1555.004(Windows<br>credential<br>manager):::d3fend-->d3fend.owl#T1555
...
- [Windows credential manager](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Credential%20access%20technique/Credentials%20from%20password%20stores/Windows%20credential%20manager/Windows%20credential%20manager.md)
