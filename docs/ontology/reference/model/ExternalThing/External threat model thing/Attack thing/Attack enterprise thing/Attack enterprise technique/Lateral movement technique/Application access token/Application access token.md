...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1527

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1527(Application<br>access<br>token):::d3fend-->d3fend.owl#LateralMovementTechnique
...
- [Application access token](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Lateral%20movement%20technique/Application%20access%20token/Application%20access%20token.md)
