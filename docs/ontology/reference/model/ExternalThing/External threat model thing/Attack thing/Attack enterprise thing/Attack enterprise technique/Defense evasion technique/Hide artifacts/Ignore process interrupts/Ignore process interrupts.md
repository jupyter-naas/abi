...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1564.011

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1564.011(Ignore<br>process<br>interrupts):::d3fend-->d3fend.owl#T1564
...
- [Ignore process interrupts](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Defense%20evasion%20technique/Hide%20artifacts/Ignore%20process%20interrupts/Ignore%20process%20interrupts.md)
