...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1037.004

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1037.004(Rc<br>scripts):::d3fend-->d3fend.owl#T1037
...
- [Rc scripts](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Boot%20or%20logon%20initialization%20scripts/Rc%20scripts/Rc%20scripts.md)
