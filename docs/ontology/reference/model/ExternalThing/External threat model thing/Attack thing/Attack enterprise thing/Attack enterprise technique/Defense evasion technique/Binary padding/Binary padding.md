...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1009

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1009(Binary<br>padding):::d3fend-->d3fend.owl#DefenseEvasionTechnique
...
- [Binary padding](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Defense%20evasion%20technique/Binary%20padding/Binary%20padding.md)
