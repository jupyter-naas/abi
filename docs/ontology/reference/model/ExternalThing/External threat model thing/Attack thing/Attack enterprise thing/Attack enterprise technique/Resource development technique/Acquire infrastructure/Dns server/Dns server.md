...
### URI
http://d3fend.mitre.org/ontologies/d3fend.owl#T1583.002

### Subclass Of
```mermaid
graph BT
    d3fend.owl#T1583.002(Dns<br>server):::d3fend-->d3fend.owl#T1583
...
- [Dns server](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Resource%20development%20technique/Acquire%20infrastructure/Dns%20server/Dns%20server.md)
