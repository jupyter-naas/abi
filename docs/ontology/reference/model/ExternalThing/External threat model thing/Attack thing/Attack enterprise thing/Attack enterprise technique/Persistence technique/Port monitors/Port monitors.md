...
```mermaid
graph BT
    d3fend.owl#T1013(Port<br>monitors):::d3fend-->d3fend.owl#PersistenceTechnique
...
- [Port monitors](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Persistence%20technique/Port%20monitors/Port%20monitors.md)
