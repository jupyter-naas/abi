...
```mermaid
graph BT
    d3fend.owl#T1574.007(Path<br>interception<br>by<br>path<br>environment<br>variable):::d3fend-->d3fend.owl#T1574
...
- [Path interception by path environment variable](/docs/ontology/reference/model/ExternalThing/External%20threat%20model%20thing/Attack%20thing/Attack%20enterprise%20thing/Attack%20enterprise%20technique/Privilege%20escalation%20technique/Hijack%20execution%20flow/Path%20interception%20by%20path%20environment%20variable/Path%20interception%20by%20path%20environment%20variable.md)
