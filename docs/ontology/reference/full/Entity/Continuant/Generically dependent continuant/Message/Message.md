...
### Definition
b is a message =Def b is a generically dependent continuant that is concretized by at least two copies, where at least one copy is generated by an agent with the intention of having at least one other agent notice the GDC

### Examples
An email message copied from sender's outbox to recipient's inbox; a spoken utterance that generates sound waves received by a listener; a text message transmitted between devices

### Aliases
Not defined.

### URI
http://ontology.naas.ai/messaging#Message

### Subclass Of
```mermaid
graph BT
    messaging#Message(Message):::bfo-->BFO_0000031
...
- [Message](/docs/ontology/reference/full/Entity/Continuant/Generically%20dependent%20continuant/Message/Message.md)
...
| abi | [has content length](http://ontology.naas.ai/messaging#hasContentLength) | m has content length n =Def m is a message & n is a non-negative integer representing the size measurement of m when concretized | A text message has content length 160 characters; an email message has content length 1024 bytes | [message](/docs/ontology/reference/full/Entity/Continuant/Generically%20dependent%20continuant/Message/Message.md) | [nonNegativeInteger](http://www.w3.org/2001/XMLSchema#nonNegativeInteger) |
| abi | [has textual representation](http://ontology.naas.ai/messaging#hasTextualRepresentation) | m has textual representation s =Def m is a message & s is a string & s is the textual representation of m when concretized in text form | An email message has textual representation 'Hello World'; a chat message has textual representation 'See you tomorrow' | [message](/docs/ontology/reference/full/Entity/Continuant/Generically%20dependent%20continuant/Message/Message.md) | [string](http://www.w3.org/2001/XMLSchema#string) |
