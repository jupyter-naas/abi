...
### Definition
b is a message sender role =Def b is a role that inheres in an agent & b is realized by processes in which that agent participates in creating new concretizations of a message GDC, making it available to agents with receiver roles

### Examples
The role of being an email sender; the role of being a broadcaster; the role of being a speaker in a conversation

### Aliases
Not defined.

### URI
http://ontology.naas.ai/messaging#MessageSenderRole

### Subclass Of
```mermaid
graph BT
    messaging#MessageSenderRole(Message<br>sender<br>role):::bfo-->BFO_0000023
...
- [Message sender role](/docs/ontology/reference/full/Entity/Continuant/Specifically%20dependent%20continuant/Realizable%20entity/Role/Message%20sender%20role/Message%20sender%20role.md)
