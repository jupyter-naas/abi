...
if __name__ == "__main__":
    ...
    path = "storage/datastore/"

    print(
        f"AWS_ACCESS_KEY_ID={access_key_id} AWS_SECRET_ACCESS_KEY={secret_access_key} AWS_SESSION_TOKEN={session_token} aws s3 sync --follow-symlinks --delete  {path} {bucket}/{path}"
    )
