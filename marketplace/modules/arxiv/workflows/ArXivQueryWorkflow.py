...
class AuthorQueryParameters(BaseModel):
    ...
    paper_title: Optional[str] = Field(None, description="Title or part of the title of the paper")
...
class ArXivQueryWorkflow(Workflow):
    ...
    def _load_graph(self) -> Graph:
        ...
        if not os.path.exists(self.__configuration.storage_path):
            print(f"Warning: Storage path {self.__configuration.storage_path} does not exist")
    ...
    def as_tools(self) -> list[StructuredTool]:
        ...
        return [
            StructuredTool(
                ...
                func=lambda **kwargs: self.query_authors(AuthorQueryParameters(**kwargs)),
            ...
            StructuredTool(
                ...
                func=lambda **kwargs: self.execute_query(SparqlQueryParameters(**kwargs)),
