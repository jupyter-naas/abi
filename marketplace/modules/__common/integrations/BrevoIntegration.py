...
class BrevoIntegration(Integration):
    ...
    def _make_request(self, method: str, endpoint: str, json: Dict = None) -> Dict:
        ...
        """
        url = (
            f"{self.__configuration.base_url}/{self.__configuration.version}{endpoint}"
        )
    ...
    def create_contact(
        self, email: str, attributes: Dict = None, list_ids: List[int] = None
    ) -> Dict:
    ...
    def get_lists(self, limit: int = 10, offset: int = 0, sort: str = "desc") -> Dict:
    ...
    def update_list(
        self, list_id: int, name: str, folder_id: Optional[int] = None
    ) -> Dict:
    ...
    def get_contacts_in_list(self, list_id: int, limit: int = 100) -> List[Dict]:
        ...
        while True:
            ...
            result = self._make_request(
                "GET", f"/contacts/lists/{list_id}/contacts", params
            )
            contacts = result.get("contacts", [])
            data.extend(contacts)
    ...
    def remove_contacts_from_list(self, list_id: int, contact_ids: List[int]) -> Dict:
        ...
        data = {"ids": contact_ids}
        return self._make_request(
            "POST", f"/contacts/lists/{list_id}/contacts/remove", data
        )
    ...
    def revoke_user_invitation(self, email: str) -> Dict:
        ...
        """
        return self._make_request(
            "PUT", f"/organization/user/invitation/revoke/{email}"
        )
    ...
    def resend_user_invitation(self, email: str) -> Dict:
        ...
        """
        return self._make_request(
            "PUT", f"/organization/user/invitation/resend/{email}"
        )
    ...
    def cancel_user_invitation(self, email: str) -> Dict:
        ...
        """
        return self._make_request(
            "PUT", f"/organization/user/invitation/cancel/{email}"
        )
    ...
    def update_user_permissions(
        ...
        Example:
            ...
            ... )
        """
        data = {"allFeaturesAccess": all_features_access}

        if not all_features_access:
            if not privileges:
                raise ValueError(
                    "privileges must be provided when all_features_access is False"
                )
            data["privileges"] = privileges

        return self._make_request(
            "POST", f"/organization/user/update/permissions/{email}", data
        )
    ...
    def send_user_invitation(
        ...
        Example:
            ...
            ... )
        """
        data = {"email": email, "allFeaturesAccess": all_features_access}
    ...
    def link_company(
        self, company_id: str, contact_ids: List[str] = None, deal_ids: List[str] = None
    ) -> Dict:
        ...
        Example:
            ...
            ... )
        """
        data = {"linkContactIds": contact_ids or [], "linkDealsIds": deal_ids or []}
    ...
    def unlink_company(
        ...
        Example:
            ...
            ... )
        """
        data = {"unlinkContactIds": contact_ids or [], "unlinkDealsIds": deal_ids or []}
        return self._make_request("PATCH", f"/companies/link-unlink/{company_id}", data)
    ...
    def create_task(
        ...
        Example:
            ...
            ... )
        """
        data = {"name": name, "taskTypeId": task_type_id, "date": date}
...
def as_tools(configuration: BrevoIntegrationConfiguration):
    ...
    class GetAllContactsSchema(BaseModel):
        limit: int = Field(
            100, description="Maximum number of contacts to return per page"
        )

    class GetContactSchema(BaseModel):
        identifier: str = Field(
            ..., description="Contact identifier (email, ID, phone etc.)"
        )
        identifier_type: str = Field(
            None, description="Type of identifier (email_id, phone_id, etc.)"
        )
    ...
    class GetEmailCampaignReportSchema(BaseModel):
        campaign_id: str = Field(
            ..., description="ID of the campaign to get report for"
        )
    ...
    class ResendCancelUserInviteSchema(BaseModel):
        email: str = Field(
            ..., description="Email address of the user to resend invite to"
        )
        action: str = Field(..., description="Action to take ('resend' or 'cancel')")

    class SendUserInviteSchema(BaseModel):
        email: str = Field(
            ..., description="Email address of the user to send invite to"
        )

    class UpdateUserPermissionsSchema(BaseModel):
        email: str = Field(
            ..., description="Email address of the user to update permissions for"
        )
    ...
    class CreateDealSchema(BaseModel):
        ...
        company_id: str = Field(
            ..., description="ID of the company to associate with the deal"
        )
    ...
    return [
        ...
        StructuredTool(
            ...
            func=lambda identifier, identifier_type: integration.get_contact(
        ...
        StructuredTool(
            ...
            func=lambda email, attributes, list_ids: integration.create_contact(
                email, attributes, list_ids
            ),
        ...
        StructuredTool(
            ...
            func=lambda name, description, contacts: integration.create_list(
        ...
        StructuredTool(
            ...
            func=lambda list_id, contact_id: integration.add_contacts_to_list(
                list_id, contact_id
            ),
        ...
        StructuredTool(
            ...
            func=lambda list_id, contact_id: integration.remove_contacts_from_list(
                list_id, contact_id
            ),
        ...
        StructuredTool(
            ...
            func=lambda start_date,
            end_date,
            limit,
            offset: integration.get_organization_activities(
        ...
        StructuredTool(
            ...
            func=lambda email, action: integration.resend_user_invitation(email)
            if action == "resend"
            else integration.cancel_user_invitation(email),
        ...
        StructuredTool(
            ...
            func=lambda email, permissions: integration.update_user_permissions(
                email, permissions
            ),
        ...
        StructuredTool(
            ...
            func=lambda task_name,
            task_type,
            task_due_date,
            task_status,
            task_priority,
            task_description: integration.create_task(
                task_name,
                task_type,
                task_due_date,
                task_status,
        ...
        StructuredTool(
            ...
            contact_ids,
            deal_ids,
            company_ids: integration.create_note(
                text, contact_ids, deal_ids, company_ids
            ),
