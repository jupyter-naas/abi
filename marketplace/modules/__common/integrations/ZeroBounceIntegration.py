...
class ZeroBounceIntegration(Integration):
    ...
    def validate_email(self, email: str, ip_address: Optional[str] = None) -> Dict:
        ...
        response = requests.get(
            f"{self.__configuration.base_url}/validate", params=params
        )
    ...
    def get_credits(self) -> int:
        ...
        """
        params = {"api_key": self.__configuration.api_key}
        response = requests.get(
            f"{self.__configuration.base_url}/getcredits", params=params
        )
        response.raise_for_status()
    ...
    def get_api_usage(self, start_date: str, end_date: str) -> Dict:
        ...
        response = requests.get(
            f"{self.__configuration.base_url}/getapiusage", params=params
        )
        response.raise_for_status()
        return response.json()
...
def as_tools(configuration: ZeroBounceIntegrationConfiguration):
    ...
    class ValidateEmailSchema(BaseModel):
        ...
        ip_address: Optional[str] = Field(
            None, description="IP address to include in the validation"
        )
