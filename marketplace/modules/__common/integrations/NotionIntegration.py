    ...
    return [
        ...
        StructuredTool(
            ...
            func=lambda database_id, title: integration.create_page(
                database_id, integration.create_property("Title", title, "title")
            ),
        ...
        StructuredTool(
            ...
            func=lambda page_id, properties: integration.update_page(
                page_id, properties
            ),
        ...
        StructuredTool(
            ...
            func=lambda database_id, title: integration.search_by_title(
                database_id, title
            ),
