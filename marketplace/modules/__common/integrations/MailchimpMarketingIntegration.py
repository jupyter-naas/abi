...
class MailchimpMarketingIntegration(Integration):
    ...
    def create_account_export(
        self, include_stages: List[str], since_timestamp: Optional[str] = None
    ) -> dict:
        ...
        """
        endpoint = f"{self.base_url}/account-exports"
        data = {"include_stages": include_stages}
        if since_timestamp:
    ...
    def update_campaign_feedback_message(
        self, campaign_id: str, feedback_id: str, data: dict
    ) -> dict:
        """Update a specific feedback message for a campaign."""
        endpoint = f"{self.base_url}/campaigns/{campaign_id}/feedback/{feedback_id}"
        return self._make_request("PATCH", endpoint, data=data)

    def delete_campaign_feedback_message(
        self, campaign_id: str, feedback_id: str
    ) -> dict:
    ...
    def get_interest_category_info(
        self, list_id: str, interest_category_id: str
    ) -> dict:
    ...
    def update_interest_category(
        self, list_id: str, interest_category_id: str, data: dict
    ) -> dict:
    ...
    def list_interests_in_category(
        self, list_id: str, interest_category_id: str
    ) -> dict:
    ...
    def get_interest_in_category(
        self, list_id: str, interest_category_id: str, interest_id: str
    ) -> dict:
        """Get interests or 'group names' for a specific category."""
        endpoint = f"{self.base_url}/lists/{list_id}/interest-categories/{interest_category_id}/interests/{interest_id}"
        return self._make_request("GET", endpoint)

    def update_interest_in_category(
        self, list_id: str, interest_category_id: str, interest_id: str, data: dict
    ) -> dict:
        """Update interests or 'group names' for a specific category."""
        endpoint = f"{self.base_url}/lists/{list_id}/interest-categories/{interest_category_id}/interests/{interest_id}"
        return self._make_request("PATCH", endpoint, data=data)

    def delete_interest_in_category(
        self, list_id: str, interest_category_id: str, interest_id: str
    ) -> dict:
    ...
    def list_member_activity_feed(self, list_id: str, subscriber_hash: str) -> dict:
        ...
        endpoint = (
            f"{self.base_url}/lists/{list_id}/members/{subscriber_hash}/activity-feed"
        )
        return self._make_request("GET", endpoint)
    ...
    def update_member_note(
        self, list_id: str, subscriber_hash: str, note_id: str, data: dict
    ) -> dict:
    ...
    def delete_member_note(
        self, list_id: str, subscriber_hash: str, note_id: str
    ) -> dict:
    ...
    def add_or_remove_member_tags(
        self, list_id: str, subscriber_hash: str, data: dict
    ) -> dict:
    ...
    def batch_add_remove_members(
        self, list_id: str, segment_id: str, data: dict
    ) -> dict:
    ...
    def publish_survey(self, list_id: str, survey_id: str) -> dict:
        ...
        endpoint = (
            f"{self.base_url}/lists/{list_id}/surveys/{survey_id}/actions/publish"
        )
        return self._make_request("POST", endpoint)
    ...
    def unpublish_survey(self, list_id: str, survey_id: str) -> dict:
        ...
        endpoint = (
            f"{self.base_url}/lists/{list_id}/surveys/{survey_id}/actions/unpublish"
        )
        return self._make_request("POST", endpoint)
...
def as_tools(configuration: MailchimpMarketingIntegrationConfiguration):
    ...
    class ListAccountExportsSchema(BaseModel):
        fields: Optional[List[str]] = Field(
            None, description="A comma-separated list of fields to return"
        )
        exclude_fields: Optional[List[str]] = Field(
            None, description="A comma-separated list of fields to exclude"
        )
    ...
    class CreateAccountExportSchema(BaseModel):
        ...
        since_timestamp: Optional[str] = Field(
            None,
            description="An ISO 8601 date that will limit the export to only records created after a given time",
        )
    ...
    class CampaignContentSchema(BaseModel):
        ...
        data: Dict = Field(
            ...,
            description="The content settings including html, plain_text, or template configuration",
        )
    ...
    class CampaignCreateSchema(BaseModel):
        data: Dict = Field(
            ..., description="Campaign settings including type, settings, recipients"
        )
    ...
    class CampaignScheduleSchema(BaseModel):
        ...
        data: Dict = Field(
            ...,
            description="Schedule settings including schedule_time, timewarp, batch_delivery",
        )

    class CampaignTestEmailSchema(BaseModel):
        campaign_id: str = Field(..., description="The unique id for the campaign")
        data: Dict = Field(
            ..., description="Test email settings including test_emails and send_type"
        )
    ...
    class WebhookSchema(BaseModel):
        ...
        webhook_id: Optional[str] = Field(
            None, description="The unique id for the webhook"
        )
    ...
    class InterestCategorySchema(BaseModel):
        ...
        interest_category_id: Optional[str] = Field(
            None, description="The unique id for the interest category"
        )
        data: Optional[Dict] = Field(None, description="Interest category data")

    class InterestSchema(BaseModel):
        list_id: str = Field(..., description="The unique id for the list")
        interest_category_id: str = Field(
            ..., description="The unique id for the interest category"
        )
        interest_id: Optional[str] = Field(
            None, description="The unique id for the interest"
        )
    ...
    class MergeFieldSchema(BaseModel):
        ...
        merge_id: Optional[str] = Field(
            None, description="The unique id for the merge field"
        )
