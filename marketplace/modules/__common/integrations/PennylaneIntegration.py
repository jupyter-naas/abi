...
class PennylaneIntegration(Integration):
    ...
    def _make_request(
        self, endpoint: str, method: str = "GET", json: Dict = None, params: Dict = {}
    ) -> Dict:
    ...
    def list_customer_invoices(
        self, limit: int = -1, filter: Optional[str] = None
    ) -> List[Dict]:
    ...
    def update_customer_invoice(
        ...
        return self._make_request(
            f"/customer_invoices/{invoice_id}", method="PUT", json=data
        )
    ...
    def update_estimate(self, estimate_id: str, estimate_data: Dict) -> Dict:
        ...
        """
        return self._make_request(
            f"/customer_estimates/{estimate_id}",
            method="PUT",
            json={"invoice": estimate_data},
        )
    ...
    def update_customer(self, customer_id: str, **customer_data) -> Dict:
        ...
        """
        return self._make_request(
            f"/customers/{customer_id}", method="PUT", json=customer_data
        )

    def list_products(self, limit: int = -1, page: Optional[int] = None) -> List[Dict]:
    ...
    def update_product(self, product_id: str, **product_data) -> Dict:
        ...
        """
        return self._make_request(
            f"/products/{product_id}", method="PUT", json=product_data
        )

    def list_categories(
        self, sort: Optional[str] = None, filter: Optional[str] = None, limit: int = -1
    ) -> List[Dict]:
    ...
    def update_category(self, category_id: str, category_data: Dict) -> Dict:
        ...
        """
        return self._make_request(
            f"/categories/{category_id}", method="PUT", json={"category": category_data}
        )
    ...
    def update_supplier(self, supplier_id: str, supplier_data: Dict) -> Dict:
        ...
        """
        return self._make_request(
            f"/suppliers/{supplier_id}", method="PUT", json={"supplier": supplier_data}
        )
...
def as_tools(configuration: PennylaneIntegrationConfiguration):
    ...
    class ListCustomersInvoicesSchema(BaseModel):
        limit: int = Field(
            ..., description="Number of invoices to return. Defaults to -1 (all)."
        )
        filter: Optional[str] = Field(
            ...,
            description='Filter string in JSON format to filter invoices. Example: \'[{"field": "status", "operator": "scope", "value": "late_status"}]\'',
        )
    ...
    class UpdateCustomerInvoiceSchema(BaseModel):
        ...
        transaction_reference: Optional[str] = Field(
            ..., description="New transaction reference"
        )
        categories: Optional[List[str]] = Field(
            ..., description="List of category IDs to link to the invoice"
        )

    class ListEstimatesSchema(BaseModel):
        limit: int = Field(
            ..., description="Number of estimates to return. Defaults to -1 (all)."
        )
        filter: Optional[str] = Field(
            ...,
            description='Filter string in JSON format to filter estimates. Example: \'[{"field": "status", "operator": "scope", "value": "estimate_pending_status"}]\'',
        )
    ...
    class ListCustomersSchema(BaseModel):
        limit: int = Field(
            ..., description="Number of customers to return. Defaults to -1 (all)."
        )
        filter: Optional[str] = Field(
            ...,
            description='Filter string in JSON format to filter customers. Example: \'[{"field": "country_alpha2", "operator": "eq", "value": "FR"}]\'',
        )
    ...
    class ListProductsSchema(BaseModel):
        limit: int = Field(
            ..., description="Number of products to return. Defaults to -1 (all)."
        )
    ...
    class ListCategoriesSchema(BaseModel):
        sort: Optional[str] = Field(
            ...,
            description="Sort categories by attributes (id, group_id, label, direction) separated by commas.",
        )
        filter: Optional[str] = Field(
            ...,
            description='Filter categories by attributes (id, group_id, label, direction). Example: \'[{"field": "direction", "operator": "eq", "value": "cash_out"}]\'',
        )
        limit: int = Field(
            ...,
            description="Total number of categories to return. Defaults to -1 (all).",
        )
    ...
    class ListPlanItemsSchema(BaseModel):
        ...
        per_page: Optional[int] = Field(
            ..., description="Number of plan items per page (defaults to 20)."
        )

    class GetEnumSchema(BaseModel):
        enum_id: str = Field(
            ...,
            description="Identifier of the enum to retrieve (e.g. 'countries', 'vat_rate')",
        )
    ...
    class ListSuppliersSchema(BaseModel):
        ...
        limit: int = Field(
            ...,
            description="Total number of suppliers to return. Defaults to -1 (all).",
        )
    ...
    class ListSupplierInvoicesSchema(BaseModel):
        ...
        per_page: Optional[int] = Field(
            ..., description="Number of invoices per page (defaults to 20)."
        )
        filter: Optional[str] = Field(
            ...,
            description='Filter string for invoices. Example: \'[{"field": "status", "operator": "scope", "value": "late_status"}]\'',
        )

    class GetSupplierInvoiceSchema(BaseModel):
        invoice_id: str = Field(
            ..., description="ID of the supplier invoice to retrieve"
        )

    class UpdateSupplierInvoiceSchema(BaseModel):
        invoice_id: str = Field(..., description="ID of the supplier invoice to update")
        invoice_data: Dict = Field(
            ...,
            description="Updated invoice data containing transaction reference and categories",
        )
    ...
    return [
        StructuredTool(
            ...
            func=lambda limit, filter: integration.list_customer_invoices(
                limit, filter
            ),
        ...
        StructuredTool(
            ...
            categories: integration.update_customer_invoice(
                invoice_id, transaction_reference, categories
            ),
        ...
        StructuredTool(
            ...
            func=lambda estimate_id, estimate_data: integration.update_estimate(
                estimate_id, estimate_data
            ),
        ...
        StructuredTool(
            ...
            func=lambda customer_id, customer_data: integration.update_customer(
        ...
        StructuredTool(
            ...
            func=lambda product_id, product_data: integration.update_product(
        ...
        StructuredTool(
            ...
            func=lambda sort, filter, limit: integration.list_categories(
                sort, filter, limit
            ),
        ...
        StructuredTool(
            ...
            func=lambda category_id, category_data: integration.update_category(
        ...
        StructuredTool(
            ...
            func=lambda supplier_id, supplier_data: integration.update_supplier(
        ...
        StructuredTool(
            ...
            func=lambda page, per_page, filter: integration.list_supplier_invoices(
        ...
        StructuredTool(
            ...
            func=lambda invoice_id, invoice_data: integration.update_supplier_invoice(
