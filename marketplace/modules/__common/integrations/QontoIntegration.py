...
class QontoIntegration(Integration):
    ...
    def _get_all(
        self, endpoint: str, params: Dict = None, limit: int = 100
    ) -> List[Dict]:
    ...
    def list_cards(
        ...
        Raises:
            IntegrationConnectionError: If request fails
        """
        params = {"page": 1, "per_page": 100, "sort_by": sort_by}
    ...
    def list_transaction_attachments(
        self, transaction_id: str, limit: Optional[int] = 100
    ) -> List[Dict]:
    ...
    def list_statements(
        ...
        if bank_account_ids and ibans:
            raise ValueError(
                "bank_account_ids and ibans parameters are mutually exclusive"
            )
...
def as_tools(configuration: QontoIntegrationConfiguration):
    ...
    class ListTransactionsSchema(BaseModel):
        ...
        status: Optional[List[str]] = Field(
            None, description="Transaction status (pending, declined, completed)"
        )
        settled_at_from: Optional[str] = Field(
            None, description="Filter by settlement date from (ISO 8601)"
        )
        settled_at_to: Optional[str] = Field(
            None, description="Filter by settlement date to (ISO 8601)"
        )
        emitted_at_from: Optional[str] = Field(
            None, description="Filter by emission date from (ISO 8601)"
        )
        emitted_at_to: Optional[str] = Field(
            None, description="Filter by emission date to (ISO 8601)"
        )
        updated_at_from: Optional[str] = Field(
            None, description="Filter by update date from (ISO 8601)"
        )
        updated_at_to: Optional[str] = Field(
            None, description="Filter by update date to (ISO 8601)"
        )
        operation_type: Optional[List[str]] = Field(
            None, description="Filter by operation types (card, transfer, income)"
        )
        side: Optional[str] = Field(
            None, description="Filter by transaction side (credit or debit)"
        )
        includes: Optional[List[str]] = Field(
            None,
            description="Embed associated resources (vat_details, labels, attachments)",
        )
        with_attachments: Optional[bool] = Field(
            None, description="Filter transactions with attachments"
        )
    ...
    class GetSupplierInvoicesSchema(BaseModel):
        status: Optional[str] = Field(
            None,
            description="Filter by invoice status (to_review, pending, scheduled, paid)",
        )
        created_at_from: Optional[str] = Field(
            None, description="Filter by min created date (ISO 8601)"
        )
        created_at_to: Optional[str] = Field(
            None, description="Filter by max created date (ISO 8601)"
        )
    ...
    class GetClientInvoicesSchema(BaseModel):
        status: Optional[str] = Field(
            None, description="Filter by invoice status (draft, unpaid, canceled, paid)"
        )
        created_at_from: Optional[str] = Field(
            None, description="Filter by min created date (ISO 8601)"
        )
    ...
    class ListClientsSchema(BaseModel):
        tax_identification_number: Optional[str] = Field(
            None, description="Filter by tax identification number"
        )
        ...
        name: Optional[str] = Field(
            None, description="Filter by client name (min 2 chars)"
        )
    ...
    class ListCardsSchema(BaseModel):
        bank_account_ids: Optional[List[str]] = Field(
            None, description="Filter by bank account IDs"
        )
        card_levels: Optional[List[str]] = Field(
            None, description="Filter by card levels"
        )
        holder_ids: Optional[List[str]] = Field(
            None, description="Filter by cardholder membership IDs"
        )
        ...
        statuses: Optional[List[str]] = Field(
            None, description="Filter by card statuses"
        )
        limit: Optional[int] = 100
    ...
    class ListBeneficiariesSchema(BaseModel):
        ...
        status: Optional[List[str]] = Field(
            None, description="Filter by status (pending, validated, declined)"
        )
        trusted: Optional[bool] = Field(None, description="Filter by trusted status")
        updated_at_from: Optional[str] = Field(
            None, description="Filter by min updated date (ISO 8601)"
        )
        updated_at_to: Optional[str] = Field(
            None, description="Filter by max updated date (ISO 8601)"
        )
    ...
    class GetBeneficiarySchema(BaseModel):
        beneficiary_id: str = Field(
            ..., description="UUID of the beneficiary to retrieve"
        )

    class GetAttachmentSchema(BaseModel):
        attachment_id: str = Field(
            ..., description="UUID of the attachment to retrieve"
        )
    ...
    class GetLabelSchema(BaseModel):
        label_id: str = Field(
            ..., description="Unique identifier of the label to retrieve"
        )
    ...
    class ListStatementsSchema(BaseModel):
        ...
        period_from: Optional[str] = Field(
            None, description="Start of statement period (MM-YYYY)"
        )
        period_to: Optional[str] = Field(
            None, description="End of statement period (MM-YYYY)"
        )
