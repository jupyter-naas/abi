    ...
    def create_dataset(
        ...
        try:
            dataset = bigquery.Dataset(
                f"{self.__configuration.project_id}.{dataset_id}"
            )
    ...
    def load_table_from_json(
        ...
        try:
            ...
            load_job = self.__client.load_table_from_json(
                json_rows, table_ref, job_config=job_config
            )
...
def as_tools(configuration: GCPBigQueryIntegrationConfiguration):
    ...
    class QuerySchema(BaseModel):
        ...
        params: Optional[List[Union[str, int, float]]] = Field(
    ...
    class CreateTableSchema(BaseModel):
        ...
        partition_field: Optional[str] = Field(
            None, description="Field to partition by"
        )
        cluster_fields: Optional[List[str]] = Field(
            None, description="Fields to cluster by"
        )
    ...
    class LoadTableSchema(BaseModel):
        ...
        table_schema: Optional[List[Dict[str, str]]] = Field(
            None, description="Table schema if creating new table"
        )
    ...
    return [
        StructuredTool(
            ...
            func=lambda query, params, timeout: integration.run_query(
        ...
        StructuredTool(
            ...
            func=lambda dataset_id, description, labels: integration.create_dataset(
        ...
        StructuredTool(
            ...
            description,
            partition_field,
            cluster_fields: integration.create_table(
                dataset_id,
                table_id,
                table_schema,
                description,
        ...
        StructuredTool(
            ...
            table_id,
            json_rows,
            table_schema: integration.load_table_from_json(
                dataset_id, table_id, json_rows, table_schema
            ),
