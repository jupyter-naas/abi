...
class AirtableIntegration(Integration):
    ...
    def _make_request(
        ...
        """
        url = (
            f"{self.__configuration.base_url}/{self.__configuration.base_id}{endpoint}"
        )
    ...
    def create_records(self, table_name: str, records: List[Dict]) -> Dict:
        ...
        return self._make_request(
            f"/{table_name}", method="POST", json={"records": records}
        )
    ...
    def update_records(self, table_name: str, records: List[Dict]) -> Dict:
        ...
        """
        return self._make_request(
            f"/{table_name}", method="PATCH", json={"records": records}
        )
    ...
    def delete_records(self, table_name: str, record_ids: List[str]) -> Dict:
        ...
        return self._make_request(f"/{table_name}", method="DELETE", params=params)
...
def as_tools(configuration: AirtableIntegrationConfiguration):
    ...
    return [
        StructuredTool(
            ...
            func=lambda table_name,
            max_records,
            view,
            formula: integration.list_records(table_name, max_records, view, formula),
            args_schema=ListRecordsSchema,
        ),
        StructuredTool(
            name="airtable_get_record",
            description="Get a specific record from an Airtable table.",
            func=lambda table_name, record_id: integration.get_record(
        ...
        StructuredTool(
            ...
            func=lambda table_name, records: integration.create_records(
                table_name, records
            ),
        ...
        StructuredTool(
            ...
            func=lambda table_name, records: integration.update_records(
                table_name, records
            ),
        ...
        StructuredTool(
            ...
            func=lambda table_name, record_ids: integration.delete_records(
