...
from src.core.modules.common.integrations.AgicapIntegration import (
...
def create_agicap_agent():
    ...
    if (
        secret.get("AGICAP_USERNAME")
        and secret.get("AGICAP_PASSWORD")
        and secret.get("AGICAP_BEARER_TOKEN")
        and secret.get("AGICAP_CLIENT_ID")
        and secret.get("AGICAP_CLIENT_SECRET")
        and secret.get("AGICAP_API_TOKEN")
    ):
