...
from src.core.modules.common.integrations.ClockifyIntegration import (
    ClockifyIntegrationConfiguration,
)
...
def create_clockify_agent():
    ...
    if secret.get("CLOCKIFY_API_KEY"):
        clockify_integration_config = ClockifyIntegrationConfiguration(
            api_key=secret.get("CLOCKIFY_API_KEY")
        )
