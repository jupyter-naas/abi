...
from src.core.modules.common.integrations.DiscordIntegration import (
...
def create_discord_agent():
    ...
    if secret.get("DISCORD_TOKEN"):
        discord_integration_config = DiscordIntegrationConfiguration(
            token=secret.get("DISCORD_TOKEN")
        )
