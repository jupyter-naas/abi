...
from src.core.modules.common.integrations import SerperIntegration
from src.core.modules.common.integrations.SerperIntegration import (
    SerperIntegrationConfiguration,
)
...
AVATAR_URL = (
    "https://res.cloudinary.com/apideck/image/upload/v1679535605/icons/serper-dev.png"
)
SYSTEM_PROMPT = f"""
