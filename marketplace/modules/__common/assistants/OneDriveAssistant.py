...
from src.core.modules.common.integrations.OneDriveIntegration import OneDriveIntegrationConfiguration
...
def create_onedrive_agent():
    ...
    if secret.get('ONE_DRIVE_ACCESS_TOKEN'):    
        one_drive_integration_config = OneDriveIntegrationConfiguration(access_token=secret.get('ONE_DRIVE_ACCESS_TOKEN'))
