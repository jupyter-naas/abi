...
from src.core.modules.common.integrations import SlackIntegration
from src.core.modules.common.integrations.SlackIntegration import (
...
def create_slack_agent():
    ...
    if secret.get("SLACK_BOT_TOKEN"):
        slack_integration_config = SlackIntegrationConfiguration(
