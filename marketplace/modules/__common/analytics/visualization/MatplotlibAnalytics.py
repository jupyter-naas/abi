...
def as_tools(configuration: MatplotlibAnalyticsConfiguration):
    ...
    class PieChartSchema(BaseModel):
        values: Optional[List] = Field(default=None, description="Values for pie slices")
        labels: Optional[List] = Field(default=None, description="Labels for pie slices")
    ...
    class BoxPlotSchema(BaseModel):
        data: Optional[List[List]] = Field(default=None, description="List of data arrays to plot")
    ...
    class HeatmapSchema(BaseModel):
        data: Optional[List[List]] = Field(default=None, description="2D array of values for heatmap")
        title: str = Field(default="Heatmap", description="Chart title")
        xlabel: str = Field(default="X Axis", description="X-axis label")
        ylabel: str = Field(default="Y Axis", description="Y-axis label")

    class StackedBarSchema(BaseModel):
        data: Optional[List[List]] = Field(default=None, description="List of data arrays for each stack")
        categories: Optional[List] = Field(default=None, description="Category labels")
        labels: Optional[List] = Field(default=None, description="Labels for each stack")
    ...
    class ViolinPlotSchema(BaseModel):
        data: Optional[List[List]] = Field(default=None, description="List of data arrays to plot")
        labels: Optional[List] = Field(default=None, description="Labels for each violin")
