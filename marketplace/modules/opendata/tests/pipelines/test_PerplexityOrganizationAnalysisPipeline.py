...
from src.core.modules.opendata.pipelines.PerplexityOrganizationAnalysisPipeline import (
    PerplexityOrganizationAnalysisPipeline,
    PerplexityOrganizationAnalysisPipelineConfiguration,
    PerplexityOrganizationAnalysisPipelineParameters,
)
from src.core.modules.opendata.workflows.PerplexityGetOrganizationWorkflows import (
...
pipeline.run(
    PerplexityOrganizationAnalysisPipelineParameters(
        organization_name=organization_name, website=website, use_cache=True
    )
)
