...
class OrganizationSizePipeline(Pipeline):
    ...
    def trigger(
        ...
        if str(event) == str(OntologyEvent.INSERT):
            return self.run(
                OrganizationSizePipelineParameters(
    ...
    def run(self, parameters: OrganizationSizePipelineParameters) -> None:
        ...
        if number_of_employees < 10:
            ...
            organization_size_description = (
                "Micro Enterprises are businesses with fewer than 10 employees."
            )
        elif number_of_employees < 50:
            organization_size_id = "small_enterprise"
            organization_size_label = "Small Enterprise"
            organization_size_description = (
                "Small Enterprises are businesses with between 10 and 49 employees."
            )
            ...
            organization_size_description = (
                "Large Enterprises are businesses with more than 250 employees."
            )
        ...
        return [
            StructuredTool(
                ...
                func=lambda **kwargs: self.run(
                    OrganizationSizePipelineParameters(**kwargs)
                ),
