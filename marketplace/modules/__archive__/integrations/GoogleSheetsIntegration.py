...
class GoogleSheetsIntegration(Integration):
    ...
    def get_values(
        ...
        try:
            ...
            raise IntegrationConnectionError(
                f"Google Sheets API request failed: {str(e)}"
            )
    ...
    def create_spreadsheet(
        self, title: str, sheets: Optional[List[Dict]] = None
    ) -> Dict:
        ...
        try:
            ...
            result = self.__service.spreadsheets().create(body=spreadsheet).execute()
            return result
        except HttpError as e:
            raise IntegrationConnectionError(
                f"Google Sheets API request failed: {str(e)}"
...
def as_tools(configuration: GoogleSheetsIntegrationConfiguration):
    ...
    class UpdateValuesSchema(BaseModel):
        ...
        value_input_option: str = Field(
            default="RAW", description="How to interpret input"
        )
    ...
    class AppendValuesSchema(BaseModel):
        ...
        insert_data_option: str = Field(
            default="INSERT_ROWS", description="How to insert data"
        )
    ...
    class CreateSpreadsheetSchema(BaseModel):
        ...
        sheets: Optional[List[Dict]] = Field(
            None, description="List of sheet configurations"
        )
    ...
    return [
        StructuredTool(
            ...
            func=lambda spreadsheet_id,
            range_name,
            major_dimension: integration.get_values(
        ...
        StructuredTool(
            ...
            values,
            major_dimension,
            value_input_option: integration.update_values(
                spreadsheet_id, range_name, values, major_dimension, value_input_option
            ),
        ...
        StructuredTool(
            ...
            major_dimension,
            value_input_option,
            insert_data_option: integration.append_values(
                spreadsheet_id,
                range_name,
                values,
                major_dimension,
        ...
        StructuredTool(
            ...
            func=lambda spreadsheet_id, range_name: integration.clear_values(
