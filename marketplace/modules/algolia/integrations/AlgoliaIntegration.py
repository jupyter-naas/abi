...
class AlgoliaIntegration(Integration):
    ...
    async def search(self, index_name: str, query: str, hits_per_page: int = 50, filters: str = None) -> Dict:
...
def as_tools(configuration: AlgoliaIntegrationConfiguration):
    ...
    class AlgoliaSearchSchema(BaseModel):
        ...
        filters: str = Field(None, description="Optional filter string. Example: 'category:Book AND price < 100'")
