...
class SearchContactByEmailParameters(WorkflowParameters):
    ...
    email: Optional[str] = Field(
        None,
        description="Optional, Email address to search for or domain to search for",
    )
...
class SearchContactByNameParameters(WorkflowParameters):
    ...
    firstname: Optional[str] = Field(
        None, description="Optional, First name to search for"
    )
    lastname: Optional[str] = Field(
        None, description="Optional, Last name to search for"
    )
...
class SearchDealByNameParameters(WorkflowParameters):
    ...
    dealname: Optional[str] = Field(
        None, description="Optional, Name of the deal to search for"
    )
...
class SearchCompanyByNameParameters(WorkflowParameters):
    ...
    name: Optional[str] = Field(
        None, description="Optional, Name of the company to search for"
    )
...
class SearchTaskBySubjectParameters(WorkflowParameters):
    ...
    subject: Optional[str] = Field(
        None, description="Optional, Subject of the task to search for"
    )
...
class SearchTaskByOwnerParameters(WorkflowParameters):
    ...
    owner_id: Optional[str] = Field(
        None, description="Optional, ID of the owner to search for"
    )
...
class CreateTaskParameters(WorkflowParameters):
    ...
    type: Optional[str] = Field(
        "TODO",
        description="Type of task (EMAIL, CALL, or TODO). Use default TODO if not specified",
    )
    priority: Optional[str] = Field(
        "MEDIUM", description="Priority level (LOW, MEDIUM, or HIGH)"
    )
    due_date: Optional[str] = Field(
        None, description="Due date for task in format YYYY-MM-DD"
    )
    owner_id: Optional[str] = Field(None, description="ID of assigned user")
    contact_ids: Optional[List[str]] = Field(
        [], description="Optional list of contact IDs to associate with the task."
    )
    company_ids: Optional[List[str]] = Field(
        [], description="Optional list of company IDs to associate with the task."
    )
    deal_ids: Optional[List[str]] = Field(
        [], description="Optional list of deal IDs to associate with the task."
    )
...
class HubSpotWorkflows(Workflow):
    ...
    def search_contacts_by_email(
        self, parameters: SearchContactByEmailParameters
    ) -> List[Dict]:
        filters = [
            {
                "propertyName": "email",
        ...
        results = self.__hubspot_integration.search_objects(
            "contacts", filters=filters, properties=properties, sorts=sorts
        )
        return [result.get("properties", {}) for result in results]

    def search_contacts_by_name(
        self, parameters: SearchContactByNameParameters
    ) -> List[Dict]:
        filters = []
    ...
    def search_deals_by_name(
        self, parameters: SearchDealByNameParameters
    ) -> List[Dict]:
        filters = [
            {
        ...
        properties = ["dealname", "dealstage", "dealtype", "amount", "closedate"]
        sorts = [{"propertyName": "hs_lastmodifieddate", "direction": "DESCENDING"}]
        results = self.__hubspot_integration.search_objects(
            "deals", filters=filters, properties=properties, sorts=sorts
        )
        return [result.get("properties", {}) for result in results]

    def search_companies_by_name(
        self, parameters: SearchCompanyByNameParameters
    ) -> List[Dict]:
        filters = [
            {
                "propertyName": "name",
        ...
        properties = ["name", "website", "description", "phone", "address"]
        sorts = [{"propertyName": "hs_lastmodifieddate", "direction": "DESCENDING"}]
        results = self.__hubspot_integration.search_objects(
            "companies", filters=filters, properties=properties, sorts=sorts
        )
        return [result.get("properties", {}) for result in results]

    def search_tasks_by_subject(
        self, parameters: SearchTaskBySubjectParameters
    ) -> List[Dict]:
        filter_groups = [
            {
                "filters": [
        ...
        sorts = [{"propertyName": "hs_lastmodifieddate", "direction": "DESCENDING"}]
        results = self.__hubspot_integration.search_objects(
            "tasks", filter_groups=filter_groups, properties=properties, sorts=sorts
        )
        return [result.get("properties", {}) for result in results]

    def search_tasks_by_owner(
        self, parameters: SearchTaskByOwnerParameters
    ) -> List[Dict]:
        filters = [
            {
        ...
        sorts = [{"propertyName": "hs_lastmodifieddate", "direction": "DESCENDING"}]
        results = self.__hubspot_integration.search_objects(
            "tasks", filters=filters, properties=properties, sorts=sorts
        )
        return [result.get("properties", {}) for result in results]
    ...
    def create_task(self, parameters: CreateTaskParameters) -> Dict:
        if parameters.due_date is not None:
            due_date = int(
                (datetime.strptime(parameters.due_date, "%Y-%m-%d"))
    ...
    def delete_task(self, parameters: DeleteTaskParameters) -> Dict:
        result = self.__hubspot_integration.delete_task(task_id=parameters.task_id)
        return result
    ...
    def as_tools(self) -> list[StructuredTool]:
        ...
        return [
            ...
            StructuredTool(
                ...
                func=lambda email: self.search_contacts_by_email(
                    SearchContactByEmailParameters(email=email)
                ),
            ...
            StructuredTool(
                ...
                func=lambda **kwargs: self.search_contacts_by_name(
                    SearchContactByNameParameters(**kwargs)
                ),
            ...
            StructuredTool(
                ...
                func=lambda dealname: self.search_deals_by_name(
                    SearchDealByNameParameters(dealname=dealname)
                ),
            ...
            StructuredTool(
                ...
                func=lambda name: self.search_companies_by_name(
                    SearchCompanyByNameParameters(name=name)
                ),
            ...
            StructuredTool(
                ...
                func=lambda subject: self.search_tasks_by_subject(
                    SearchTaskBySubjectParameters(subject=subject)
                ),
            ...
            StructuredTool(
                ...
                func=lambda owner_id: self.search_tasks_by_owner(
                    SearchTaskByOwnerParameters(owner_id=owner_id)
                ),
            ...
            StructuredTool(
                ...
                func=lambda task_id: self.delete_task(
                    DeleteTaskParameters(task_id=task_id)
                ),
