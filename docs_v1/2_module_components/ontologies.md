...
<http://ontology.naas.ai/abi/linkedin.ttl> rdf:type owl:Ontology ;
                                        ...
                                        dc11:contributor "Emma Petit" , "Grace Lambert" , "Alice Dupont" ;
...
abi:linkedin_url a owl:DatatypeProperty ;
    ...
    skos:example "The URL of John Doe's LinkedIn profile page is 'https://demo.example/profiles/demo"@en .
...
abi:linkedin_public_url a owl:DatatypeProperty ;
    ...
    skos:example "The public URL of John Doe's LinkedIn profile page is 'https://demo.example/profiles/demo"@en .
```
