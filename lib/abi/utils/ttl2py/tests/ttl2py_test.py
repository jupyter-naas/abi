...
def test_cco_to_py():
    ...
    response = requests.get("https://raw.githubusercontent.com/CommonCoreOntology/CommonCoreOntologies/refs/heads/develop/src/cco-merged/CommonCoreOntologiesMerged.ttl")
...
def test_bfo_to_py():
    ...
    response = requests.get("https://raw.githubusercontent.com/BFO-ontology/BFO-2020/refs/heads/master/src/owl/bfo-core.ttl")
