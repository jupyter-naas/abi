...
class Model:
    ...
    created_at: Annotated[Optional[datetime], Field(description="The date and time the model was created")]
    canonical_slug: Annotated[Optional[str], Field(description="Canonical slug for the model")]
    hugging_face_id: Annotated[Optional[str], Field(description="Hugging Face model identifier, if applicable")]
    pricing: Annotated[Optional[dict], Field(description="Pricing information for the model")]
    architecture: Annotated[Optional[dict], Field(description="Model architecture information")]
    top_provider: Annotated[Optional[dict], Field(description="Information about the top provider for this model")]
    per_request_limits: Annotated[Optional[dict], Field(description="Per-request token limits")]
    supported_parameters: Annotated[Optional[list], Field(description="List of supported parameters for this model")]
    default_parameters: Annotated[Optional[dict], Field(description="Default parameters for this model")]
...
class ChatModel(Model):
    model: BaseChatModel
    context_window: Annotated[Optional[int], Field(description="Maximum context length in tokens")]
