...
class TripleStoreFactory:
    ...
    @staticmethod 
    def TripleStoreServiceNaas(naas_api_key: str, workspace_id: str, storage_name: str, base_prefix: str = "ontologies") -> TripleStoreService:
        ...
        return TripleStoreService(TripleStoreService__SecondaryAdaptor__NaasStorage(object_service))


    @staticmethod
    def TripleStoreServiceFilesystem(path: str) -> TripleStoreService:
        return TripleStoreService(TripleStoreService__SecondaryAdaptor__Filesystem(path))   