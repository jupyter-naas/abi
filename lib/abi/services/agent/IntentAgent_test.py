...
def agent():
    ...
    subagent_chatgpt = Agent(name="ChatGPT", description="ChatGPT agent", chat_model=model, tools=[], agents=[], configuration=AgentConfiguration())
    subagent_perplexity = Agent(name="Perplexity", description="Perplexity agent", chat_model=model, tools=[], agents=[], configuration=AgentConfiguration())
    ...
    intents = [
        ...
        Intent(intent_value="Search news about", intent_type=IntentType.AGENT, intent_target="ChatGPT"),
        Intent(intent_value="Search news about", intent_type=IntentType.AGENT, intent_target="Perplexity"),
    ]
...
def test_intent_agent(agent):    
    ...
    assert "I can't give you the personal phone number of John Doe".lower() in result.lower(), result
