...
class ObjectStorageFactory:
    ...
    def ObjectStorageServiceFS__find_storage(needle : str = 'storage') -> ObjectStorageService:
        ...
        return ObjectStorageService(ObjectStorageSecondaryAdapterFS(find_storage_folder(os.getcwd())))
    ...
    @staticmethod
    def ObjectStorageServiceS3(access_key_id: str, secret_access_key: str, bucket_name: str, base_prefix: str, session_token: str = None) -> ObjectStorageService:
