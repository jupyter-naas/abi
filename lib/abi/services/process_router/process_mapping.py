...
# Global process mapper instance (lazy initialization)
_process_mapper_instance = None

def get_process_mapper():
    """Get the global process mapper instance (lazy initialization)"""
    global _process_mapper_instance
    if _process_mapper_instance is None:
        _process_mapper_instance = ProcessMapper()
    return _process_mapper_instance