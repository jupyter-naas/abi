...
import { ApprovalFunnel } from '@/components/dashboard/procurement/ApprovalFunnel';
import { PurchasePipeline } from '@/components/dashboard/procurement/PurchasePipeline';
