...
Usage:
    uv run python libs/naas-abi-marketplace/naas_abi_marketplace/domains/signals/pipelines/ontology_engineer/workflows/EntityResolutionWorkflow.py
"""
...
if __name__ == "__main__":
    ...
    tbox_paths = [
        "libs/naas-abi-marketplace/naas_abi_marketplace/domains/signals/pipelines/ontology_engineer/ontologies/BFO7BucketsProcessOntology.ttl",
