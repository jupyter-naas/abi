...
| ✅ | `PersonnelProfilingProcess.ttl` | Registering a person from a profile document (orchestrates working, studying, certification, profile pipelines) | `personnel-profiling.ttl` |
