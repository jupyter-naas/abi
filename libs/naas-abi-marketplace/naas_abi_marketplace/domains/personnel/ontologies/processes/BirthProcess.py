...
class Birth(RDFEntity):
    """
    Deliberately does NOT concretize a birth record.
    """
    ...
    is_registered_by: (
        Annotated[
            list[BirthProcess | URIRef | str],
            Field(
                description="Relates a natural birth to the ledger birth processes that record it."
            ),
        ]
        | None
    ) = None
...
class BirthDeclarationAct(RDFEntity):
    """
    WHY: realizes the speaker role borne by the declarant. HOW WE KNOW: concretizes (and has as output) the asserted information content.
    """
    ...
    # Object properties
    concretizes: Annotated[URIRef | str, Field()] | None = None
    hasParticipant: Annotated[list[Person | URIRef | str], Field()] | None = None
    is_information_source_of: (
        Annotated[
            list[BirthProcess | URIRef | str],
            Field(
                description="Relates a birth declaration act to the birth processes that record its asserted content."
            ),
        ]
        | None
    ) = None
    ...
    occursIn: Annotated[list[Site | URIRef | str], Field()] | None = None
    ont00001829: Annotated[URIRef | str, Field()] | None = None
    ont00001833: Annotated[list[Person | URIRef | str], Field()] | None = None
    realizes: Annotated[list[Role | URIRef | str], Field()] | None = None


class BirthProcess(RDFEntity):
    """
    Process slice for birth. Reuses shared personnel classes.
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/personnel/BirthProcess"
    _name: ClassVar[str] = "Birth Process"
    _property_uris: ClassVar[dict] = {
        "concretizes": "http://ontology.naas.ai/abi/concretizes",
        "created": "http://purl.org/dc/terms/created",
        "creator": "http://purl.org/dc/terms/creator",
    ...
    has_declarant: (
        Annotated[
            ...
            Field(
                description="Relates a birth process in the ledger to the person who made the declaration it records. Entailed by has information source ∘ has agent; assert hasInformationSource instead of this."
            ),
        ]
        | None
    ) = None
    has_information_source: (
        Annotated[
            list[BirthDeclarationAct | URIRef | str],
            Field(
                description="Relates a birth process in the ledger to the declaration act whose asserted content it records."
            ),
        ]
        | None
    ) = None
    ...
    registers_birth: (
        Annotated[
            list[Birth | URIRef | str],
            Field(
                description="Relates a birth process in the ledger to the single mind-independent birth it records."
            ),
        ]
        | None
    ) = None
    updates_prior_registration: (
        Annotated[
            list[BirthProcess | URIRef | str],
            Field(
                description="Relates a birth process that adds complementary information to an earlier ledger entry for the same natural birth."
            ),
        ]
        | None
    ) = None
