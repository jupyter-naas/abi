...
class FinancialControlsWorkflow(Workflow):
    ...
    def __init__(self, config: Optional[FinancialControlsWorkflowConfiguration] = None):
        ...
        logger.warning(
            "🚧 FinancialControlsWorkflow is not functional yet - template only"
        )

    async def execute(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        """
        Execute financialcontrols workflow
        ...
        """
        logger.warning("🚧 FinancialControlsWorkflow.execute() not implemented yet")
