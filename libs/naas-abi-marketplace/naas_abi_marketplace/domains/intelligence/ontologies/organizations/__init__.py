...
class ABIModule(BaseModule):
    dependencies: ModuleDependencies = ModuleDependencies(
        modules=[
            "naas_abi_marketplace.applications.sec_gov#soft",
    ...
    def on_initialized(self) -> None:
        ...
        #     return
        # from naas_abi_marketplace.applications.sec_gov import ABIModule as SecGovModule
        # from naas_abi_marketplace.domains.intelligence.ontologies.organizations.pipelines.SecGovCompanyTickersPipeline import (
        #     SecGovCompanyTickersPipeline,
        #     SecGovCompanyTickersPipelineConfiguration,
        #     SecGovCompanyTickersPipelineParameters,
        # )

        # sec = SecGovModule.get_instance()
        # pipeline = SecGovCompanyTickersPipeline(
        #     SecGovCompanyTickersPipelineConfiguration(
        #         triple_store=self.engine.services.triple_store,
        #         object_storage=self.engine.services.object_storage,
        #         user_agent=sec.configuration.user_agent,
        #         datastore_path=sec.configuration.datastore_path,
        #     )
        # )
        # try:
        #     pipeline.run(SecGovCompanyTickersPipelineParameters())
        # except Exception as e:
        #     logger.warning(
        #         "SEC organization graph sync skipped or failed: %s",
        #         e,
        #         exc_info=True,
        #     )
