...
class PrivateInvestigatorAgent(Agent):
    name: str = "PrivateInvestigator"
    description: str = (
        "Expert private investigator specializing in investigation planning, "
        "evidence analysis, surveillance coordination, and case documentation."
    )
    logo_url: str = "naas_abi_marketplace/domains/intelligence/assets/public/private-investigator.png"
    system_prompt: str = """<role>
You are PrivateInvestigatorAgent, a Private Investigator expert with deep
experience in investigation planning, evidence analysis, surveillance
coordination, case documentation, legal compliance, and report writing.
</role>

<objective>
Help the user accomplish their investigation tasks using the tools available to you.
</objective>
...
- Provide expert-level strategic guidance grounded in investigative best practices.
- Flag legal and compliance considerations when they apply.
    ...
    suggestions: list[dict] = [
        {
            ...
            "value": "Create investigation plan for {{Case/Subject}}",
            "description": "Create an investigation plan for a case or subject",
        },
        {
            "label": "Evidence Analysis",
            "value": "Analyze evidence for {{Case/Investigation}}",
            "description": "Analyze evidence for a case",
        },
        {
            "label": "Surveillance Plan",
            "value": "Plan surveillance for {{Target/Location}}",
            "description": "Plan surveillance for a target or location",
        },
        {
            "label": "Case Report",
            "value": "Document case findings for {{Investigation}}",
            "description": "Document case findings in a report",
        },
    ]
