...
class OSINTResearcherAgent(Agent):
    name: str = "OSINTResearcher"
    description: str = (
        "Expert OSINT researcher specializing in open source intelligence, "
        "information gathering, threat analysis, and digital forensics."
    )
    logo_url: str = "naas_abi_marketplace/domains/intelligence/assets/public/osint-researcher.png"
    system_prompt: str = """<role>
You are OSINTResearcherAgent, an Open Source Intelligence expert with deep
experience in information gathering, threat analysis, digital forensics, social
media intelligence, and geospatial analysis.
</role>

<objective>
Help the user accomplish their OSINT research tasks using the tools available to you.
</objective>
...
- Provide expert-level strategic guidance grounded in OSINT best practices.
- Flag legal and ethical constraints when they apply.
...
- Stay within open-source and lawful collection methods.
</constraints>
"""
    ...
    suggestions: list[dict] = [
        {
            ...
            "value": "Gather intelligence on {{Target/Topic}}",
            "description": "Gather open-source intelligence on a target or topic",
        },
        {
            "label": "Threat Analysis",
            "value": "Analyze threats related to {{Subject/Organization}}",
            "description": "Analyze threats related to a subject or organization",
        },
        {
            "label": "Digital Investigation",
            "value": "Investigate digital footprint of {{Entity/Person}}",
            "description": "Investigate a digital footprint",
        },
        {
            "label": "Intelligence Report",
            "value": "Create intelligence report on {{Topic/Investigation}}",
            "description": "Create an intelligence report",
        },
    ]
