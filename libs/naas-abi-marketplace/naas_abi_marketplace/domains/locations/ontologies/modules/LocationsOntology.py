# onto2py-source-sha256: 0fa975f6e9ddcd14c988709f33118fc1d6a9816cdf73f88eac19d61dbb287f7c
...
class Country(RDFEntity):
    """
    A country is a distinct region with recognized boundaries and political governance, making it a suitable subclass of cco:GeospatialRegion.
    """
    ...
    country_code: Optional[
        Annotated[
            str,
            Field(description="The ISO 3166-1 alpha-2 code for the country."),
        ]
    ] = None
...
class State(RDFEntity):
    """
    A State is the top-level administrative division below a Country (GeoNames admin1 / pgeocode state_name), making it a suitable subclass of cco:GeospatialRegion.
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/State"
    _name: ClassVar[str] = "State"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "state_code": "http://ontology.naas.ai/abi/state_code",
    }
    _object_properties: ClassVar[set[str]] = set()
    ...
    state_code: Optional[
        Annotated[
            str,
            Field(
                description="The GeoNames admin1 code identifying the State within its Country."
            ),
        ]
    ] = None
    label: Optional[Annotated[str, Field(description="Label of the resource.")]] = None
...
class Region(RDFEntity):
    """
    A Region is a finer-grained administrative division than a State (GeoNames admin2 / pgeocode county_name), making it a suitable subclass of cco:GeospatialRegion.
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/Region"
    _name: ClassVar[str] = "Region"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "region_code": "http://ontology.naas.ai/abi/region_code",
    }
    _object_properties: ClassVar[set[str]] = set()
    ...
    region_code: Optional[
        Annotated[
            str,
            Field(
                description="The GeoNames admin2 code identifying the Region within its State."
            ),
        ]
    ] = None
    label: Optional[Annotated[str, Field(description="Label of the resource.")]] = None
...
class City(RDFEntity):
    """
    A City is a Populated Place (town, village, or municipality), making it a suitable subclass of cco:Populated place.
    """
...
class Address(RDFEntity):
    """
    An Address is a structured string of characters used to identify the location of an entity, typically including elements such as street name, number, city, region, and postal code.
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/Address"
    _name: ClassVar[str] = "Address"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
...
class PostalCode(RDFEntity):
    """
    A Postal Code generalizes country-specific postal identifiers, such as the US ZIP Code, into a single worldwide concept.
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/PostalCode"
    _name: ClassVar[str] = "Postal Code"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
...
class ZIPCode(PostalCode, RDFEntity):
    """
    A ZIP Code is the US-specific specialization of abi:PostalCode, used for mail sorting and delivery purposes.
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/ZIPCode"
    _name: ClassVar[str] = "ZIP Code"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
