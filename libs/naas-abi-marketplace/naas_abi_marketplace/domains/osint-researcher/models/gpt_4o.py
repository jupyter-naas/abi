...
gpt-4o model configuration for Osint Researcher domain expert
"""
...
def create_model():
    """Create gpt-4o model for Osint Researcher - NOT FUNCTIONAL YET"""
    ...
    # Model configuration optimized for osint researcher domain
    model = ChatOpenAI(
        model="gpt-4o",
        api_key=api_key,
