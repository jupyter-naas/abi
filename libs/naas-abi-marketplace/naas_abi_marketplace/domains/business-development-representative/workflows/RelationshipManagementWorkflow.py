...
class RelationshipManagementWorkflow(Workflow):
    ...
    def __init__(
        self, config: Optional[RelationshipManagementWorkflowConfiguration] = None
    ):
        ...
        logger.warning(
            "🚧 RelationshipManagementWorkflow is not functional yet - template only"
        )
    ...
    async def execute(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        logger.warning(
            "🚧 RelationshipManagementWorkflow.execute() not implemented yet"
        )
