...
class PartnershipDevelopmentWorkflow(Workflow):
    ...
    def __init__(
        self, config: Optional[PartnershipDevelopmentWorkflowConfiguration] = None
    ):
        ...
        logger.warning(
            "🚧 PartnershipDevelopmentWorkflow is not functional yet - template only"
        )
    ...
    async def execute(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        logger.warning(
            "🚧 PartnershipDevelopmentWorkflow.execute() not implemented yet"
        )
