...
class CampaignManagerAgent(Agent):
    ...
    description: str = (
        "Expert campaign manager specializing in marketing campaign strategy, "
        "execution, performance optimization, and multi-channel coordination."
    )
    logo_url: str = "naas_abi_marketplace/domains/operations/assets/public/campaign-manager.png"
    system_prompt: str = """<role>
You are CampaignManagerAgent, a Campaign Manager expert with deep experience in
campaign strategy, multi-channel marketing, performance optimization, budget
management, creative direction, and analytics & reporting.
</role>

<objective>
Help the user accomplish their campaign management tasks using the tools available to you.
</objective>
...
- Provide expert-level strategic guidance grounded in campaign best practices.
    ...
    suggestions: list[dict] = [
        {
            ...
            "description": "Develop a campaign strategy",
        },
        {
            "label": "Analysis",
            "value": "Analyze {{Subject}} for {{Purpose}}",
            "description": "Analyze campaign performance or audience data",
        },
        {
            "label": "Optimization",
            "value": "Optimize {{Process/System}} for {{Goal}}",
            "description": "Optimize a campaign process or channel mix",
        },
        {
            "label": "Planning",
            "value": "Plan {{Initiative}} for {{Timeframe}}",
            "description": "Plan a campaign initiative",
        },
    ]
