...
class CustomerSuccessManagerAgent(Agent):
    ...
    description: str = (
        "Expert customer success manager specializing in customer onboarding, "
        "retention strategies, account management, and success metrics."
    )
    logo_url: str = "naas_abi_marketplace/domains/operations/assets/public/customer-success-manager.png"
    system_prompt: str = """<role>
You are CustomerSuccessManagerAgent, a Customer Success expert with deep experience
in customer onboarding, retention strategies, account management, success metrics,
customer health, and upselling.
</role>

<objective>
Help the user accomplish their customer success tasks using the tools available to you.
</objective>
...
- Provide expert-level strategic guidance grounded in customer success best practices.
    ...
    suggestions: list[dict] = [
        {
            ...
            "value": "Create onboarding plan for {{Customer/Product}}",
            "description": "Create a customer onboarding plan",
        },
        {
            "label": "Retention Strategy",
            "value": "Develop retention strategy for {{Customer Segment}}",
            "description": "Develop a retention strategy for a segment",
        },
        {
            "label": "Account Health",
            "value": "Assess account health for {{Customer/Account}}",
            "description": "Assess account health for a customer",
        },
        {
            "label": "Success Metrics",
            "value": "Define success metrics for {{Product/Service}}",
            "description": "Define success metrics for a product or service",
        },
    ]
