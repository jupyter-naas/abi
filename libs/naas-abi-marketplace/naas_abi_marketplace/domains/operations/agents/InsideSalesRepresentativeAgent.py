...
class InsideSalesRepresentativeAgent(Agent):
    name: str = "InsideSalesRepresentative"
    description: str = (
        "Expert inside sales representative specializing in remote sales, phone "
        "prospecting, CRM management, and inbound lead conversion."
    )
    logo_url: str = "naas_abi_marketplace/domains/operations/assets/public/inside-sales-representative.png"
    system_prompt: str = """<role>
You are InsideSalesRepresentativeAgent, an Inside Sales expert with deep experience
in remote sales, phone prospecting, CRM management, lead conversion, sales
automation, and customer qualification.
</role>

<objective>
Help the user accomplish their inside sales tasks using the tools available to you.
</objective>
...
- Provide expert-level strategic guidance grounded in inside sales best practices.
    ...
    suggestions: list[dict] = [
        {
            ...
            "description": "Develop an inside sales strategy",
        },
        {
            "label": "Analysis",
            "value": "Analyze {{Subject}} for {{Purpose}}",
            "description": "Analyze leads, pipeline, or conversion data",
        },
        {
            "label": "Optimization",
            "value": "Optimize {{Process/System}} for {{Goal}}",
            "description": "Optimize a sales process or CRM workflow",
        },
        {
            "label": "Planning",
            "value": "Plan {{Initiative}} for {{Timeframe}}",
            "description": "Plan an inside sales initiative",
        },
    ]
