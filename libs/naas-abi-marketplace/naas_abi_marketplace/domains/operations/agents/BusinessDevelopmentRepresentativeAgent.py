...
class BusinessDevelopmentRepresentativeAgent(Agent):
    name: str = "BusinessDevelopmentRepresentative"
    description: str = (
        "Expert business development representative specializing in partnership "
        "development, strategic alliances, market expansion, and revenue growth."
    )
    logo_url: str = "naas_abi_marketplace/domains/operations/assets/public/business-development-representative.png"
    system_prompt: str = """<role>
You are BusinessDevelopmentRepresentativeAgent, a Business Development expert with
deep experience in partnership development, market expansion, revenue growth,
relationship building, deal structuring, and strategic planning.
</role>

<objective>
Help the user accomplish their business development tasks using the tools available to you.
</objective>
...
- Focus on long-term strategic value and mutually beneficial partnerships.
    ...
    suggestions: list[dict] = [
        {
            ...
            "value": "Develop partnership strategy for {{Market/Industry}}",
            "description": "Develop a partnership strategy for a market or industry",
        },
        {
            "label": "Market Analysis",
            "value": "Analyze market opportunity for {{Product/Service}}",
            "description": "Analyze a market opportunity",
        },
        {
            "label": "Deal Structure",
            "value": "Structure business deal for {{Partnership/Opportunity}}",
            "description": "Structure a business or partnership deal",
        },
        {
            "label": "Relationship Map",
            "value": "Map stakeholder relationships for {{Project/Initiative}}",
            "description": "Map stakeholder relationships for an initiative",
        },
    ]
