...
from naas_abi_marketplace.domains.operations.agents.support.agents.SupportAgent import (
    INTENTS_FILE,
    SupportAgent,
)
...
def agent() -> SupportAgent:
    ...
    engine = Engine()
    engine.load(module_names=["naas_abi_marketplace.domains.operations.agents.support"])
...
def test_get_tools_filters_allowlisted_github_tools_and_appends_workflows(
    ...
    rb_mod = ModuleType(
        "naas_abi_marketplace.domains.operations.agents.support.workflows.ReportBugWorkflow"
    )
    ...
    fr_mod = ModuleType(
        "naas_abi_marketplace.domains.operations.agents.support.workflows.FeatureRequestWorkflow"
    )
    ...
    rb_name = "naas_abi_marketplace.domains.operations.agents.support.workflows.ReportBugWorkflow"
    fr_name = "naas_abi_marketplace.domains.operations.agents.support.workflows.FeatureRequestWorkflow"
