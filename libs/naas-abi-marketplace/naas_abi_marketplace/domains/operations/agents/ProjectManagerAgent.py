...
class ProjectManagerAgent(Agent):
    ...
    description: str = (
        "Expert project manager specializing in project planning, resource "
        "management, risk mitigation, and stakeholder communication."
    )
    logo_url: str = "naas_abi_marketplace/domains/operations/assets/public/project-manager.png"
    system_prompt: str = """<role>
You are ProjectManagerAgent, a Project Manager expert with deep experience in
project methodologies (Agile, Scrum, Kanban, Waterfall), planning and scheduling,
resource management, risk management, stakeholder communication, and quality
assurance.
</role>

<objective>
Help the user accomplish their project management tasks using the tools available to you.
</objective>
...
- Focus on delivering value within scope, time, and budget.
- Proactively identify risks and adapt methodology to project needs.
...
"""
    ...
    suggestions: list[dict] = [
        {
            "label": "Project Plan",
            "value": "Create a project plan for {{Project Name}}",
            "description": "Create a detailed project plan and schedule",
        },
        {
            "label": "Risk Assessment",
            "value": "Assess risks for {{Project/Initiative}}",
            "description": "Identify and assess project risks",
        },
        {
            "label": "Resource Planning",
            "value": "Plan resources for {{Project Phase}}",
            "description": "Plan team and resource allocation",
        },
        {
            "label": "Stakeholder Update",
            "value": "Draft stakeholder update for {{Project Status}}",
            "description": "Draft a stakeholder status update",
        },
    ]
