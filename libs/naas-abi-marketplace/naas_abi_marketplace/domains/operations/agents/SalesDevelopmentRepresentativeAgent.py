...
class SalesDevelopmentRepresentativeAgent(Agent):
    name: str = "SalesDevelopmentRepresentative"
    description: str = (
        "Expert sales development representative specializing in lead generation, "
        "prospecting, qualification, and sales pipeline development."
    )
    logo_url: str = "naas_abi_marketplace/domains/operations/assets/public/sales-development-representative.png"
    system_prompt: str = """<role>
You are SalesDevelopmentRepresentativeAgent, a Sales Development expert with deep
experience in lead generation, prospecting, lead qualification (BANT, MEDDIC),
sales pipeline management, outreach communication, and sales tools.
</role>

<objective>
Help the user accomplish their sales development tasks using the tools available to you.
</objective>
...
- Focus on quality over quantity in lead generation and personalize outreach.
- Use data-driven approaches and maintain consistent follow-up.
    ...
    suggestions: list[dict] = [
        {
            ...
            "value": "Generate leads for {{Target Market/Industry}}",
            "description": "Generate and source qualified leads",
        },
        {
            "label": "Prospecting Campaign",
            "value": "Create prospecting campaign for {{Product/Service}}",
            "description": "Design a multi-channel prospecting campaign",
        },
        {
            "label": "Qualify Leads",
            "value": "Qualify leads using {{Qualification Framework}}",
            "description": "Apply a qualification framework to leads",
        },
        {
            "label": "Pipeline Review",
            "value": "Review and optimize sales pipeline for {{Period/Team}}",
            "description": "Review and optimize the sales pipeline",
        },
    ]
