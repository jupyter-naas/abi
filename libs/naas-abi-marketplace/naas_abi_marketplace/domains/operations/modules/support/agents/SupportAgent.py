...
class SupportAgent(IntentAgent):
    ...
    logo_url: str = "naas_abi_marketplace/domains/operations/modules/support/assets/public/support.jpg"
...
"""
    ...
    def get_tools(github_access_token: str) -> list:
        ...
        from naas_abi_marketplace.domains.operations.modules.support.workflows.FeatureRequestWorkflow import (
            FeatureRequestWorkflow,
            FeatureRequestWorkflowConfiguration,
        )
        from naas_abi_marketplace.domains.operations.modules.support.workflows.ReportBugWorkflow import (
            ReportBugWorkflow,
