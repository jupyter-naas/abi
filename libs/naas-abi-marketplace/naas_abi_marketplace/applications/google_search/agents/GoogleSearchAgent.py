...
class GoogleSearchAgent(IntentAgent):
    ...
    description: str = "Search the web using Google Programmable Search Engine."
    avatar_url: str = "https://s3-alpha.figma.com/hub/file/4765445806/10c157d8-1da5-42fd-8143-4dd6df2656ab-cover.png"
