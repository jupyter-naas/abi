...
class GitHubIntegration(Integration):
    ...
    def update_organization_repository(
        ...
        return self._make_request(
            "PATCH", f"/repos/{org}/{repo_name}", headers={"Accept": accept}, data=data
        )
    ...
    def delete_repository(
        ...
        self._make_request("DELETE", f"/repos/{repo_name}", headers={"Accept": accept})
    ...
    def create_or_update_repository_secret(
        ...
        public_key: str = (
            public_key_response.get("key", "")
            if isinstance(public_key_response, dict)
            else ""
        )
        key_id: str = (
            public_key_response.get("key_id", "")
            if isinstance(public_key_response, dict)
            else ""
        )
    ...
    def list_repository_contributors(
        ...
        params = {"per_page": per_page, "page": page}
        response = self._make_request(
            "GET", f"/repos/{repo_name}/contributors", params=params
        )
...
def as_tools(configuration: GitHubIntegrationConfiguration):
    ...
    return [
        ...
        StructuredTool(
            ...
            func=lambda org: integration.list_organization_repositories(
                org, return_list=True
            ),
        ...
        StructuredTool(
            ...
            func=lambda org, repo_name: integration.delete_repository(org, repo_name),
        ...
        StructuredTool(
            ...
            func=lambda repo_name: integration.list_repository_contributors(
                repo_name, return_login=True
            ),
