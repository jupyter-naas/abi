...
from naas_abi_marketplace.applications.x.apps.x_proxy.cache import projection
...
def test_a_projection_from_an_older_schema_is_not_attached(monkeypatch):
    ...
    import naas_abi_marketplace.applications.x.apps.x_proxy.cache.schema as schema_module
