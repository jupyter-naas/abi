...
DEFAULT_APP_PREFIX = "x/apps/x_proxy"
...
class SnapshotContext:
    ...
    def save_json(self, relative_dir: str, filename: str, data: dict | list) -> str:
        """Write JSON under ``x/apps/x_proxy/<relative_dir>/<filename>``."""
    ...
    def save_bytes(self, relative_dir: str, filename: str, payload: bytes) -> str:
        """Write raw bytes under ``x/apps/x_proxy/<relative_dir>/<filename>``."""
        prefix = f"{self.app_prefix}/{relative_dir}".rstrip("/")
    ...
    def save_json_compact(
        ...
        """Write minified JSON under ``x/apps/x_proxy/<relative_dir>/<filename>``.
