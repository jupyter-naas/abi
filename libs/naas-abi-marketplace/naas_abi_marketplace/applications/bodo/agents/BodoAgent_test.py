...
def agent():
    ...
    from naas_abi_marketplace.applications.bodo.agents.BodoAgent import (
        BodoAgent,
    )

    engine = Engine()
    engine.load(module_names=["naas_abi_marketplace.applications.bodo"])

    return BodoAgent.New()
