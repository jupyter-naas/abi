...
NAME = "Gemma"
DESCRIPTION = (
    "Local Gemma3 4B model via Ollama - lightweight, fast alternative to cloud Gemini"
)
...
def create_agent(
    ...
    intents = [
        ...
        Intent(
            ...
            intent_value="ask quick question",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="get fast response",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="use lightweight ai",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="use efficient ai",
            intent_target="call_model",
        ),
        # Privacy and local AI intents
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="start private chat",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="have local conversation",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="chat offline",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="get personal assistance",
            intent_target="call_model",
        ),
        # Alternative to Gemini intents
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="use local gemini",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="run offline gemini",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="access private gemini",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="try open source gemini",
            intent_target="call_model",
        ),
        # General Gemma intents
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="activate gemma",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="change to gemma",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="start gemma chat",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="get gemma help",
            intent_target="call_model",
        ),
        # Task-specific intents
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="get writing help",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="do quick editing",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="ask general question",
            intent_target="call_model",
        ),
        Intent(
            intent_type=IntentType.AGENT,
            intent_value="handle everyday task",
            intent_target="call_model",
        ),
    ]
