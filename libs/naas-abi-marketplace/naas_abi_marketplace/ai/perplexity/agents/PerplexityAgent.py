...
AVATAR_URL = (
    "https://naasai-public.s3.eu-west-3.amazonaws.com/abi/assets/perplexity.png"
)
SYSTEM_PROMPT = """# ROLE
...
def create_agent(
    ...
    intents: list = [
        Intent(
            intent_value="quick search about",
            intent_type=IntentType.TOOL,
            intent_target="perplexity_quick_search",
        ),
        Intent(
            intent_value="search news about",
            intent_type=IntentType.TOOL,
            intent_target="perplexity_search",
        ),
        Intent(
        ...
        Intent(
            intent_value="advanced search about",
            intent_type=IntentType.TOOL,
            intent_target="perplexity_advanced_search",
        ),
        Intent(
            intent_value="search web with high context size about",
            intent_type=IntentType.TOOL,
            intent_target="perplexity_advanced_search",
        ),
        Intent(
            intent_value="where can i find information about perplexity models",
            intent_type=IntentType.RAW,
            intent_target="Here is the link to the documentation: https://docs.perplexity.ai/getting-started/models",
        ),
    ]
