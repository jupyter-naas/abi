...
class CacheSet(LogProcess, RDFEntity):
    """
    CacheSet
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/cache/CacheSet"
    _name: ClassVar[str] = "CacheSet"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "data_type": "http://ontology.naas.ai/abi/cache/dataType",
        "key": "http://ontology.naas.ai/abi/cache/key",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "size_bytes": "http://ontology.naas.ai/abi/cache/sizeBytes",
        "tier": "http://ontology.naas.ai/abi/cache/tier",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class CacheDeleted(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/cache/CacheDeleted"
    _name: ClassVar[str] = "CacheDeleted"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class CacheError(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/cache/CacheError"
    _name: ClassVar[str] = "CacheError"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "key": "http://ontology.naas.ai/abi/cache/key",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "message": "http://ontology.naas.ai/abi/cache/message",
        "operation": "http://ontology.naas.ai/abi/cache/operation",
        "tier": "http://ontology.naas.ai/abi/cache/tier",
    }
    _object_properties: ClassVar[set[str]] = set()
...
CacheSet.model_rebuild()
CacheDeleted.model_rebuild()
CacheError.model_rebuild()
