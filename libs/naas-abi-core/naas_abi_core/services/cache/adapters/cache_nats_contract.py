"""Wire-level NATS contract shared by cache's primary and secondary
...
``adapters/primary/cache__primary_adapter__NATS.py`` and
``adapters/secondary/CacheSecondaryAdapterNATSClient.py`` import from here
instead.

See ``naas_abi_core/proto/cache/v1/cache.proto`` for the full wire contract
this pairs with.
"""

SERVICE_NAME = "cache"
SERVICE_VERSION = "1.0.0"
SUBJECT_PREFIX = "abi.svc.cache.v1"
