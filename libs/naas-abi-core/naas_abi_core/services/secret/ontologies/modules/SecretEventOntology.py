...
class SecretSet(LogProcess, RDFEntity):
    """
    SecretSet
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/secret/SecretSet"
    _name: ClassVar[str] = "SecretSet"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "key": "http://ontology.naas.ai/abi/secret/key",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
    }
    _object_properties: ClassVar[set[str]] = set()

    # Data properties
    key: Annotated[str, Field(description="Secret key the operation targeted.")] | None = None
...
class SecretRemoved(LogProcess, RDFEntity):
    """
    SecretRemoved
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/secret/SecretRemoved"
    _name: ClassVar[str] = "SecretRemoved"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class SecretError(LogProcess, RDFEntity):
    """
    SecretError
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/secret/SecretError"
    _name: ClassVar[str] = "SecretError"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "key": "http://ontology.naas.ai/abi/secret/key",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "message": "http://ontology.naas.ai/abi/secret/message",
        "operation": "http://ontology.naas.ai/abi/secret/operation",
    }
    _object_properties: ClassVar[set[str]] = set()

    # Data properties
    key: Annotated[str, Field(description="Secret key the operation targeted.")] | None = None
    operation: Annotated[str, Field(description="Name of the secret operation that failed (e.g. 'set', 'remove').")] | None = None
...
SecretSet.model_rebuild()
SecretRemoved.model_rebuild()
SecretError.model_rebuild()
