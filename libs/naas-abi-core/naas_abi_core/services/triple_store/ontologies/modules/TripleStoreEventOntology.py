...
class TriplesInserted(LogProcess, RDFEntity):
    """
    TriplesInserted
    """

    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/triple_store/TriplesInserted"
    )
    _name: ClassVar[str] = "TriplesInserted"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "graph_name": "http://ontology.naas.ai/abi/triple_store/graphName",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "triple_count": "http://ontology.naas.ai/abi/triple_store/tripleCount",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class TriplesRemoved(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/triple_store/TriplesRemoved"
    )
    _name: ClassVar[str] = "TriplesRemoved"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class GraphCreated(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/triple_store/GraphCreated"
    _name: ClassVar[str] = "GraphCreated"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class GraphCleared(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/triple_store/GraphCleared"
    _name: ClassVar[str] = "GraphCleared"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class GraphDropped(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/triple_store/GraphDropped"
    _name: ClassVar[str] = "GraphDropped"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class SchemaLoaded(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/triple_store/SchemaLoaded"
    _name: ClassVar[str] = "SchemaLoaded"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "filepath": "http://ontology.naas.ai/abi/triple_store/filepath",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class SchemaRemoved(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/triple_store/SchemaRemoved"
    _name: ClassVar[str] = "SchemaRemoved"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class TripleStoreError(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/triple_store/TripleStoreError"
    )
    _name: ClassVar[str] = "TripleStoreError"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        ...
        "graph_name": "http://ontology.naas.ai/abi/triple_store/graphName",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "message": "http://ontology.naas.ai/abi/triple_store/message",
        "operation": "http://ontology.naas.ai/abi/triple_store/operation",
    }
    _object_properties: ClassVar[set[str]] = set()
...
TriplesInserted.model_rebuild()
TriplesRemoved.model_rebuild()
GraphCreated.model_rebuild()
GraphCleared.model_rebuild()
GraphDropped.model_rebuild()
SchemaLoaded.model_rebuild()
SchemaRemoved.model_rebuild()
TripleStoreError.model_rebuild()
