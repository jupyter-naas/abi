"""Wire-level NATS contract shared by triple_store's primary and secondary
...
``adapters/primary/triple_store__primary_adapter__NATS.py`` and
``adapters/secondary/TripleStoreSecondaryAdapterNATSClient.py`` import from
here instead.

See ``naas_abi_core/proto/triple_store/v1/triple_store.proto`` for the full
wire contract this pairs with.
"""

SERVICE_NAME = "triple_store"
SERVICE_VERSION = "1.0.0"
SUBJECT_PREFIX = "abi.svc.triple_store.v1"
