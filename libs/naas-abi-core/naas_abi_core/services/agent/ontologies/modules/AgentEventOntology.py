...
class AgentModelCalled(LogProcess, RDFEntity):
    """
    AgentModelCalled
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/agent/AgentModelCalled"
    _name: ClassVar[str] = "AgentModelCalled"
    _property_uris: ClassVar[dict] = {
        "agent_name": "http://ontology.naas.ai/abi/agent/agentName",
        "chat_id": "http://ontology.naas.ai/abi/agent/chatId",
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "user_id": "http://ontology.naas.ai/abi/agent/userId",
        "workspace_id": "http://ontology.naas.ai/abi/agent/workspaceId",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class AgentAIMessageEmitted(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/agent/AgentAIMessageEmitted"
    )
    _name: ClassVar[str] = "AgentAIMessageEmitted"
    _property_uris: ClassVar[dict] = {
        "agent_name": "http://ontology.naas.ai/abi/agent/agentName",
        "chat_id": "http://ontology.naas.ai/abi/agent/chatId",
        "content": "http://ontology.naas.ai/abi/agent/content",
        "content_length": "http://ontology.naas.ai/abi/agent/contentLength",
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
...
class AgentToolCalled(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/agent/AgentToolCalled"
    _name: ClassVar[str] = "AgentToolCalled"
    _property_uris: ClassVar[dict] = {
        "agent_name": "http://ontology.naas.ai/abi/agent/agentName",
        "chat_id": "http://ontology.naas.ai/abi/agent/chatId",
        "created": "http://purl.org/dc/terms/created",
        ...
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "tool_args": "http://ontology.naas.ai/abi/agent/toolArgs",
        "tool_call_id": "http://ontology.naas.ai/abi/agent/toolCallId",
        "tool_name": "http://ontology.naas.ai/abi/agent/toolName",
        "user_id": "http://ontology.naas.ai/abi/agent/userId",
        "workspace_id": "http://ontology.naas.ai/abi/agent/workspaceId",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class AgentToolResponded(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/agent/AgentToolResponded"
    _name: ClassVar[str] = "AgentToolResponded"
    _property_uris: ClassVar[dict] = {
        "agent_name": "http://ontology.naas.ai/abi/agent/agentName",
        "chat_id": "http://ontology.naas.ai/abi/agent/chatId",
        "content": "http://ontology.naas.ai/abi/agent/content",
...
class AgentRouted(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/agent/AgentRouted"
    _name: ClassVar[str] = "AgentRouted"
    _property_uris: ClassVar[dict] = {
        "agent_name": "http://ontology.naas.ai/abi/agent/agentName",
        "chat_id": "http://ontology.naas.ai/abi/agent/chatId",
        "created": "http://purl.org/dc/terms/created",
        ...
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "routed_to": "http://ontology.naas.ai/abi/agent/routedTo",
        "user_id": "http://ontology.naas.ai/abi/agent/userId",
        "workspace_id": "http://ontology.naas.ai/abi/agent/workspaceId",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class AgentInvocationCompleted(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/agent/AgentInvocationCompleted"
    )
    _name: ClassVar[str] = "AgentInvocationCompleted"
    _property_uris: ClassVar[dict] = {
        "agent_name": "http://ontology.naas.ai/abi/agent/agentName",
        "chat_id": "http://ontology.naas.ai/abi/agent/chatId",
        "content": "http://ontology.naas.ai/abi/agent/content",
...
class AgentUserMessageReceived(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/agent/AgentUserMessageReceived"
    )
    _name: ClassVar[str] = "AgentUserMessageReceived"
    _property_uris: ClassVar[dict] = {
        "agent_name": "http://ontology.naas.ai/abi/agent/agentName",
        "chat_id": "http://ontology.naas.ai/abi/agent/chatId",
        "content": "http://ontology.naas.ai/abi/agent/content",
...
AgentModelCalled.model_rebuild()
AgentAIMessageEmitted.model_rebuild()
AgentToolCalled.model_rebuild()
AgentToolResponded.model_rebuild()
AgentRouted.model_rebuild()
AgentInvocationCompleted.model_rebuild()
AgentUserMessageReceived.model_rebuild()
