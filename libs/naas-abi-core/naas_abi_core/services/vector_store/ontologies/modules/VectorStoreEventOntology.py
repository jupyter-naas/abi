...
class CollectionEnsured(LogProcess, RDFEntity):
    """
    CollectionEnsured
    """

    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/vector_store/CollectionEnsured"
    )
    _name: ClassVar[str] = "CollectionEnsured"
    _property_uris: ClassVar[dict] = {
        "collection_name": "http://ontology.naas.ai/abi/vector_store/collectionName",
...
class DocumentsAdded(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/vector_store/DocumentsAdded"
    )
    _name: ClassVar[str] = "DocumentsAdded"
    _property_uris: ClassVar[dict] = {
        "collection_name": "http://ontology.naas.ai/abi/vector_store/collectionName",
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "document_count": "http://ontology.naas.ai/abi/vector_store/documentCount",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class DocumentUpdated(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/vector_store/DocumentUpdated"
    )
    _name: ClassVar[str] = "DocumentUpdated"
    _property_uris: ClassVar[dict] = {
        "collection_name": "http://ontology.naas.ai/abi/vector_store/collectionName",
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "document_id": "http://ontology.naas.ai/abi/vector_store/documentId",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class DocumentsDeleted(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/vector_store/DocumentsDeleted"
    )
    _name: ClassVar[str] = "DocumentsDeleted"
    _property_uris: ClassVar[dict] = {
        "collection_name": "http://ontology.naas.ai/abi/vector_store/collectionName",
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
...
class CollectionDeleted(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/vector_store/CollectionDeleted"
    )
    _name: ClassVar[str] = "CollectionDeleted"
    _property_uris: ClassVar[dict] = {
        "collection_name": "http://ontology.naas.ai/abi/vector_store/collectionName",
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
...
class VectorStoreError(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/vector_store/VectorStoreError"
    )
    _name: ClassVar[str] = "VectorStoreError"
    _property_uris: ClassVar[dict] = {
        "collection_name": "http://ontology.naas.ai/abi/vector_store/collectionName",
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "message": "http://ontology.naas.ai/abi/vector_store/message",
        "operation": "http://ontology.naas.ai/abi/vector_store/operation",
    }
    _object_properties: ClassVar[set[str]] = set()
...
CollectionEnsured.model_rebuild()
DocumentsAdded.model_rebuild()
DocumentUpdated.model_rebuild()
DocumentsDeleted.model_rebuild()
CollectionDeleted.model_rebuild()
VectorStoreError.model_rebuild()
