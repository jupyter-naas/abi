"""Wire-level NATS contract shared by vector_store's primary and secondary
...
``adapters/primary/vector_store__primary_adapter__NATS.py`` and
``adapters/secondary/VectorStoreSecondaryAdapterNATSClient.py`` import from
here instead.

See ``naas_abi_core/proto/vector_store/v1/vector_store.proto`` for the full
wire contract this pairs with.
"""

SERVICE_NAME = "vector_store"
SERVICE_VERSION = "1.0.0"
SUBJECT_PREFIX = "abi.svc.vector_store.v1"
