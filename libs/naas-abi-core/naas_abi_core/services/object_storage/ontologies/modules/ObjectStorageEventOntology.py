...
class ObjectPut(LogProcess, RDFEntity):
    """
    ObjectPut
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/object_storage/ObjectPut"
    _name: ClassVar[str] = "ObjectPut"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "key": "http://ontology.naas.ai/abi/object_storage/key",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "prefix": "http://ontology.naas.ai/abi/object_storage/prefix",
        "size_bytes": "http://ontology.naas.ai/abi/object_storage/sizeBytes",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class ObjectDeleted(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://ontology.naas.ai/abi/object_storage/ObjectDeleted"
    )
    _name: ClassVar[str] = "ObjectDeleted"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
ObjectPut.model_rebuild()
ObjectDeleted.model_rebuild()
