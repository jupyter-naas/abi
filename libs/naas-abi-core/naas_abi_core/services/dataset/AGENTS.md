...
protobuf endpoints. `adapters/secondary/DatasetSecondaryAdapterNATSClient.py` implements the outbound
port. Wire contracts live under `naas_abi_core/proto/dataset/v1/`.
