...
class BusMessagePublished(LogProcess, RDFEntity):
    """
    BusMessagePublished
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/bus/BusMessagePublished"
    _name: ClassVar[str] = "BusMessagePublished"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "routing_key": "http://ontology.naas.ai/abi/bus/routingKey",
        "size_bytes": "http://ontology.naas.ai/abi/bus/sizeBytes",
        "topic": "http://ontology.naas.ai/abi/bus/topic",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class BusMessageEnqueued(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/bus/BusMessageEnqueued"
    _name: ClassVar[str] = "BusMessageEnqueued"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class BusError(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/bus/BusError"
    _name: ClassVar[str] = "BusError"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "message": "http://ontology.naas.ai/abi/bus/message",
        "operation": "http://ontology.naas.ai/abi/bus/operation",
        "routing_key": "http://ontology.naas.ai/abi/bus/routingKey",
        "topic": "http://ontology.naas.ai/abi/bus/topic",
    }
    _object_properties: ClassVar[set[str]] = set()
...
BusMessagePublished.model_rebuild()
BusMessageEnqueued.model_rebuild()
BusError.model_rebuild()
