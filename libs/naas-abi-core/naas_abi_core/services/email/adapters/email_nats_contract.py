"""Wire-level NATS contract shared by email's primary and secondary
...
``adapters/primary/email__primary_adapter__NATS.py`` and
``adapters/secondary/EmailSecondaryAdapterNATSClient.py`` import from here
instead.

See ``naas_abi_core/proto/email/v1/email.proto`` for the full wire contract
this pairs with.
"""

SERVICE_NAME = "email"
SERVICE_VERSION = "1.0.0"
SUBJECT_PREFIX = "abi.svc.email.v1"
