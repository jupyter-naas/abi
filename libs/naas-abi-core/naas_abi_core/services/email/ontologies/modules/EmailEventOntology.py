...
class EmailSent(LogProcess, RDFEntity):
    """
    EmailSent
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/email/EmailSent"
    _name: ClassVar[str] = "EmailSent"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "sender": "http://ontology.naas.ai/abi/email/sender",
        "subject": "http://ontology.naas.ai/abi/email/subject",
        "to": "http://ontology.naas.ai/abi/email/to",
    }
    _object_properties: ClassVar[set[str]] = set()
...
class EmailError(LogProcess, RDFEntity):
    ...
    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/email/EmailError"
    _name: ClassVar[str] = "EmailError"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "message": "http://ontology.naas.ai/abi/email/message",
        "subject": "http://ontology.naas.ai/abi/email/subject",
        "to": "http://ontology.naas.ai/abi/email/to",
    }
    _object_properties: ClassVar[set[str]] = set()
...
EmailSent.model_rebuild()
EmailError.model_rebuild()
