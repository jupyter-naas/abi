...
class KeyValueSet(LogProcess, RDFEntity):
    """
    KeyValueSet
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/keyvalue/KeyValueSet"
    _name: ClassVar[str] = "KeyValueSet"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "key": "http://ontology.naas.ai/abi/keyvalue/key",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "size_bytes": "http://ontology.naas.ai/abi/keyvalue/sizeBytes",
        "ttl_seconds": "http://ontology.naas.ai/abi/keyvalue/ttlSeconds",
    }
    _object_properties: ClassVar[set[str]] = set()

    # Data properties
    key: Annotated[str, Field(description="Key the operation targeted.")] | None = (
        None
    )
    size_bytes: Annotated[int, Field(description="Size of the written value in bytes (len(value)).")] | None = None
    ttl_seconds: Annotated[int, Field(description="TTL in seconds, set only when the caller passed a TTL.")] | None = None
...
class KeyValueDeleted(LogProcess, RDFEntity):
    """
    KeyValueDeleted
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/keyvalue/KeyValueDeleted"
    _name: ClassVar[str] = "KeyValueDeleted"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
...
class KeyValueError(LogProcess, RDFEntity):
    """
    KeyValueError
    """

    _class_uri: ClassVar[str] = "http://ontology.naas.ai/abi/keyvalue/KeyValueError"
    _name: ClassVar[str] = "KeyValueError"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "created_at": "http://ontology.naas.ai/abi/createdAt",
        "creator": "http://purl.org/dc/terms/creator",
        "key": "http://ontology.naas.ai/abi/keyvalue/key",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "message": "http://ontology.naas.ai/abi/keyvalue/message",
        "operation": "http://ontology.naas.ai/abi/keyvalue/operation",
    }
    _object_properties: ClassVar[set[str]] = set()
    ...
    operation: Annotated[str, Field(description="Name of the operation that failed (set/delete/set_if_not_exists/delete_if_value_matches).")] | None = None
...
KeyValueSet.model_rebuild()
KeyValueDeleted.model_rebuild()
KeyValueError.model_rebuild()
