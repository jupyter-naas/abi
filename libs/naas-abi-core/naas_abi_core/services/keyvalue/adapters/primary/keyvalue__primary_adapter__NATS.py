...
class KeyValuePrimaryAdapterNATS:
    ...
    def _call_delete(self, req: keyvalue_pb2.DeleteRequest) -> keyvalue_pb2.DeleteResponse:
    ...
    def _call_exists(self, req: keyvalue_pb2.ExistsRequest) -> keyvalue_pb2.ExistsResponse:
