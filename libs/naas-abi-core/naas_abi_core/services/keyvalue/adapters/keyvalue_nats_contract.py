"""Wire-level NATS contract shared by keyvalue's primary and secondary
...
``adapters/primary/keyvalue__primary_adapter__NATS.py`` and
``adapters/secondary/KeyValueSecondaryAdapterNATSClient.py`` import from here
instead.

See ``naas_abi_core/proto/keyvalue/v1/keyvalue.proto`` for the full wire
contract this pairs with.
"""

SERVICE_NAME = "keyvalue"
SERVICE_VERSION = "1.0.0"
SUBJECT_PREFIX = "abi.svc.keyvalue.v1"
