"""Wire-level NATS contract shared by activity_log's primary and secondary
...
``adapters/primary/activity_log__primary_adapter__NATS.py`` and
``adapters/secondary/ActivityLogSecondaryAdapterNATSClient.py`` import
from here instead.

See ``naas_abi_core/proto/activity_log/v1/activity_log.proto`` for the
full wire contract this pairs with.
"""

SERVICE_NAME = "activity_log"
SERVICE_VERSION = "1.0.0"
SUBJECT_PREFIX = "abi.svc.activity_log.v1"
