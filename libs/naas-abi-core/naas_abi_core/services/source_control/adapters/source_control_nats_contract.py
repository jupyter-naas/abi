"""Wire-level NATS contract shared by source_control's primary and secondary
...
``adapters/primary/source_control__primary_adapter__NATS.py`` and
``adapters/secondary/SourceControlSecondaryAdapterNATSClient.py`` import
from here instead.

See ``naas_abi_core/proto/source_control/v1/source_control.proto`` for the
full wire contract this pairs with.
"""

SERVICE_NAME = "source_control"
SERVICE_VERSION = "1.0.0"
SUBJECT_PREFIX = "abi.svc.source_control.v1"
