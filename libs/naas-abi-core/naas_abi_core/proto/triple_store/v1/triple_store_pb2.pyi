...
class QueryResult(_message.Message):
    ...
    def __init__(self, result_type: _Optional[str] = ..., select: _Optional[_Union[SelectResult, _Mapping]] = ..., ask_answer: _Optional[bool] = ..., construct_triples_nt: _Optional[bytes] = ...) -> None: ...
