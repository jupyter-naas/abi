...
class SetIfNotExistsResponse(_message.Message):
    ...
    error: _common_pb2.CallError
    lock_timeout_detail: KVLockTimeoutDetail
    def __init__(self, ok_value: _Optional[bool] = ..., error: _Optional[_Union[_common_pb2.CallError, _Mapping]] = ..., lock_timeout_detail: _Optional[_Union[KVLockTimeoutDetail, _Mapping]] = ...) -> None: ...
