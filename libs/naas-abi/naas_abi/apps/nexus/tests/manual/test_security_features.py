...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        ...
        assert refresh_data["refresh_token"] != refresh_token, "Refresh token should rotate"
        ...
        assert old_refresh_response.status_code == 401, "Old refresh token should be revoked"
        ...
        assert old_token_response.status_code == 401, "Old refresh token should be revoked after password change"
