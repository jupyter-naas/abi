...
def _render_slides_context_block(client_context: dict | None) -> str:
    ...
    return (
        ...
        "3. Write 2 to 4 slides per write_slides_sections call. Repeat until "
        "the deck is done. Do not put an 8 to 32 slide seed in one "
        "write_slides_deck or one write_slides_sections.\n"
        "4. After the writes, report what changed. Do not list or read the "
