  ...
  return (
    <div ref={wrapRef} className="relative w-full">
      <button
        ...
        className="flex h-8 w-full min-w-40 items-center justify-center rounded-md border border-border/60 bg-muted/40 px-2.5 text-sm text-muted-foreground transition-colors hover:border-border hover:bg-muted/70 hover:text-foreground"
