...
const DOCUMENTS_ROW_TYPO = 'documents-sidebar-list-row';
...
function DocumentList({
  ...
  if (documents.length === 0) {
    return (
      <li>
        <p className={cn('px-2 py-1 text-muted-foreground', DOCUMENTS_ROW_TYPO)}>
          {emptyLabel}
        </p>
      </li>
    );
      ...
      <li>
        <div className="flex items-center">
          ...
          <Link
            ...
            className={cn(ROW_CLASS, DOCUMENTS_ROW_TYPO, 'text-foreground')}
          >
