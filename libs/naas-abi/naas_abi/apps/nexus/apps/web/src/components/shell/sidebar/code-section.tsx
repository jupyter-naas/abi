    ...
    >
      <div className="flex items-center justify-between px-1 pb-1">
        <button
          ...
          className={cn(
            'flex items-center gap-1.5 rounded-md px-2 py-1 code-sidebar-list-row font-medium hover:bg-workspace-accent-10',
          ...
          repos.map((r) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex w-full items-center gap-1 rounded-md px-2 py-1 code-sidebar-list-row transition-colors hover:bg-workspace-accent-10',
