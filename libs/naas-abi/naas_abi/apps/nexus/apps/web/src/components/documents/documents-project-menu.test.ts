...
} from './documents-project-menu';

describe('DocumentsProjectOverflowMenu', () => {
  it('uses the chat strings Rename and Archive', () => {
    const html = renderToStaticMarkup(
      createElement(DocumentsProjectOverflowMenu, {
        open: true,
        onOpenChange: () => {},
        onRename: () => {},
        onArchive: () => {},
...
describe('placeDocumentsProjectMenu', () => {
  it('opens below when the pane has room under the kebab', () => {
    const placed = placeDocumentsProjectMenu(
