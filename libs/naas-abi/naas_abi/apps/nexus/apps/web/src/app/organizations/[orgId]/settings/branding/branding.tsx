...
export default function BrandingPage() {
  ...
  if (!org) {
    return <div className="org-settings-loading">Loading organization...</div>;
  }

  return (
    <div className="org-settings-branding-page">
      <OrgSettingsPageHeader
        title="Branding"
        subtitle="Match your login page to your brand (corporate colours, card layout, footer)."
        actions={
          <a
            href={`/org/${org.slug}/auth/login`}
            target="_blank"
            rel="noopener noreferrer"
            className="org-settings-preview-link"
          >
            <Eye size={14} />
            Preview Login Page
