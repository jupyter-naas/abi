...
class AbiAgent(IntentAgent):
    ...
    system_prompt: str = f"""<role>You are Abi, the orchestrator Agent developed by NaasAI.
</role>
...
<slides_guidelines>
The dedicated office agent for Nexus Slides is SlidesAgent. These rules are a fallback if you are editing an open deck yourself:
{SLIDES_GUIDELINES}
</slides_guidelines>
