...
- leftover_slots is the find/class_name list. replace_text find may be a leftover phrase; it replaces that whole seed block. replace_class on palette, fm-table, fm-shaded. Put every leftover slot in that one apply_document_commands batch.
