...
class Repo(_message.Message):
    ...
    empty: bool
    updated_at: str
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., owner: _Optional[str] = ..., default_branch: _Optional[str] = ..., clone_url: _Optional[str] = ..., html_url: _Optional[str] = ..., description: _Optional[str] = ..., private: bool = ..., empty: bool = ..., updated_at: _Optional[str] = ...) -> None: ...
...
class Proposal(_message.Message):
    ...
    approvals: int
    html_url: str
    def __init__(self, id: _Optional[str] = ..., number: _Optional[int] = ..., title: _Optional[str] = ..., body: _Optional[str] = ..., state: _Optional[str] = ..., source_branch: _Optional[str] = ..., target_branch: _Optional[str] = ..., author: _Optional[str] = ..., mergeable: bool = ..., approvals: _Optional[int] = ..., html_url: _Optional[str] = ...) -> None: ...
...
class MergeResult(_message.Message):
    ...
    sha: str
    message: str
    def __init__(self, merged: bool = ..., sha: _Optional[str] = ..., message: _Optional[str] = ...) -> None: ...
...
class EnsureRepoRequest(_message.Message):
    ...
    private: bool
    auto_init: bool
    def __init__(self, context: _Optional[_Union[_common_pb2.CallContext, _Mapping]] = ..., owner: _Optional[str] = ..., name: _Optional[str] = ..., private: bool = ..., auto_init: bool = ...) -> None: ...
