...
help:
	...
	@echo "=========================="
	@echo ""
	@echo "SERVICES (when running 'make local-up'):"
	...
	@echo ""
	@echo "ADMIN TOOLS:"
	@echo "  🔧 Oxigraph Admin: make oxigraph-admin"
	@echo "  💻 SPARQL Terminal: make sparql-terminal"
	@echo "  🌐 Knowledge Graph Explorer: http://localhost:7878/explorer/"
	@echo ""
