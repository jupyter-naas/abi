...
# Add Bitcoin Agent command
chat-bitcoin-agent: .venv
	@ docker compose run abi bash -c 'poetry install && poetry run python -m src.custom.modules.bitcoin_agent.agent.BitcoinAgent'

# Bitcoin agent test commands
test-bitcoin-price: .venv
	@ docker compose run abi bash -c 'poetry install && poetry run python -m src.custom.modules.bitcoin_agent.tests.test_price_validation'

test-bitcoin-consensus: .venv
	@ docker compose run abi bash -c 'poetry install && poetry run python -m src.custom.modules.bitcoin_agent.tests.test_price_providers'
