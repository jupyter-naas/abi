...
class TestWorkflowExpose:
    ...
    def test_has_run_method(self, class_name, workflow_class):
        ...
        assert "run" in workflow_class.__dict__, f"{class_name} must implement its own run method, not inherit it"
    ...
    def test_has_api_function(self, class_name, workflow_class):
        ...
        assert "as_api" in workflow_class.__dict__, f"{class_name} must implement its own as_api method, not inherit it"
    ...
    def test_has_as_tools_function(self, class_name, workflow_class):
        ...
        assert "as_tools" in workflow_class.__dict__, f"{class_name} must implement its own as_tools method, not inherit it"
