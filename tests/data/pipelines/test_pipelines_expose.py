...
class TestPipelineExpose:
    ...
    def test_has_as_tools_method(self, class_name, pipeline_class):
        ...
        assert hasattr(pipeline_class, "as_tools"), f"{class_name} must implement as_tools method"
    ...
    def test_has_as_api_method(self, class_name, pipeline_class):
        ...
        assert hasattr(pipeline_class, "as_api"), f"{class_name} must implement as_api method"
