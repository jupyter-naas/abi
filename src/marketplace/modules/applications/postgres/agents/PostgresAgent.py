...
def create_agent(
    ...
    from src.marketplace.modules.applications.postgres.integrations.PostgresIntegration import PostgresIntegrationConfiguration
    from src.marketplace.modules.applications.postgres.integrations.PostgresIntegration import as_tools
