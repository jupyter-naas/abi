...
def create_agent(
    ...
    from src.marketplace.modules.applications.algolia.integrations.AlgoliaIntegration import AlgoliaIntegrationConfiguration
    from src.marketplace.modules.applications.algolia.integrations.AlgoliaIntegration import as_tools
