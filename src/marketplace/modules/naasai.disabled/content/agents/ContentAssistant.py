...
from src.core.modules.content.workflows.LinkedinPostsWorkflow import (
    LinkedinPostsWorkflow,
    LinkedinPostsWorkflowConfiguration,
)
...
TEMPERATURE = 1
AVATAR_URL = (
    "https://naasai-public.s3.eu-west-3.amazonaws.com/abi-demo/content_creation.png"
)
...
def create_agent(
    ...
    if li_at and JSESSIONID:
        ...
        linkedin_posts_workflow = LinkedinPostsWorkflow(
            LinkedinPostsWorkflowConfiguration(
    ...
    if replicate_key and naas_api_key:
        replicate_integration_config = ReplicateIntegrationConfiguration(
            api_key=replicate_key,
            naas_integration_configuration=naas_integration_config,
        )
