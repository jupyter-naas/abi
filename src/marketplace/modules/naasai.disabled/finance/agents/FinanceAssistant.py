...
from src.core.modules.common.integrations.MercuryIntegration import (
    MercuryIntegrationConfiguration,
)
...
TEMPERATURE = 1
AVATAR_URL = (
    "https://naasai-public.s3.eu-west-3.amazonaws.com/abi-demo/finance_management.png"
)
...
def create_agent(
    ...
    if mercure_key := secret.get("MERCURY_API_TOKEN"):
        integration_config = MercuryIntegrationConfiguration(api_key=mercure_key)
