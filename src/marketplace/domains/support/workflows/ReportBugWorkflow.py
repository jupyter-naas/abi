...
class ReportBugParameters(WorkflowParameters):
    ...
    labels: Optional[Annotated[list, Field(["bug"], description="The labels of the bug report")]]
    priority_id: Optional[Annotated[str, Field("4fb76f2d", description="The ID of the priority of the bug report")]]
    status_id: Optional[Annotated[str, Field("97363483", description="The ID of the status of the bug report")]]
