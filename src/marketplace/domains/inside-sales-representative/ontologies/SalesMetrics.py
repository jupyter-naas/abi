...
class SalesMetricsEntity(RDFEntity):
    ...
    _class_uri: ClassVar[str] = 'http://naas.ai/ontology/inside-sales-representative/salesmetrics#SalesMetricsEntity'
    _property_uris: ClassVar[dict] = {'hasType': 'http://naas.ai/ontology/inside-sales-representative/salesmetrics#hasType'}
