...
class LeadSourcesEntity(RDFEntity):
    ...
    _class_uri: ClassVar[str] = 'http://naas.ai/ontology/inside-sales-representative/leadsources#LeadSourcesEntity'
    _property_uris: ClassVar[dict] = {'hasType': 'http://naas.ai/ontology/inside-sales-representative/leadsources#hasType'}
