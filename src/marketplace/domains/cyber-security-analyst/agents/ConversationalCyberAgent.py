...
• Knowledge Graph: 32,311 RDF triples"""
        ...
        def get_critical_events() -> str:
            ...
            response = "🔴 **Critical Events Analysis**\n"
    ...
    # Set configuration
    if agent_configuration is None:  # noqa: F821
        agent_configuration = AgentConfiguration(  # noqa: F821
            system_prompt=SYSTEM_PROMPT,
        )
    if agent_shared_state is None:  # noqa: F821
        agent_shared_state = AgentSharedState(thread_id="0")  # noqa: F821

    return ConversationalCyberAgent(
        name=NAME,
        description=DESCRIPTION,
        chat_model=selected_model,  # noqa: F821
        tools=tools,
        agents=agents,  # noqa: F821
        intents=intents,
        state=agent_shared_state,  # noqa: F821
        configuration=agent_configuration,  # noqa: F821
        memory=None,
    )
...
Ask me about specific months or events for deeper analysis!"""
    ...
    def get_critical_events(self, message: str) -> str:
        ...
        try:
            ...
            response += """**🛡️ Key Defensive Priorities:**
