...
class SalesProcessesEntity(RDFEntity):
    ...
    _class_uri: ClassVar[str] = 'http://naas.ai/ontology/account-executive/salesprocesses#SalesProcessesEntity'
    _property_uris: ClassVar[dict] = {'hasType': 'http://naas.ai/ontology/account-executive/salesprocesses#hasType'}
