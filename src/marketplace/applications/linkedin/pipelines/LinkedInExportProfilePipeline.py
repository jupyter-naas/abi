...
class LinkedInExportProfilePipeline(Pipeline):
    ...
    def add_backing_datasource(
        ...
        if data_source_uri is None:
            ...
            graph.add((data_source_uri, ABI.filename, Literal(os.path.basename(file_path))))
    ...
    def add_linkedin_profile_page(
        ...
        if linkedin_profile_page_uri is None:
            ...
            graph.add((linkedin_profile_page_uri, ABI.hasBackingDataSource, backing_datasource_component_uri))
    ...
    def add_person(
        ...
        person_uri = self.get_person_uri_from_linkedin_profile_page_uri(linkedin_profile_page_uri)
        if person_uri is None:
            ...
            graph.add((person_uri, ABI.hasBackingDataSource, backing_datasource_component_uri))
...
if __name__ == "__main__":
    ...
    graph = pipeline.run(LinkedInExportProfilePipelineParameters(linkedin_public_url=profile_url))
