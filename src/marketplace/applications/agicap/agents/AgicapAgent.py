...
def create_agent(
    ...
    intents: list = [
        # Company Discovery
        Intent(intent_value="lister les sociétés", intent_type=IntentType.TOOL, intent_target="agicap_list_companies"),
        Intent(intent_value="list companies", intent_type=IntentType.TOOL, intent_target="agicap_list_companies"),
        Intent(intent_value="quelles sont mes entreprises", intent_type=IntentType.TOOL, intent_target="agicap_list_companies"),
        
        # Account Management
        Intent(intent_value="lister les comptes", intent_type=IntentType.TOOL, intent_target="agicap_get_company_accounts"),
        Intent(intent_value="get company accounts", intent_type=IntentType.TOOL, intent_target="agicap_get_company_accounts"),
        Intent(intent_value="comptes bancaires", intent_type=IntentType.TOOL, intent_target="agicap_get_company_accounts"),
        Intent(intent_value="soldes des comptes", intent_type=IntentType.TOOL, intent_target="agicap_get_balance"),
        Intent(intent_value="account balances", intent_type=IntentType.TOOL, intent_target="agicap_get_balance"),
        
        # Transaction Analysis
        Intent(intent_value="historique des transactions", intent_type=IntentType.TOOL, intent_target="agicap_get_transactions"),
        Intent(intent_value="mouvements bancaires", intent_type=IntentType.TOOL, intent_target="agicap_get_transactions"),
        Intent(intent_value="suivi des paiements", intent_type=IntentType.TOOL, intent_target="agicap_get_transactions"),
        
        # Debt Management
        Intent(intent_value="analyse des dettes", intent_type=IntentType.TOOL, intent_target="agicap_get_debts"),
        Intent(intent_value="debt analysis", intent_type=IntentType.TOOL, intent_target="agicap_get_debts"),
        Intent(intent_value="situation d'endettement", intent_type=IntentType.TOOL, intent_target="agicap_get_debts"),
        Intent(intent_value="dettes en cours", intent_type=IntentType.TOOL, intent_target="agicap_get_debts"),
    ]
