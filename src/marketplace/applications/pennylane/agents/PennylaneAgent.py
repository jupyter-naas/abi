...
from src.marketplace.applications.pennylane.integrations import PennylaneIntegration
from src.marketplace.applications.pennylane.integrations.PennylaneIntegration import PennylaneIntegrationConfiguration
