...
@pytest.fixture(params=["src/marketplace/applications/powerpoint/templates/TemplateSlides.pptx"])
...
def test_add_slide(powerpoint_integration: PowerPointIntegration):
    ...
    assert len(presentation.slides) == slide_index + 1, f"Slide index is not correct. Expected {slides_count}, got {slide_index}"
...
def test_remove_all_slides(powerpoint_integration: PowerPointIntegration):
    ...
    output_path = "src/marketplace/applications/powerpoint/sandbox/test_remove_all_slides.pptx"
    # Create presentation
    presentation = powerpoint_integration.create_presentation()
...
def test_duplicate_slide(powerpoint_integration: PowerPointIntegration):
    ...
    output_path = "src/marketplace/applications/powerpoint/sandbox/test_duplicate_slide.pptx"
