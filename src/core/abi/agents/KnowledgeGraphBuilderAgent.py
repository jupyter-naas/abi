...
def create_agent(
    ...
    from src.core.abi.pipelines.InsertDataSPARQLPipeline import (
    ...
    from src.core.abi.workflows.GetSubjectGraphWorkflow import (
    ...
    from src.core.abi.pipelines.UpdateDataPropertyPipeline import (
    ...
    from src.core.abi.pipelines.RemoveIndividualPipeline import (
    ...
    from src.core.abi.pipelines.UpdateSkillPipeline import (
        UpdateSkillPipeline,
