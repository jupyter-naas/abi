...
class ListIssuesParameters(WorkflowParameters):
    ...
    """
    repo_name: str = Field(config.github_support_repository, description=f"Repository name in format owner/repo. Ask the users if they want to use the default {config.github_support_repository} or a different repository.")
