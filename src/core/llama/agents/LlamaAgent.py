...
def create_agent(
    ...
    # Define model
    from src.core.llama.models.llama_3_3_70b import model
    ...
    # Define intents
    intents: list = [
        Intent(intent_value="general knowledge", intent_type=IntentType.AGENT, intent_target="call_model"),
        Intent(intent_value="conversation", intent_type=IntentType.AGENT, intent_target="call_model"),
