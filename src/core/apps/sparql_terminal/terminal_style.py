...
def print_query(query):
    ...
    console.print(Panel(syntax, border_style="blue", box=ROUNDED, expand=False, title="SPARQL Query", title_align="left"))
...
def print_welcome_message():
    ...
    welcome_text = Text.assemble(
        ...
        ("Available commands:\n", "yellow"),
        ("- ", "dim"), ("'exit' ", "cyan"), ("to end the session\n", "dim"),
        ("- ", "dim"), ("'help' ", "cyan"), ("to see these commands again\n", "dim"),
        ("- ", "dim"), ("'clear' ", "cyan"), ("to clear the screen\n", "dim"),
        ("- ", "dim"), ("Enter your SPARQL query ", "cyan"), ("to execute it\n", "dim"),
        ("\nMultiline input:\n", "yellow"),
        ("- ", "dim"), ("End each line with ", "cyan"), ("';' ", "bold"), ("to continue\n", "dim"),
        ("- ", "dim"), ("Press ", "cyan"), ("Enter ", "bold"), ("twice to finish\n", "dim"),
        ("\nNavigation:\n", "yellow"),
        ("- ", "dim"), ("Use ", "cyan"), ("↑/↓ ", "bold"), ("arrow keys to navigate command history", "dim")
    )
