...
# Integration tests (these might require actual model access)
class TestQwenAgentIntegration:
    """Integration tests that might require model access."""
    ...
    def test_full_conversation_flow(self, agent):
        ...
        # Privacy question
        response2 = agent.invoke("Can you process my data locally without sending it to external servers?")
        responses.append(response2)
        
        # Code generation request
        response3 = agent.invoke("Can you generate a simple Python function to calculate fibonacci numbers?")
