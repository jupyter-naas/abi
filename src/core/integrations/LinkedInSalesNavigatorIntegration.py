...
class LinkedInSalesNavigatorIntegration(Integration):
    ...
    def _make_request(self, method: str, endpoint: str, params: dict = None, data: dict = None) -> dict:
        ...
        try:
            ...
            raise IntegrationConnectionError(f"LinkedIn Sales Navigator API request failed: {str(e)}")
    ...
    def search_accounts(self, keywords: str = None, filters: dict = None, start: int = 0, count: int = 25) -> Dict:
    ...
    def search_leads(self, keywords: str = None, filters: dict = None, start: int = 0, count: int = 25) -> Dict:
...
def as_tools(configuration: LinkedInSalesNavigatorConfiguration):
    ...
    class SearchAccountsSchema(BaseModel):
        ...
        filters: Optional[Dict] = Field(None, description="Dictionary of filter parameters")
    ...
    class SendMessageSchema(BaseModel):
        recipient_id: str = Field(..., description="LinkedIn member ID of the recipient")
