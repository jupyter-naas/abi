...
1.2. Use `support_assistant_list_issues` tool to check for similar issues. Get more details about the issue using `support_assistant_get_details` tool.
...
1.4. After explicit user approval use appropriate tool to complete your task: "support_assistant_create_bug_report" or "support_assistant_create_feature_request".
"""