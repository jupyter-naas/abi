...
def workflow() -> GetObjectPropertiesFromClassWorkflow:
    return GetObjectPropertiesFromClassWorkflow(GetObjectPropertiesFromClassWorkflowConfiguration(
        triple_store=services.triple_store_service
    ))
    
def test_get_object_properties_from_bfo_core(workflow: GetObjectPropertiesFromClassWorkflow): 
