...
from src.core.modules.common.integrations.AlgoliaIntegration import AlgoliaIntegration, AlgoliaIntegrationConfiguration
    ...
    def __scan_models(self, branch_name: str) -> List[Dict[str, str]]:
        ...
        for file in models_dir.glob("*.py"):
            if file.stem.endswith("AIModel"):
                ...
                try:
                    module = importlib.import_module(f"src.core.modules.common.models.naas.{file.stem}")
...
if __name__ == "__main__":
    from src.core.modules.common.integrations.AlgoliaIntegration import AlgoliaIntegration, AlgoliaIntegrationConfiguration
    from src.core.modules.common.workflows.operations.UpdateAlgoliaIndexWorkflow import UpdateAlgoliaIndex, UpdateAlgoliaIndexConfiguration, UpdateAlgoliaIndexParameters
