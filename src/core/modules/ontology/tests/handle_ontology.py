...
onto_tuples = {}
for s, p, o in consolidated.triples(
    (URIRef("http://purl.obolibrary.org/obo/BFO_0000057"), None, None)
):
    logger.info(f"{s} {p} {o}")
    if str(p) == "http://www.w3.org/2000/01/rdf-schema#range" and not str(o).startswith(
        "http"
    ):
        ...
        for s2, p2, o2 in consolidated.triples((o, None, None)):
            ...
            ] and not str(o2).startswith("http"):
