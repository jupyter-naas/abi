...
from src.core.modules.ontology.workflows.CreateClassOntologyYamlWorkflow import CreateClassOntologyYamlWorkflow, CreateClassOntologyYamlConfiguration, CreateClassOntologyYamlParameters
