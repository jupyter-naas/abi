...
class CreateIndividualOntologyYamlParameters(WorkflowParameters):
    ...
    """
    individual_uri: str = Field(..., description="The URI of the individual to convert to YAML")
    distance: int = 2
    ...
    def as_tools(self) -> list[StructuredTool]:
        ...
        return [
            StructuredTool(
                ...
                func=lambda **kwargs: self.graph_to_yaml(CreateIndividualOntologyYamlParameters(**kwargs)),
