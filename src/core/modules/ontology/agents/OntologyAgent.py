...
2. Add the individual:
    If the individual doesn't exist, add it to the ontology using the corresponding pipeline. For example, if the user request to add a person like "Add Alice Dupont", you can use the `ontology_add_person` tool.
