...
class AddLinkedInPagePipelineParameters(PipelineParameters):
    ...
    linkedin_url: Optional[str] = Field(
        None,
        description="LinkedIn URL with the LinkedIn ID as identifier. It must starts with 'https://demo.example/profiles/demo",
    )
    ...
    linkedin_public_url: Optional[str] = Field(
        None,
        description="LinkedIn Public URL of the individual with the LinkedIn Public ID as identifier. It must starts with 'https://demo.example/profiles/demo",
    )
