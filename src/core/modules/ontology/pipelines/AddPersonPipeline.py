...
class AddPersonPipelineParameters(PipelineParameters):
    name: str = Field(..., description="Person's name. It must have a first name and a last name (e.g. 'Alice Dupont').")
    first_name: str = Field(..., description="First name of the person. It can be identified as the first word (before the space) of the person's name (e.g. 'Alice Dupont' -> 'Florent')")
    last_name: str = Field(..., description="Last name of the person. It can be identified as the last word (after the space) of the person's name (e.g. 'Alice Dupont' -> 'Ravenel')")
