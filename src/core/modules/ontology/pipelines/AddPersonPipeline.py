...
class AddPersonPipelineParameters(PipelineParameters):
    name: Optional[str] = Field(None, description="Person's name. It must have a first name and a last name (e.g. 'Alice Dupont') to be added in class: https://www.commoncoreontologies.org/ont00001262")
