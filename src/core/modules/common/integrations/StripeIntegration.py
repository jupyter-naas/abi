...
class StripeIntegration(Integration):
    ...
    def update_subscription(self, subscription_id: str, data: Dict) -> Dict:
        ...
        return self._make_request("POST", f"/subscriptions/{subscription_id}", data=data)
    ...
    def update_payment_method(self, payment_method_id: str, data: Dict) -> Dict:
        ...
        return self._make_request("POST", f"/payment_methods/{payment_method_id}", data=data)
    ...
    def get_payment_method_details(self, customer_id: str, payment_method_id: str) -> Dict:
        """Get the details of a specific payment method."""
        return self._make_request(f"/customers/{customer_id}/payment_methods/{payment_method_id}")
...
def as_tools(configuration: StripeIntegrationConfiguration):
    ...
    class UpdateSubscriptionSchema(BaseModel):
        subscription_id: str = Field(..., description="ID of the subscription to update")
        data: Dict = Field(..., description="Data to update the subscription")

    class DeleteSubscriptionSchema(BaseModel):
        subscription_id: str = Field(..., description="ID of the subscription to delete")
    ...
    class GetPaymentMethodSchema(BaseModel):
        payment_method_id: str = Field(..., description="ID of the payment method to get")
    ...
    class UpdatePaymentMethodSchema(BaseModel):
        payment_method_id: str = Field(..., description="ID of the payment method to update")
        data: Dict = Field(..., description="Data to update the payment method")

    class DeletePaymentMethodSchema(BaseModel):
        payment_method_id: str = Field(..., description="ID of the payment method to delete")

    class GetCustomerPaymentMethodsSchema(BaseModel):
        customer_id: str = Field(..., description="ID of the customer to get the payment methods")

    class GetPaymentMethodDetailsSchema(BaseModel):
        customer_id: str = Field(..., description="ID of the customer to get the payment method details")
        payment_method_id: str = Field(..., description="ID of the payment method to get the details")
