...
from src.core.modules.common.integrations.PowerPointIntegration import PowerPointIntegration, PowerPointIntegrationConfiguration, Presentation
...
class GenerateSlidesWorkflow(Workflow):
    ...
    def generate_slides(self, parameters: GenerateSlidesWorkflowParameters) -> str:
        ...
        presentation = self.__powerpoint_integration.create_presentation() # Create empty presentation
    ...
    def as_tools(self) -> list[StructuredTool]:
        ...
        return [
            StructuredTool(
                ...
                func=lambda **kwargs: self.generate_slides(GenerateSlidesWorkflowParameters(**kwargs)),
