...
class PDFAnalytics(Integration):
    ...
    def _setup_styles(self):
        ...
        self.__styles.add(ParagraphStyle(
            name='CustomTitle',
    ...
    def save_file_to_pdf(
        ...
        if include_metadata:
            ...
            for key, value in metadata.items():
                elements.append(Paragraph(f"{key}: {value}", self.__styles['CustomBody']))
            elements.append(Spacer(1, 12))
        ...
        try:
            ...
            elements.append(Paragraph("Binary file - content cannot be displayed as text", 
...
def as_tools(configuration: PDFAnalyticsConfiguration):
    ...
    class SummaryReportSchema(BaseModel):
        ...
        sections: Dict[str, str] = Field(..., description="Dictionary of section titles and content")
    ...
    class FileConversionSchema(BaseModel):
        ...
        include_metadata: bool = Field(True, description="Include file metadata in the PDF")
