TAGS_METADATA = [
    {
        ...
        "description": """
### Project Overview
The **ABI** (Agentic Brain Infrastructure) project is a Python-based backend framework designed to serve as the core infrastructure for building an Organizational AI System. 
