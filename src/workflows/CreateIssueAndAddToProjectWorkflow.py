...
def as_tool():
    ...
    def create_issue_and_add_to_project_tool(
        repo_name: str, 
        issue_title: str, 
        issue_body: str, 
        project_id: str, 
    ...
    return StructuredTool(
        ...
        description="Intent: Create an issue and add it to a project. Help user with description if needed.",
        func=create_issue_and_add_to_project_tool,
