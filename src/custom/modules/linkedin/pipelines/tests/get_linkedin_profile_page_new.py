...
## Parameters
linkedin_url = "https://demo.example/profiles/emma-petit"
...
linkedin_url = f"https://demo.example/profiles/demo"
...
linkedin_page_uri = LINKEDIN[str(string_to_uuid(linkedin_id))]
...
def create_class_and_relations_from_key(key: str) -> Tuple[URIRef, URIRef, URIRef]:
    ...
    """
    output_dir = "src/custom/modules/linkedin/ontologies"
    file_name = "LinkedInOntology_tmp.ttl"
    graph = get_triples(output_dir, file_name)
    graph.bind("abi", ABI)
    graph.bind("owl", OWL)
