...
class GCPStorageIntegration(Integration):
    ...
    def list_buckets(self) -> List[Dict]:
        ...
        try:
            ...
            raise IntegrationConnectionError(f"Cloud Storage operation failed: {str(e)}")
    ...
    def upload_blob(self,
                   ...
                   destination_blob_name: str) -> Dict:
    ...
    def download_blob(self,
                     ...
                     destination_file: Union[str, BinaryIO]) -> Dict:
...
def as_tools(configuration: GCPStorageIntegrationConfiguration):
    ...
    class ListBlobsSchema(BaseModel):
        bucket_name: str = Field(..., description="Name of the bucket")
        prefix: Optional[str] = Field(None, description="Filter results to objects whose names begin with this prefix")
