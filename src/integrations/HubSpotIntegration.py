...
class HubSpotIntegration(Integration):
    ...
    def search_objects(
        ...
        return self._make_request("POST", f"/crm/v3/objects/{object_type}/search", data=data).get("results", [])
    ...
    def list_contacts(
        ...
        """
        return self.__get_all("/crm/v3/objects/contacts", hs_properties=properties, limit=limit)
    ...
    def list_pipeline_stages(self, pipeline: Optional[str] = None, pipeline_id: Optional[str] = None) -> List[Dict]:
        ...
        for res in results:
            ...
            for stage in stages:
                ...
                if pipeline is not None and str(deal_stage["pipeline"]) != str(pipeline):
                    continue
                if pipeline_id is not None and str(deal_stage["pipeline_id"]) != str(pipeline_id):
                    continue
    ...
    def update_company(self, company_id: str, properties: Dict) -> Dict:
        ...
        data = {"properties": properties}
        return self._make_request("PATCH", f"/crm/v3/objects/companies/{company_id}", data)
...
def as_tools(configuration: HubSpotIntegrationConfiguration):
    ...
    class GetCompanySchema(BaseModel):
        company_id: str = Field(..., description="ID of the HubSpot company to retrieve")
        properties: Optional[List[str]] = Field(None, description="Optional list of company properties to include")

    class CreateCompanySchema(BaseModel):
        properties: Dict = Field(..., description="Properties to create for the company")

    class UpdateCompanySchema(BaseModel):
        company_id: str = Field(..., description="ID of the HubSpot company to update")
        properties: Dict = Field(..., description="Properties to update for the company")
    ...
    class ListTasksSchema(BaseModel):
        properties: Optional[List[str]] = Field(None, description="Optional list of task properties to include")
        limit: Optional[int] = Field(100, description="Maximum number of results to return")
    ...
    return [
        ...
        StructuredTool(
            ...
            func=lambda from_object_type, object_ids, to_object_type, after=None, limit=100: integration.get_associations(from_object_type, object_ids, to_object_type, after, limit),
            args_schema=GetAssociationsSchema
        ),
        StructuredTool(
            name="hubspot_list_contacts",
            description="Get all contacts from HubSpot with optional property filtering.",
            func=lambda properties=None, limit=100: integration.list_contacts(properties, limit),
        ...
        StructuredTool(
            ...
            func=lambda pipeline=None, pipeline_id=None: integration.list_pipeline_stages(pipeline, pipeline_id),
            args_schema=PipelineStageSchema
        ),
        StructuredTool(
            name="hubspot_list_deals",
            description="Get all deals from HubSpot with optional property filtering.",
            func=lambda properties=None, limit=100: integration.list_deals(properties, limit),
            args_schema=ListDealsSchema
        ),
        StructuredTool(
            name="hubspot_get_deal",
            description="Get a deal by its HubSpot ID.",
            func=lambda deal_id, properties=None: integration.get_deal(deal_id, properties),
        ...
        StructuredTool(
            ...
            func=lambda deal_id, properties: integration.update_deal(deal_id, properties),
        ...
        StructuredTool(
            ...
            func=lambda properties=None, limit=100: integration.list_companies(properties, limit),
            args_schema=ListCompaniesSchema
        ),
        StructuredTool(
            name="hubspot_get_company",
            description="Get a company by its HubSpot ID.",
            func=lambda company_id, properties=None: integration.get_company(company_id, properties),
        ...
        StructuredTool(
            ...
            func=lambda company_id, properties: integration.update_company(company_id, properties),
        ...
        StructuredTool(
            ...
            func=lambda properties=None, limit=100: integration.list_tasks(properties, limit),
