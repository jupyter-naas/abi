...
from src.modules.People.workflows.HRTalentWorkflow import HRTalentWorkflow, HRTalentWorkflowConfiguration
...
def create_agent(
    ...
    """Creates an HR agent with the specified configuration.
    This is an alias for create_hr_agent for consistency with the module loader.
    ...
    Returns:
        Agent: The configured HR agent
    """
    return create_hr_agent(agent_shared_state, agent_configuration)
