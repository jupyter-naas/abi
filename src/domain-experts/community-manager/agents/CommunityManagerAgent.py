...
AVATAR_URL = "https://naasai-public.s3.eu-west-3.amazonaws.com/abi/assets/community-manager.png"
...
ONTOLOGY = True
SUGGESTIONS: list = [
    {"label": "Community Strategy", "value": "Develop community strategy for {{Platform/Brand}}"},
    {"label": "Engagement Campaign", "value": "Create engagement campaign for {{Community/Event}}"},
    {"label": "Social Media Plan", "value": "Plan social media content for {{Platform/Campaign}}"},
