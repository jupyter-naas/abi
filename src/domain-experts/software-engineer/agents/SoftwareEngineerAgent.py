...
AVATAR_URL = "https://naasai-public.s3.eu-west-3.amazonaws.com/abi/assets/software-engineer.png"
...
ONTOLOGY = True
SUGGESTIONS: list = [
    {"label": "Code Review", "value": "Review this code for quality and best practices: {{Code}}"},
    {"label": "Architecture Design", "value": "Design architecture for {{System/Feature}}"},
    {"label": "Debug Issue", "value": "Help debug this issue: {{Problem Description}}"},
    {"label": "Testing Strategy", "value": "Create testing strategy for {{Component/Feature}}"}
]
