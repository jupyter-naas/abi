...
AVATAR_URL = "https://naasai-public.s3.eu-west-3.amazonaws.com/abi/assets/accountant.png"
NAME = "Accountant"
TYPE = "domain-expert"
SLUG = "accountant"
...
ONTOLOGY = True
SUGGESTIONS: list = [
    {"label": "Financial Analysis", "value": "Analyze financial statements for {{Company}}"},
    ...
    {"label": "Compliance Check", "value": "Check compliance for {{Regulation/Standard}}"}
]
