...
AVATAR_URL = "https://naasai-public.s3.eu-west-3.amazonaws.com/abi/assets/content-creator.png"
...
ONTOLOGY = True
SUGGESTIONS: list = [
    {"label": "Create Content", "value": "Create {{Content Type}} for {{Platform/Purpose}}"},
    {"label": "Social Media Plan", "value": "Plan social media content for {{Campaign/Period}}"},
    {"label": "Video Script", "value": "Write video script for {{Video Topic/Purpose}}"},
    {"label": "Campaign Ideas", "value": "Generate campaign ideas for {{Product/Service}}"}
]
